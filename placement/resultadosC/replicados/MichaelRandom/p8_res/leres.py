...
for _, _, arquivo in os.walk('.'):
    ...
    for a in arquivo:
        try:
            ...
            if val[2] > maiorTempo and val[2] < 99999:
                maiorTempo = val[2]
            ...
            if val[2] > hop_maiorTempo and val[2] < 99999:
