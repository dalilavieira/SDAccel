...
int main(int argc, char **argv) {
    ...
    for (int i = 0; i < DATA_SIZE; i++) {
        int host_result = source_b[i]* (source_b[i] * source_a[i] * (source_c[i] * (source_c[i] - 110) + 195) - source_a[i] * (source_c[i]*180 - (source_b[i]+ 240)) + source_a[i] * (source_c[i] * 117 * source_c[i] -  92 + source_a[i] * (28 * source_c[i] - 179) - 155) + source_c[i] * (source_c[i] * (source_c[i] - 138) + 34) - 198);
