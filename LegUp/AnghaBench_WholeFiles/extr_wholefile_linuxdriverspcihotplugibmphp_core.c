...
struct slot {TYPE_3__* bus_on; int /*<<< orphan*/  busstatus; TYPE_4__* ctrl; } ;
...
struct TYPE_9__ {int /*<<< orphan*/  revision; int /*<<< orphan*/  options; } ;
struct TYPE_8__ {int current_bus_mode; int /*<<< orphan*/  current_speed; } ;
struct TYPE_7__ {TYPE_1__* self; } ;
struct TYPE_6__ {unsigned int no_d1d2; } ;

/* Variables and functions */
 int CURRENT_BUS_MODE (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  CURRENT_BUS_SPEED (int /*<<< orphan*/ ) ; 
 int EINVAL ; 
 int ENODEV ; 
 int ENOTTY ; 
 ...
 int /*<<< orphan*/  READ_BUSSTATUS ; 
 scalar_t__ READ_BUS_MODE (TYPE_4__*) ; 
 scalar_t__ READ_BUS_STATUS (TYPE_4__*) ; 
...
__attribute__((used)) static inline int get_cur_bus_info(struct slot **sl)
{
	int rc = 1;
