...
struct nspire_keypad {int int_mask; unsigned int* state; unsigned long scan_interval; unsigned long row_delay; scalar_t__ active_low; struct input_dev* input; scalar_t__ reg_base; scalar_t__ clk; int /*<<< orphan*/  row_shift; } ;
struct TYPE_9__ {int /*<<< orphan*/  bustype; } ;
struct input_dev {unsigned short* keycode; char* name; int (* open ) (struct input_dev*) ;void (* close ) (struct input_dev*) ;int /*<<< orphan*/  evbit; TYPE_1__ id; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  dev_dbg (TYPE_2__*,char*,struct resource*,unsigned long,unsigned long,char*) ; 
 ...
 int devm_request_irq (TYPE_2__*,int,int /*<<< orphan*/  (*) (int,void*),int /*<<< orphan*/ ,char*,struct nspire_keypad*) ; 
 ...
 int of_property_read_u32 (struct device_node const*,char*,unsigned long*) ; 
