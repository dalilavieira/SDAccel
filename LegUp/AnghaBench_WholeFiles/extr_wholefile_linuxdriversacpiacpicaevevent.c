...
struct TYPE_3__ {int enable_register_id; size_t status_bit_mask; size_t enable_bit_mask; int status_register_id; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  AE_OK ; 
 int /*<<< orphan*/  TRUE ; 
static  size_t acpi_ev_fixed_event_dispatch (size_t) ; 
static  int /*<<< orphan*/  acpi_ev_fixed_event_initialize () ; 
