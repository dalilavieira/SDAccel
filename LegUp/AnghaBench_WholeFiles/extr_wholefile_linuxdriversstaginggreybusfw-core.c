...
struct gb_bundle {int num_cports; TYPE_2__* intf; int /*<<< orphan*/  dev; struct greybus_descriptor_cport* cport_desc; } ;
...
#define  GREYBUS_PROTOCOL_SPI 128 
 ...
 int /*<<< orphan*/  gb_fw_mgmt_connection_exit (struct gb_connection*) ; 
