...
/* Variables and functions */
 ...
 scalar_t__ cl_rename (char*,char*) ; 
 ...
 scalar_t__ git_buf_sets (TYPE_1__*,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  git_config_free (int /*<<< orphan*/ *) ; 
 scalar_t__ git_config_get_int32 (scalar_t__*,int /*<<< orphan*/ *,char*) ; 
 scalar_t__ git_config_open_default (int /*<<< orphan*/ **) ; 
 scalar_t__ git_config_set_int32 (int /*<<< orphan*/ *,char*,int) ; 
 scalar_t__ git_config_set_string (int /*<<< orphan*/ *,char*,char*) ; 
 int git_futils_creat_withpath (char*,int,int) ; 
 scalar_t__ git_futils_mkdir (char const*,int,int /*<<< orphan*/ ) ; 
 scalar_t__ git_futils_mkdir_r (char*,int) ; 
 int /*<<< orphan*/  git_futils_mkpath2file (char*,int) ; 
 scalar_t__ git_futils_readbuffer (TYPE_1__*,char*) ; 
 scalar_t__ git_futils_rmdir_r (char*,int /*<<< orphan*/ *,int /*<<< orphan*/ ) ; 
 scalar_t__ git_libgit2_opts (int /*<<< orphan*/ ,int /*<<< orphan*/ ,char*) ; 
 scalar_t__ git_path_exists (char*) ; 
 scalar_t__ git_path_isdir (char*) ; 
 scalar_t__ git_path_prettify (TYPE_1__*,char*,int /*<<< orphan*/ *) ; 
 scalar_t__ git_repository_config (int /*<<< orphan*/ **,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  git_repository_free (int /*<<< orphan*/ *) ; 
 int git_repository_is_bare (int /*<<< orphan*/ *) ; 
 scalar_t__ git_repository_open (int /*<<< orphan*/ **,char*) ; 
 scalar_t__ git_repository_open_bare (int /*<<< orphan*/ **,char*) ; 
 scalar_t__ git_repository_open_ext (int /*<<< orphan*/ **,char const*,int,char*) ; 
 int /*<<< orphan*/ * git_repository_path (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/ * git_repository_workdir (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  p_close (int) ; 
 scalar_t__ p_mkdir (char*,int) ; 
 scalar_t__ p_rename (char*,char*) ; 
 scalar_t__ p_write (int,char*,int /*<<< orphan*/ ) ; 
