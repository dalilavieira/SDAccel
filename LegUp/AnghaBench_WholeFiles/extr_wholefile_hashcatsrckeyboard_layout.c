...
typedef  int u8 ;
typedef  int u32 ;
struct TYPE_8__ {int token_cnt; int* len_min; int* len_max; int* sep; scalar_t__* len; int /*<<< orphan*/ * buf; void** attr; } ;
typedef  TYPE_1__ token_t ;
struct TYPE_9__ {scalar_t__ src_len; int src_char; int dst_char; int dst_len; } ;
...
/* Variables and functions */
 ...
 int input_tokenizer (int const*,int const,TYPE_1__*) ; 
