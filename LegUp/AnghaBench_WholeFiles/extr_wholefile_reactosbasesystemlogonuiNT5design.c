...
struct TYPE_18__ {int cy; int cx; int /*<<< orphan*/  hInstance; } ;
struct TYPE_17__ {int bmHeight; int /*<<< orphan*/  bmWidth; } ;
struct TYPE_16__ {int LowerRight; scalar_t__ UpperLeft; } ;
struct TYPE_15__ {int lfHeight; int lfWeight; int /*<<< orphan*/  lfFaceName; int /*<<< orphan*/  lfCharSet; } ;
struct TYPE_14__ {int top; int left; int right; scalar_t__ bottom; } ;
struct TYPE_13__ {int x; int y; int Red; int Green; int Blue; int Alpha; } ;
...
/* Variables and functions */
 int /*<<< orphan*/  BitBlt (int /*<<< orphan*/ *,int,int,int /*<<< orphan*/ ,int,int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 ...
 int /*<<< orphan*/  GetObjectW (int /*<<< orphan*/ *,int,TYPE_5__*) ; 
 int /*<<< orphan*/  GradientFill (int /*<<< orphan*/ *,TYPE_1__*,int,TYPE_4__*,int,int /*<<< orphan*/ ) ; 
 ...
 int NT5_BOTTOM_BORDER_HEIGHT ; 
 int NT5_TOP_BORDER_HEIGHT ; 
 int /*<<< orphan*/  PATCOPY ; 
 int /*<<< orphan*/  PatBlt (int /*<<< orphan*/ *,int /*<<< orphan*/ ,int,int,int,int /*<<< orphan*/ ) ; 
 ...
 int /*<<< orphan*/  StretchBlt (int /*<<< orphan*/ *,int /*<<< orphan*/ ,int,int,int,int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int,int /*<<< orphan*/ ) ; 
