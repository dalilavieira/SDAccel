...
struct inode {int i_size; void* i_ctime; void* i_mtime; int /*<<< orphan*/  i_mapping; struct super_block* i_sb; } ;
struct buffer_head {int b_size; scalar_t__ b_data; } ;
typedef  long sector_t ;
typedef  int loff_t ;
typedef  scalar_t__ block_t ;
struct TYPE_12__ {scalar_t__ key; scalar_t__* p; struct buffer_head* bh; } ;
...
/* Variables and functions */
 ...
 int block_to_path (struct inode*,long,int*) ; 
 int /*<<< orphan*/  block_truncate_page (int /*<<< orphan*/ ,int,int (*) (struct inode*,long,struct buffer_head*,int)) ; 
 int /*<<< orphan*/  brelse (struct buffer_head*) ; 
 void* cpu_to_block (int) ; 
 void* current_time (struct inode*) ; 
 scalar_t__* i_data (struct inode*) ; 
...
__attribute__((used)) static inline Indirect *get_branch(struct inode *inode,
					int depth,
					int *offsets,
...
__attribute__((used)) static inline void truncate (struct inode * inode)
{
	struct super_block *sb = inode->i_sb;
