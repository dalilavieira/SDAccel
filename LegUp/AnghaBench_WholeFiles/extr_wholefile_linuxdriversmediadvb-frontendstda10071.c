...
typedef  int u32 ;
typedef  int u16 ;
struct tda10071_reg_val_mask {int delivery_system; int modulation; scalar_t__ fec; int val; int member_0; int member_1; int member_2; int reg; int mask; } ;
struct tda10071_platform_data {int clk; int i2c_wr_max; int ts_mode; int spec_inv; int pll_multiplier; int tuner_i2c_addr; struct dvb_frontend* (* get_dvb_frontend ) (struct i2c_client*) ;} ;
struct TYPE_26__ {int len; TYPE_8__* stat; } ;
struct TYPE_24__ {int len; TYPE_6__* stat; } ;
struct TYPE_22__ {int len; TYPE_4__* stat; } ;
struct TYPE_20__ {int len; TYPE_2__* stat; } ;
struct dtv_frontend_properties {int delivery_system; int modulation; int frequency; int symbol_rate; int inversion; int pilot; scalar_t__ fec_inner; TYPE_9__ block_error; TYPE_7__ post_bit_error; TYPE_5__ cnr; TYPE_3__ strength; int /*<<< orphan*/  rolloff; } ;
struct dvb_frontend {int ops; struct tda10071_dev* demodulator_priv; struct dtv_frontend_properties dtv_property_cache; } ;
struct tda10071_dev {int warm; int fe_status; int delivery_system; unsigned int meas_count; int dvbv3_ber; int post_bit_error; int block_error; int pll_multiplier; int i2c_wr_max; int clk; int spec_inv; int tuner_i2c_addr; int ts_mode; struct dvb_frontend fe; int /*<<< orphan*/  regmap; int /*<<< orphan*/  cmd_execute_mutex; struct i2c_client* client; } ;
struct tda10071_cmd {int* args; int len; } ;
struct regmap_config {int reg_bits; int val_bits; } ;
struct i2c_device_id {int dummy; } ;
struct TYPE_17__ {struct tda10071_platform_data* platform_data; } ;
...
struct dvb_diseqc_master_cmd {int msg_len; TYPE_10__* msg; } ;
...
struct TYPE_25__ {scalar_t__ scale; int uvalue; } ;
struct TYPE_23__ {int uvalue; void* scale; } ;
struct TYPE_21__ {scalar_t__ scale; int svalue; } ;
struct TYPE_19__ {scalar_t__ scale; int svalue; } ;
struct TYPE_18__ {int frequency_tolerance_hz; int /*<<< orphan*/  name; } ;
...
/* Variables and functions */
 ...
 int CMD_LNB_UPDATE_REPLY ; 
 int CMD_MPEG_CONFIG ; 
 void* CMD_SET_SLEEP_MODE ; 
 int CMD_TUNER_INIT ; 
 int EFAULT ; 
 int EINVAL ; 
 int ENODEV ; 
...
#define  INVERSION_AUTO 146 
#define  INVERSION_OFF 145 
#define  INVERSION_ON 144 
 scalar_t__ IS_ERR (int /*<<< orphan*/ ) ; 
#define  PILOT_AUTO 143 
#define  PILOT_OFF 142 
#define  PILOT_ON 141 
 int PTR_ERR (int /*<<< orphan*/ ) ; 
 int QPSK ; 
#define  ROLLOFF_20 140 
#define  ROLLOFF_25 139 
#define  ROLLOFF_35 138 
#define  ROLLOFF_AUTO 137 
#define  SEC_MINI_A 136 
#define  SEC_MINI_B 135 
#define  SEC_TONE_OFF 134 
#define  SEC_TONE_ON 133 
#define  SEC_VOLTAGE_13 132 
#define  SEC_VOLTAGE_18 131 
#define  SEC_VOLTAGE_OFF 130 
#define  SYS_DVBS 129 
#define  SYS_DVBS2 128 
 int const SYS_UNDEFINED ; 
 int* TDA10071_FIRMWARE ; 
 struct tda10071_reg_val_mask* TDA10071_MODCOD ; 
 ...
 int /*<<< orphan*/  dev_info (TYPE_11__*,char*,...) ; 
 ...
 int /*<<< orphan*/  memcpy (int*,TYPE_10__*,int) ; 
 ...
 int request_firmware (struct firmware const**,int*,TYPE_11__*) ; 
