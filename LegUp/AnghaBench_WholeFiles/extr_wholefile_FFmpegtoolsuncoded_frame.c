...
struct TYPE_39__ {int nb_inputs; int nb_outputs; int /*<<< orphan*/ * outputs; int /*<<< orphan*/ * inputs; int /*<<< orphan*/  output_pads; } ;
struct TYPE_38__ {int nb_filters; TYPE_6__** filters; } ;
struct TYPE_37__ {scalar_t__ pts; } ;
struct TYPE_36__ {TYPE_10__* mux; TYPE_11__* stream; int /*<<< orphan*/  sink; } ;
struct TYPE_35__ {int codec_type; void* format; int /*<<< orphan*/  codec_id; int /*<<< orphan*/  sample_rate; int /*<<< orphan*/  channels; int /*<<< orphan*/  channel_layout; int /*<<< orphan*/  sample_aspect_ratio; int /*<<< orphan*/  height; int /*<<< orphan*/  width; } ;
struct TYPE_34__ {int flags; } ;
struct TYPE_33__ {int /*<<< orphan*/  index; int /*<<< orphan*/  time_base; TYPE_2__* codecpar; int /*<<< orphan*/  r_frame_rate; int /*<<< orphan*/  avg_frame_rate; } ;
struct TYPE_32__ {scalar_t__ pb; int /*<<< orphan*/  url; TYPE_1__* oformat; } ;
...
#define  AVMEDIA_TYPE_VIDEO 128 
 ...
 int av_interleaved_write_uncoded_frame (TYPE_10__*,int /*<<< orphan*/ ,TYPE_4__*) ; 
 int /*<<< orphan*/  av_log (TYPE_10__*,int /*<<< orphan*/ ,char*,...) ; 
 scalar_t__ av_rescale_q (scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  av_write_trailer (TYPE_10__*) ; 
 int av_write_uncoded_frame_query (TYPE_10__*,int /*<<< orphan*/ ) ; 
 ...
 int avfilter_graph_create_filter (int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *,TYPE_5__*) ; 
 ...
 int avfilter_link (TYPE_6__*,int,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int avfilter_pad_get_type (int /*<<< orphan*/ ,int) ; 
 int avformat_alloc_output_context2 (TYPE_10__**,int /*<<< orphan*/ *,char*,char*) ; 
 int /*<<< orphan*/  avformat_free_context (TYPE_10__*) ; 
 TYPE_11__* avformat_new_stream (TYPE_10__*,int /*<<< orphan*/ *) ; 
 int avformat_write_header (TYPE_10__*,int /*<<< orphan*/ *) ; 
