...
/* Variables and functions */
 size_t PIC_MIDRANGE_OPCODE_ADDFSR ; 
 size_t PIC_MIDRANGE_OPCODE_ADDLW ; 
 size_t PIC_MIDRANGE_OPCODE_ADDWF ; 
 size_t PIC_MIDRANGE_OPCODE_ADDWFC ; 
 size_t PIC_MIDRANGE_OPCODE_ANDLW ; 
 size_t PIC_MIDRANGE_OPCODE_ANDWF ; 
 size_t PIC_MIDRANGE_OPCODE_ASRF ; 
 size_t PIC_MIDRANGE_OPCODE_BCF ; 
 size_t PIC_MIDRANGE_OPCODE_BRA ; 
 size_t PIC_MIDRANGE_OPCODE_BRW ; 
 size_t PIC_MIDRANGE_OPCODE_BSF ; 
 size_t PIC_MIDRANGE_OPCODE_BTFSC ; 
 size_t PIC_MIDRANGE_OPCODE_BTFSS ; 
 size_t PIC_MIDRANGE_OPCODE_CALL ; 
 size_t PIC_MIDRANGE_OPCODE_CALLW ; 
 size_t PIC_MIDRANGE_OPCODE_CLR ; 
 size_t PIC_MIDRANGE_OPCODE_CLRWDT ; 
 size_t PIC_MIDRANGE_OPCODE_COMF ; 
 size_t PIC_MIDRANGE_OPCODE_DECF ; 
 size_t PIC_MIDRANGE_OPCODE_DECFSZ ; 
 size_t PIC_MIDRANGE_OPCODE_GOTO ; 
 size_t PIC_MIDRANGE_OPCODE_INCF ; 
 size_t PIC_MIDRANGE_OPCODE_INCFSZ ; 
 size_t PIC_MIDRANGE_OPCODE_INVALID ; 
 size_t PIC_MIDRANGE_OPCODE_IORLW ; 
 size_t PIC_MIDRANGE_OPCODE_IORWF ; 
 size_t PIC_MIDRANGE_OPCODE_LSLF ; 
 size_t PIC_MIDRANGE_OPCODE_LSRF ; 
 size_t PIC_MIDRANGE_OPCODE_MOVF ; 
 size_t PIC_MIDRANGE_OPCODE_MOVIW_1 ; 
 size_t PIC_MIDRANGE_OPCODE_MOVIW_2 ; 
 size_t PIC_MIDRANGE_OPCODE_MOVLB ; 
 size_t PIC_MIDRANGE_OPCODE_MOVLP ; 
 size_t PIC_MIDRANGE_OPCODE_MOVLW ; 
 size_t PIC_MIDRANGE_OPCODE_MOVWF ; 
 size_t PIC_MIDRANGE_OPCODE_MOVWI_1 ; 
 size_t PIC_MIDRANGE_OPCODE_MOVWI_2 ; 
 size_t PIC_MIDRANGE_OPCODE_NOP ; 
 size_t PIC_MIDRANGE_OPCODE_OPTION ; 
 size_t PIC_MIDRANGE_OPCODE_RESET ; 
 size_t PIC_MIDRANGE_OPCODE_RETFIE ; 
 size_t PIC_MIDRANGE_OPCODE_RETLW ; 
 size_t PIC_MIDRANGE_OPCODE_RETURN ; 
 size_t PIC_MIDRANGE_OPCODE_RLF ; 
 size_t PIC_MIDRANGE_OPCODE_RRF ; 
 size_t PIC_MIDRANGE_OPCODE_SLEEP ; 
 size_t PIC_MIDRANGE_OPCODE_SUBLW ; 
 size_t PIC_MIDRANGE_OPCODE_SUBWF ; 
 size_t PIC_MIDRANGE_OPCODE_SUBWFB ; 
 size_t PIC_MIDRANGE_OPCODE_SWAPF ; 
 size_t PIC_MIDRANGE_OPCODE_TRIS ; 
 size_t PIC_MIDRANGE_OPCODE_XORLW ; 
 size_t PIC_MIDRANGE_OPCODE_XORWF ; 
...
#define  PIC_MIDRANGE_OP_ARGS_NONE 128 
 ...
 TYPE_2__ const* pic_midrange_op_info ; 
