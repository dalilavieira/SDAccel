...
struct TYPE_52__ {int nb_samples; int** data; } ;
struct TYPE_51__ {int size; unsigned int* data; } ;
...
struct TYPE_49__ {size_t dict_entry; int sample; int /*<<< orphan*/  delta_compression; TYPE_1__* dict; } ;
struct TYPE_48__ {size_t r; size_t l; } ;
