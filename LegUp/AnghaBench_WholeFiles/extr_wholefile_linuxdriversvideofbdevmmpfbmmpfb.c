...
typedef  int u32 ;
typedef  int u16 ;
struct TYPE_16__ {struct mmp_buffer_driver_mach_info* platform_data; } ;
struct platform_device {TYPE_7__ dev; } ;
struct fb_videomode {int pixclock; int sync; int vmode; int /*<<< orphan*/  yres; int /*<<< orphan*/  xres; int /*<<< orphan*/  vsync_len; int /*<<< orphan*/  hsync_len; int /*<<< orphan*/  lower_margin; int /*<<< orphan*/  upper_margin; int /*<<< orphan*/  right_margin; int /*<<< orphan*/  left_margin; int /*<<< orphan*/  refresh; int /*<<< orphan*/  name; } ;
struct mmpfb_info {int fb_size; int* pseudo_palette; int pix_fmt; int output_fmt; TYPE_7__* dev; int /*<<< orphan*/  access_ok; scalar_t__ fb_start_dma; struct mmp_win* fb_start; int /*<<< orphan*/  overlay; TYPE_3__* path; int /*<<< orphan*/  name; struct fb_info* fb_info; struct fb_videomode mode; } ;
struct mmp_win {int pix_fmt; int* pitch; scalar_t__* phys; int /*<<< orphan*/  ydst; int /*<<< orphan*/  ysrc; int /*<<< orphan*/  xdst; int /*<<< orphan*/  xsrc; } ;
struct mmp_mode {int pixclock_freq; int hsync_invert; int vsync_invert; int invert_pixclock; int pix_fmt_out; int /*<<< orphan*/  vsync_len; int /*<<< orphan*/  hsync_len; int /*<<< orphan*/  lower_margin; int /*<<< orphan*/  upper_margin; int /*<<< orphan*/  right_margin; int /*<<< orphan*/  left_margin; int /*<<< orphan*/  yres; int /*<<< orphan*/  xres; int /*<<< orphan*/  refresh; int /*<<< orphan*/  name; } ;
struct mmp_buffer_driver_mach_info {int default_pixfmt; int /*<<< orphan*/  dmafetch_id; int /*<<< orphan*/  overlay_id; int /*<<< orphan*/  path_name; int /*<<< orphan*/  name; } ;
struct mmp_addr {int pix_fmt; int* pitch; scalar_t__* phys; int /*<<< orphan*/  ydst; int /*<<< orphan*/  ysrc; int /*<<< orphan*/  xdst; int /*<<< orphan*/  xsrc; } ;
struct fb_bitfield {int length; scalar_t__ offset; } ;
struct TYPE_13__ {scalar_t__ length; int offset; } ;
struct fb_var_screeninfo {int bits_per_pixel; int xoffset; int xres; int xres_virtual; int yoffset; int yres; int yres_virtual; struct fb_bitfield blue; struct fb_bitfield green; struct fb_bitfield red; TYPE_1__ transp; } ;
struct TYPE_14__ {scalar_t__ visual; int line_length; int ypanstep; int smem_len; int /*<<< orphan*/  id; scalar_t__ smem_start; int /*<<< orphan*/  accel; scalar_t__ ywrapstep; scalar_t__ xpanstep; scalar_t__ type_aux; int /*<<< orphan*/  type; } ;
struct fb_info {int flags; int node; int* pseudo_palette; int screen_size; TYPE_2__ fix; struct fb_var_screeninfo var; struct mmpfb_info* par; int /*<<< orphan*/  cmap; struct mmp_win* screen_base; int /*<<< orphan*/ * fbops; int /*<<< orphan*/  modelist; } ;
...
#define  PIXFMT_YVU422P 128 
 ...
 struct mmp_win* dma_alloc_coherent (TYPE_7__*,int /*<<< orphan*/ ,scalar_t__*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  dma_free_coherent (TYPE_7__*,int /*<<< orphan*/ ,struct mmp_win*,scalar_t__) ; 
 ...
 int mmp_path_get_modelist (TYPE_3__*,struct mmp_mode**) ; 
 int /*<<< orphan*/  mmp_path_get_overlay (TYPE_3__*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  mmp_path_set_mode (TYPE_3__*,struct mmp_mode*) ; 
