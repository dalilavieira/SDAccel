...
struct pci_dev {int revision; int device; int /*<<< orphan*/  dev; } ;
struct TYPE_4__ {scalar_t__ update; scalar_t__ tx_mc_byte_cnt; scalar_t__ tx_bc_byte_cnt; scalar_t__ tx_trunc; scalar_t__ tx_len_err; scalar_t__ tx_trd_eop; scalar_t__ tx_underrun; scalar_t__ tx_abort_col; scalar_t__ tx_late_col; scalar_t__ tx_multi_col; scalar_t__ tx_single_col; scalar_t__ tx_sz_max; scalar_t__ tx_sz_1518B; scalar_t__ tx_sz_1023B; scalar_t__ tx_sz_511B; scalar_t__ tx_sz_255B; scalar_t__ tx_sz_127B; scalar_t__ tx_sz_64B; scalar_t__ tx_byte_cnt; scalar_t__ tx_defer; scalar_t__ tx_ctrl; scalar_t__ tx_exc_defer; scalar_t__ tx_pause; scalar_t__ tx_mcast; scalar_t__ tx_bcast; scalar_t__ tx_ok; scalar_t__ rx_err_addr; scalar_t__ rx_mc_byte_cnt; scalar_t__ rx_bc_byte_cnt; scalar_t__ rx_align_err; scalar_t__ rx_ov_rrd; scalar_t__ rx_ov_rxf; scalar_t__ rx_ov_sz; scalar_t__ rx_sz_max; scalar_t__ rx_sz_1518B; scalar_t__ rx_sz_1023B; scalar_t__ rx_sz_511B; scalar_t__ rx_sz_255B; scalar_t__ rx_sz_127B; scalar_t__ rx_sz_64B; scalar_t__ rx_frag; scalar_t__ rx_runt; scalar_t__ rx_byte_cnt; scalar_t__ rx_len_err; scalar_t__ rx_fcs_err; scalar_t__ rx_ctrl; scalar_t__ rx_pause; scalar_t__ rx_mcast; scalar_t__ rx_bcast; scalar_t__ rx_ok; } ;
struct TYPE_3__ {scalar_t__ mmds; } ;
struct alx_hw {scalar_t__ hw_addr; scalar_t__ link_speed; scalar_t__ rx_ctrl; scalar_t__ duplex; scalar_t__ adv_cfg; scalar_t__* mac_addr; unsigned long smb_timer; int imt; scalar_t__ ith_tpd; int dma_chnl; scalar_t__* phy_id; TYPE_2__ stats; TYPE_1__ mdio; struct pci_dev* pdev; int /*<<< orphan*/  mtu; scalar_t__ lnk_patch; int /*<<< orphan*/  mdio_lock; } ;
...
#define  ADVERTISED_100baseT_Full 134 
#define  ADVERTISED_100baseT_Half 133 
#define  ADVERTISED_10baseT_Full 132 
#define  ADVERTISED_10baseT_Half 131 
 scalar_t__ ADVERTISED_Asym_Pause ; 
 scalar_t__ ADVERTISED_Autoneg ; 
 scalar_t__ ADVERTISED_Pause ; 
 scalar_t__ ADVERTISE_CSMA ; 
 ...
 scalar_t__ ALX_ANACTRL_DEF ; 
 scalar_t__ ALX_AZ_ANADECT_DEF ; 
 scalar_t__ ALX_AZ_ANADECT_LONG ; 
 scalar_t__ ALX_CLDCTRL3_BP_CABLE1TH_DET_GT ; 
 scalar_t__ ALX_CLDCTRL5_BP_VD_HLFBIAS ; 
 int /*<<< orphan*/  ALX_CLDCTRL6_CAB_LEN ; 
 scalar_t__ ALX_CLDCTRL6_CAB_LEN_SHORT100M ; 
 scalar_t__ ALX_CLDCTRL6_CAB_LEN_SHORT1G ; 
 scalar_t__ ALX_CLK_GATE ; 
 scalar_t__ ALX_CLK_GATE_ALL ; 
 scalar_t__ ALX_DEV_CTRL_MAXRRS_MIN ; 
 scalar_t__ ALX_DMA ; 
 scalar_t__ ALX_DMA_MAC_RST_TO ; 
 int ALX_DMA_RCHNL_SEL_SHIFT ; 
 scalar_t__ ALX_DMA_RDLY_CNT_DEF ; 
 scalar_t__ ALX_DMA_RDLY_CNT_SHIFT ; 
 scalar_t__ ALX_DMA_RORDER_MODE_OUT ; 
 scalar_t__ ALX_DMA_RORDER_MODE_SHIFT ; 
 scalar_t__ ALX_DMA_RREQ_BLEN_SHIFT ; 
 scalar_t__ ALX_DMA_RREQ_PRI_DATA ; 
 scalar_t__ ALX_DMA_WDLY_CNT_DEF ; 
 scalar_t__ ALX_DMA_WDLY_CNT_SHIFT ; 
 scalar_t__ ALX_DRV ; 
 int /*<<< orphan*/  ALX_DRV_PHY ; 
 scalar_t__ ALX_DRV_PHY_10 ; 
 scalar_t__ ALX_DRV_PHY_100 ; 
 scalar_t__ ALX_DRV_PHY_1000 ; 
 scalar_t__ ALX_DRV_PHY_AUTO ; 
 scalar_t__ ALX_DRV_PHY_DUPLEX ; 
 scalar_t__ ALX_DRV_PHY_UNKNOWN ; 
 scalar_t__ ALX_EFLD ; 
 scalar_t__ ALX_EFLD_E_EXIST ; 
 scalar_t__ ALX_EFLD_F_EXIST ; 
 scalar_t__ ALX_EFLD_START ; 
 scalar_t__ ALX_EFLD_STAT ; 
 scalar_t__ ALX_FC_ANEG ; 
 scalar_t__ ALX_FC_RX ; 
 scalar_t__ ALX_FC_TX ; 
 int ALX_GET_FIELD (scalar_t__,int /*<<< orphan*/ ) ; 
#define  ALX_GIGA_PSSR_1000MBS 130 
#define  ALX_GIGA_PSSR_100MBS 129 
#define  ALX_GIGA_PSSR_10MBS 128 
 scalar_t__ ALX_GIGA_PSSR_DPLX ; 
 scalar_t__ ALX_GIGA_PSSR_SPD_DPLX_RESOLVED ; 
 scalar_t__ ALX_GIGA_PSSR_SPEED ; 
 scalar_t__ ALX_GREENCFG2_BP_GREEN ; 
 scalar_t__ ALX_GREENCFG2_GATE_DFSE_EN ; 
 scalar_t__ ALX_HQTPD ; 
 scalar_t__ ALX_HQTPD_BURST_EN ; 
 scalar_t__ ALX_HQTPD_Q1_NUMPREF_SHIFT ; 
 scalar_t__ ALX_HQTPD_Q2_NUMPREF_SHIFT ; 
 scalar_t__ ALX_HQTPD_Q3_NUMPREF_SHIFT ; 
 scalar_t__ ALX_IDLE_DECISN_TIMER ; 
 scalar_t__ ALX_IDLE_DECISN_TIMER_DEF ; 
 scalar_t__ ALX_IER_LINK_DOWN ; 
 scalar_t__ ALX_IER_LINK_UP ; 
 scalar_t__ ALX_IMR ; 
 scalar_t__ ALX_INT_RETRIG ; 
 scalar_t__ ALX_INT_RETRIG_TO ; 
 scalar_t__ ALX_IRQ_MODU_TIMER ; 
 int ALX_IRQ_MODU_TIMER1_SHIFT ; 
 scalar_t__ ALX_ISR ; 
 scalar_t__ ALX_ISR_DIS ; 
 scalar_t__ ALX_LEGCYPS_DEF ; 
 scalar_t__ ALX_LPI_CTRL ; 
 scalar_t__ ALX_LPI_CTRL_EN ; 
 scalar_t__ ALX_MAC_CTRL ; 
 scalar_t__ ALX_MAC_CTRL_FAST_PAUSE ; 
 scalar_t__ ALX_MAC_CTRL_FULLD ; 
 scalar_t__ ALX_MAC_CTRL_RXFC_EN ; 
 scalar_t__ ALX_MAC_CTRL_RX_EN ; 
 int /*<<< orphan*/  ALX_MAC_CTRL_SPEED ; 
 int /*<<< orphan*/  ALX_MAC_CTRL_SPEED_1000 ; 
 int /*<<< orphan*/  ALX_MAC_CTRL_SPEED_10_100 ; 
 scalar_t__ ALX_MAC_CTRL_TXFC_EN ; 
 scalar_t__ ALX_MAC_CTRL_TX_EN ; 
 scalar_t__ ALX_MAC_STS ; 
 scalar_t__ ALX_MAC_STS_IDLE ; 
 scalar_t__ ALX_MASTER ; 
 scalar_t__ ALX_MASTER_DMA_MAC_RST ; 
 scalar_t__ ALX_MASTER_IRQMOD1_EN ; 
 scalar_t__ ALX_MASTER_IRQMOD2_EN ; 
 scalar_t__ ALX_MASTER_OOB_DIS ; 
 scalar_t__ ALX_MASTER_PCLKSEL_SRDS ; 
 scalar_t__ ALX_MASTER_SYSALVTIMER_EN ; 
 scalar_t__ ALX_MASTER_WAKEN_25M ; 
 scalar_t__ ALX_MDIO ; 
 scalar_t__ ALX_MDIO_BUSY ; 
 scalar_t__ ALX_MDIO_CLK_SEL_25MD128 ; 
 scalar_t__ ALX_MDIO_CLK_SEL_25MD4 ; 
 scalar_t__ ALX_MDIO_CLK_SEL_SHIFT ; 
 int /*<<< orphan*/  ALX_MDIO_DATA ; 
 scalar_t__ ALX_MDIO_DATA_SHIFT ; 
 scalar_t__ ALX_MDIO_EXTN ; 
 scalar_t__ ALX_MDIO_EXTN_DEVAD_SHIFT ; 
 scalar_t__ ALX_MDIO_EXTN_REG_SHIFT ; 
 int ALX_MDIO_MAX_AC_TO ; 
 scalar_t__ ALX_MDIO_MODE_EXT ; 
 scalar_t__ ALX_MDIO_OP_READ ; 
 scalar_t__ ALX_MDIO_REG_SHIFT ; 
 scalar_t__ ALX_MDIO_SPRES_PRMBL ; 
 scalar_t__ ALX_MDIO_START ; 
 scalar_t__ ALX_MIB_RX_ALIGN_ERR ; 
 scalar_t__ ALX_MIB_RX_BCAST ; 
 scalar_t__ ALX_MIB_RX_BCCNT ; 
 scalar_t__ ALX_MIB_RX_BYTE_CNT ; 
 scalar_t__ ALX_MIB_RX_CTRL ; 
 scalar_t__ ALX_MIB_RX_ERRADDR ; 
 scalar_t__ ALX_MIB_RX_FCS_ERR ; 
 scalar_t__ ALX_MIB_RX_FRAG ; 
 scalar_t__ ALX_MIB_RX_LEN_ERR ; 
 scalar_t__ ALX_MIB_RX_MCAST ; 
 scalar_t__ ALX_MIB_RX_MCCNT ; 
 scalar_t__ ALX_MIB_RX_OK ; 
 scalar_t__ ALX_MIB_RX_OV_RRD ; 
 scalar_t__ ALX_MIB_RX_OV_RXF ; 
 scalar_t__ ALX_MIB_RX_OV_SZ ; 
 scalar_t__ ALX_MIB_RX_PAUSE ; 
 scalar_t__ ALX_MIB_RX_RUNT ; 
 scalar_t__ ALX_MIB_RX_SZ_1023B ; 
 scalar_t__ ALX_MIB_RX_SZ_127B ; 
 scalar_t__ ALX_MIB_RX_SZ_1518B ; 
 scalar_t__ ALX_MIB_RX_SZ_255B ; 
 scalar_t__ ALX_MIB_RX_SZ_511B ; 
 scalar_t__ ALX_MIB_RX_SZ_64B ; 
 scalar_t__ ALX_MIB_RX_SZ_MAX ; 
 scalar_t__ ALX_MIB_TX_ABORT_COL ; 
 scalar_t__ ALX_MIB_TX_BCAST ; 
 scalar_t__ ALX_MIB_TX_BCCNT ; 
 scalar_t__ ALX_MIB_TX_BYTE_CNT ; 
 scalar_t__ ALX_MIB_TX_CTRL ; 
 scalar_t__ ALX_MIB_TX_DEFER ; 
 scalar_t__ ALX_MIB_TX_EXC_DEFER ; 
 scalar_t__ ALX_MIB_TX_LATE_COL ; 
 scalar_t__ ALX_MIB_TX_LEN_ERR ; 
 scalar_t__ ALX_MIB_TX_MCAST ; 
 scalar_t__ ALX_MIB_TX_MCCNT ; 
 scalar_t__ ALX_MIB_TX_MULTI_COL ; 
 scalar_t__ ALX_MIB_TX_OK ; 
 scalar_t__ ALX_MIB_TX_PAUSE ; 
 scalar_t__ ALX_MIB_TX_SINGLE_COL ; 
 scalar_t__ ALX_MIB_TX_SZ_1023B ; 
 scalar_t__ ALX_MIB_TX_SZ_127B ; 
 scalar_t__ ALX_MIB_TX_SZ_1518B ; 
 scalar_t__ ALX_MIB_TX_SZ_255B ; 
 scalar_t__ ALX_MIB_TX_SZ_511B ; 
 scalar_t__ ALX_MIB_TX_SZ_64B ; 
 scalar_t__ ALX_MIB_TX_SZ_MAX ; 
 scalar_t__ ALX_MIB_TX_TRD_EOP ; 
 scalar_t__ ALX_MIB_TX_TRUNC ; 
 scalar_t__ ALX_MIB_TX_UNDERRUN ; 
 scalar_t__ ALX_MIB_UPDATE ; 
 scalar_t__ ALX_MIIDBG_AGC ; 
 scalar_t__ ALX_MIIDBG_ANACTRL ; 
 scalar_t__ ALX_MIIDBG_AZ_ANADECT ; 
 scalar_t__ ALX_MIIDBG_GREENCFG2 ; 
 scalar_t__ ALX_MIIDBG_LEGCYPS ; 
 scalar_t__ ALX_MIIDBG_MSE16DB ; 
 scalar_t__ ALX_MIIDBG_MSE20DB ; 
 scalar_t__ ALX_MIIDBG_SRDSYSMOD ; 
 scalar_t__ ALX_MIIDBG_SYSMODCTRL ; 
 scalar_t__ ALX_MIIDBG_TST100BTCFG ; 
 scalar_t__ ALX_MIIDBG_TST10BTCFG ; 
 scalar_t__ ALX_MIIEXT_AFE ; 
 scalar_t__ ALX_MIIEXT_ANEG ; 
 scalar_t__ ALX_MIIEXT_CLDCTRL3 ; 
 scalar_t__ ALX_MIIEXT_CLDCTRL5 ; 
 scalar_t__ ALX_MIIEXT_CLDCTRL6 ; 
 scalar_t__ ALX_MIIEXT_LOCAL_EEEADV ; 
 scalar_t__ ALX_MIIEXT_NLP78 ; 
 scalar_t__ ALX_MIIEXT_NLP78_120M_DEF ; 
 scalar_t__ ALX_MIIEXT_PCS ; 
 scalar_t__ ALX_MIIEXT_S3DIG10 ; 
 scalar_t__ ALX_MIIEXT_S3DIG10_DEF ; 
 scalar_t__ ALX_MIIEXT_VDRVBIAS ; 
 scalar_t__ ALX_MII_DBG_ADDR ; 
 scalar_t__ ALX_MII_DBG_DATA ; 
 scalar_t__ ALX_MII_GIGA_PSSR ; 
 scalar_t__ ALX_MII_IER ; 
 scalar_t__ ALX_MII_ISR ; 
 scalar_t__ ALX_MISC ; 
 scalar_t__ ALX_MISC3 ; 
 scalar_t__ ALX_MISC3_25M_BY_SW ; 
 scalar_t__ ALX_MISC3_25M_NOTO_INTNL ; 
 scalar_t__ ALX_MISC_INTNLOSC_OPEN ; 
 scalar_t__ ALX_MISC_ISO_EN ; 
 ...
 scalar_t__ ALX_MSIC2 ; 
 scalar_t__ ALX_MSIC2_CALB_START ; 
 scalar_t__ ALX_MSIX_ENTRY_BASE ; 
 scalar_t__ ALX_MSIX_MASK ; 
 scalar_t__ ALX_MTU ; 
 scalar_t__ ALX_MTU_JUMBO_TH ; 
 int ALX_MTU_STD_ALGN ; 
 scalar_t__ ALX_PCI_CMD ; 
 int ALX_PCI_REVID_SHIFT ; 
 scalar_t__ ALX_PDLL_TRNS1 ; 
 scalar_t__ ALX_PDLL_TRNS1_D3PLLOFF_EN ; 
 scalar_t__ ALX_PHY_CTRL ; 
 scalar_t__ ALX_PHY_CTRL_CLS ; 
 scalar_t__ ALX_PHY_CTRL_DSPRST_OUT ; 
 int ALX_PHY_CTRL_DSPRST_TO ; 
 scalar_t__ ALX_PHY_CTRL_GATE_25M ; 
 scalar_t__ ALX_PHY_CTRL_HIB_EN ; 
 scalar_t__ ALX_PHY_CTRL_HIB_PULSE ; 
 scalar_t__ ALX_PHY_CTRL_IDDQ ; 
 scalar_t__ ALX_PHY_CTRL_POWER_DOWN ; 
 scalar_t__ ALX_PHY_CTRL_RST_ANALOG ; 
 scalar_t__ ALX_PHY_INITED ; 
 scalar_t__ ALX_PMCTRL ; 
 scalar_t__ ALX_PMCTRL_ASPM_FCEN ; 
 scalar_t__ ALX_PMCTRL_HOTRST_WTEN ; 
 scalar_t__ ALX_PMCTRL_L0S_EN ; 
 int /*<<< orphan*/  ALX_PMCTRL_L1REG_TO_DEF ; 
 int /*<<< orphan*/  ALX_PMCTRL_L1REQ_TO ; 
 scalar_t__ ALX_PMCTRL_L1_BUFSRX_EN ; 
 scalar_t__ ALX_PMCTRL_L1_CLKSW_EN ; 
 scalar_t__ ALX_PMCTRL_L1_EN ; 
 scalar_t__ ALX_PMCTRL_L1_SRDSPLL_EN ; 
 scalar_t__ ALX_PMCTRL_L1_SRDSRX_PWD ; 
 scalar_t__ ALX_PMCTRL_L1_SRDS_EN ; 
 ...
 scalar_t__ ALX_PMCTRL_RCVR_WT_1US ; 
 scalar_t__ ALX_PMCTRL_RXL1_AFTER_L0S ; 
 scalar_t__ ALX_PMCTRL_SADLY_EN ; 
 scalar_t__ ALX_PMCTRL_TXL1_AFTER_L0S ; 
 scalar_t__ ALX_RAW_MTU (int /*<<< orphan*/ ) ; 
 scalar_t__ ALX_REV_A0 ; 
 scalar_t__ ALX_REV_A1 ; 
 scalar_t__ ALX_REV_B0 ; 
 scalar_t__ ALX_RFD_PIDX ; 
 scalar_t__ ALX_RXQ0 ; 
 int /*<<< orphan*/  ALX_RXQ0_ASPM_THRESH ; 
 int /*<<< orphan*/  ALX_RXQ0_ASPM_THRESH_100M ; 
 scalar_t__ ALX_RXQ0_EN ; 
 scalar_t__ ALX_RXQ0_IDT_TBL_SIZE_DEF ; 
 scalar_t__ ALX_RXQ0_IDT_TBL_SIZE_SHIFT ; 
 scalar_t__ ALX_RXQ0_IPV6_PARSE_EN ; 
 scalar_t__ ALX_RXQ0_NUM_RFD_PREF_DEF ; 
 scalar_t__ ALX_RXQ0_NUM_RFD_PREF_SHIFT ; 
 scalar_t__ ALX_RXQ0_RSS_HASH_EN ; 
 scalar_t__ ALX_RXQ0_RSS_HSTYP_ALL ; 
 scalar_t__ ALX_RXQ0_RSS_MODE_DIS ; 
 scalar_t__ ALX_RXQ0_RSS_MODE_SHIFT ; 
 scalar_t__ ALX_RXQ2 ; 
 scalar_t__ ALX_RXQ2_RXF_FLOW_CTRL_RSVD ; 
 scalar_t__ ALX_RXQ2_RXF_XOFF_THRESH_SHIFT ; 
 scalar_t__ ALX_RXQ2_RXF_XON_THRESH_SHIFT ; 
 scalar_t__ ALX_SERDES ; 
 scalar_t__ ALX_SERDES_MACCLK_SLWDWN ; 
 scalar_t__ ALX_SERDES_PHYCLK_SLWDWN ; 
 int /*<<< orphan*/  ALX_SET_FIELD (scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 scalar_t__ ALX_SLD ; 
 int ALX_SLD_MAX_TO ; 
 scalar_t__ ALX_SLD_START ; 
 scalar_t__ ALX_SLD_STAT ; 
 scalar_t__ ALX_SMB_TIMER ; 
 scalar_t__ ALX_SRAM5 ; 
 int /*<<< orphan*/  ALX_SRAM_RXF_LEN ; 
 scalar_t__ ALX_SRAM_RXF_LEN_8K ; 
 scalar_t__ ALX_SRDSYSMOD_DEF ; 
 scalar_t__ ALX_STAD0 ; 
 scalar_t__ ALX_STAD1 ; 
 scalar_t__ ALX_SYSMODCTRL_IECHOADJ_DEF ; 
 scalar_t__ ALX_TINT_TIMER ; 
 scalar_t__ ALX_TINT_TPD_THRSHLD ; 
 scalar_t__ ALX_TST100BTCFG_DEF ; 
 scalar_t__ ALX_TST10BTCFG_DEF ; 
 scalar_t__ ALX_TXQ0 ; 
 scalar_t__ ALX_TXQ0_EN ; 
 scalar_t__ ALX_TXQ0_LSO_8023_EN ; 
 scalar_t__ ALX_TXQ0_MODE_ENHANCE ; 
 scalar_t__ ALX_TXQ0_SUPT_IPOPT ; 
 scalar_t__ ALX_TXQ0_TPD_BURSTPREF_SHIFT ; 
 scalar_t__ ALX_TXQ0_TXF_BURST_PREF_SHIFT ; 
 scalar_t__ ALX_TXQ1 ; 
 scalar_t__ ALX_TXQ1_ERRLGPKT_DROP_EN ; 
 scalar_t__ ALX_TXQ1_JUMBO_TSO_TH ; 
 scalar_t__ ALX_TXQ_TPD_BURSTPREF_DEF ; 
 scalar_t__ ALX_TXQ_TXF_BURST_PREF_DEF ; 
 scalar_t__ ALX_UE_SVRT ; 
 scalar_t__ ALX_UE_SVRT_DLPROTERR ; 
 scalar_t__ ALX_UE_SVRT_FCPROTERR ; 
 scalar_t__ ALX_VDRVBIAS_DEF ; 
 scalar_t__ ALX_WOL0 ; 
 scalar_t__ ALX_WRR ; 
 ...
 scalar_t__ MII_ADVERTISE ; 
 scalar_t__ MII_BMCR ; 
 scalar_t__ MII_BMSR ; 
 scalar_t__ MII_CTRL1000 ; 
 scalar_t__ MII_PHYSID1 ; 
 scalar_t__ MII_PHYSID2 ; 
 int /*<<< orphan*/  PCI_COMMAND ; 
 scalar_t__ PCI_COMMAND_INTX_DISABLE ; 
 ...
 void alx_enable_aspm (struct alx_hw*,int,int) ; 
