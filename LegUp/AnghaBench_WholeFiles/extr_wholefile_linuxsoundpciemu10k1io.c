...
/* Type definitions */
typedef  int u32 ;
struct snd_emu10k1 {int /*<<< orphan*/  emu_lock; scalar_t__ port; int /*<<< orphan*/  i2c_lock; TYPE_2__* card; int /*<<< orphan*/  spi_lock; TYPE_1__* card_capabilities; scalar_t__ audigy; } ;
struct snd_ac97 {struct snd_emu10k1* private_data; } ;
struct TYPE_4__ {int /*<<< orphan*/  dev; } ;
struct TYPE_3__ {scalar_t__ ca0108_chip; } ;
...
/* Variables and functions */
 ...
 int I2C_A_ADC_START ; 
 scalar_t__ INTE ; 
 unsigned int P17V_I2C_1 ; 
 unsigned int P17V_I2C_ADDR ; 
 scalar_t__ PTR ; 
