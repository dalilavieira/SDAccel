...
struct TYPE_22__ {int td_subfiletype; double td_xresolution; double td_yresolution; int td_resolutionunit; double td_xposition; double td_yposition; int td_bitspersample; int td_sampleformat; int td_compression; size_t td_photometric; int td_extrasamples; int* td_sampleinfo; int td_samplesperpixel; char* td_inknames; int td_inknameslen; int td_threshholding; int td_fillorder; int* td_ycbcrsubsampling; int td_ycbcrpositioning; int* td_halftonehints; size_t td_orientation; size_t td_rowsperstrip; int td_minsamplevalue; int td_maxsamplevalue; double* td_sminsamplevalue; double* td_smaxsamplevalue; int td_planarconfig; int* td_pagenumber; double* td_refblackwhite; int** td_transferfunction; int td_nsubifd; size_t td_nstrips; scalar_t__* td_stripbytecount; scalar_t__* td_stripoffset; scalar_t__* td_subifd; int /*<<< orphan*/ ** td_colormap; scalar_t__ td_tiledepth; scalar_t__ td_tilelength; scalar_t__ td_tilewidth; scalar_t__ td_imagedepth; scalar_t__ td_imagelength; scalar_t__ td_imagewidth; } ;
struct TYPE_24__ {int tif_flags; TYPE_1__ tif_tagmethods; scalar_t__ tif_diroff; TYPE_3__ tif_dir; } ;
struct TYPE_23__ {char* name; } ;
struct TYPE_21__ {char* field_name; scalar_t__ field_type; size_t field_readcount; int const field_tag; scalar_t__ field_passcount; } ;
...
#define  EXTRASAMPLE_ASSOCALPHA 159 
#define  EXTRASAMPLE_UNASSALPHA 158 
#define  EXTRASAMPLE_UNSPECIFIED 157 
...
#define  FILLORDER_LSB2MSB 156 
#define  FILLORDER_MSB2LSB 155 
#define  INKSET_CMYK 154 
 size_t NORIENTNAMES ; 
 size_t NPHOTONAMES ; 
#define  PHOTOMETRIC_LOGL 153 
#define  PHOTOMETRIC_LOGLUV 152 
#define  PLANARCONFIG_CONTIG 151 
#define  PLANARCONFIG_SEPARATE 150 
#define  RESUNIT_CENTIMETER 149 
#define  RESUNIT_INCH 148 
#define  RESUNIT_NONE 147 
#define  SAMPLEFORMAT_COMPLEXIEEEFP 146 
#define  SAMPLEFORMAT_COMPLEXINT 145 
#define  SAMPLEFORMAT_IEEEFP 144 
#define  SAMPLEFORMAT_INT 143 
#define  SAMPLEFORMAT_UINT 142 
#define  SAMPLEFORMAT_VOID 141 
#define  THRESHHOLD_BILEVEL 140 
#define  THRESHHOLD_ERRORDIFFUSE 139 
#define  THRESHHOLD_HALFTONE 138 
 scalar_t__ TIFFFieldSet (TYPE_5__*,int /*<<< orphan*/ ) ; 
 TYPE_2__* TIFFFieldWithTag (TYPE_5__*,size_t) ; 
 TYPE_4__* TIFFFindCODEC (int) ; 
 int TIFFGetField (TYPE_5__*,size_t,void*,...) ; 
 scalar_t__ TIFFGetTagListCount (TYPE_5__*) ; 
 size_t TIFFGetTagListEntry (TYPE_5__*,int) ; 
 long TIFFPRINT_COLORMAP ; 
 long TIFFPRINT_CURVES ; 
 long TIFFPRINT_STRIPS ; 
#define  TIFFTAG_DOTRANGE 137 
#define  TIFFTAG_ICCPROFILE 136 
#define  TIFFTAG_INKSET 135 
#define  TIFFTAG_PHOTOSHOP 134 
#define  TIFFTAG_RICHTIFFIPTC 133 
#define  TIFFTAG_STONITS 132 
#define  TIFFTAG_WHITEPOINT 131 
#define  TIFFTAG_XMLPACKET 130 
