...
typedef  int u8 ;
typedef  int u32 ;
struct nvkm_volt_func {int (* volt_get ) (struct nvkm_volt*) ;int (* vid_get ) (struct nvkm_volt*) ;int (* volt_set ) (struct nvkm_volt*,int) ;int (* vid_set ) (struct nvkm_volt*,int) ;int (* set_id ) (struct nvkm_volt*,int,int) ;int (* speedo_read ) (struct nvkm_volt*) ;int (* oneinit ) (struct nvkm_volt*) ;} ;
struct nvkm_subdev {TYPE_1__* device; } ;
struct nvkm_volt {int vid_nr; int max_uv; int speedo; scalar_t__ min_uv; int vid_mask; int max0_id; int max1_id; int max2_id; TYPE_2__* vid; struct nvkm_subdev subdev; struct nvkm_volt_func const* func; } ;
...
struct nvbios_volt {int vidmask; scalar_t__ base; scalar_t__ step; scalar_t__ min; scalar_t__ max; scalar_t__ type; scalar_t__ pwm_range; scalar_t__ ranged; } ;
struct nvbios_vmap_entry {int link; int min; int mode; int max; scalar_t__* arg; } ;
struct nvbios_vmap {int max0; int max1; int max2; } ;
typedef  int s64 ;
struct TYPE_4__ {int vid; int uv; } ;
...
/* Variables and functions */
 ...
 void* max (int,int) ; 
 void* min (void*,int) ; 
 int nvbios_vmap_entry_parse (struct nvkm_bios*,int,int*,int*,struct nvbios_vmap_entry*) ; 
 scalar_t__ nvbios_vmap_parse (struct nvkm_bios*,int*,int*,int*,int*,struct nvbios_vmap*) ; 
 int nvbios_volt_entry_parse (struct nvkm_bios*,int,int*,int*,struct nvbios_volt_entry*) ; 
 int nvbios_volt_parse (struct nvkm_bios*,int*,int*,int*,int*,struct nvbios_volt*) ; 
 int /*<<< orphan*/  nvkm_debug (struct nvkm_subdev*,char*,...) ; 
 int /*<<< orphan*/  nvkm_error (struct nvkm_subdev*,char*,int) ; 
 int /*<<< orphan*/  nvkm_subdev_ctor (void* (*) (struct nvkm_subdev*),struct nvkm_device*,int,struct nvkm_subdev*) ; 
 void* nvkm_volt (struct nvkm_subdev*) ; 
 int stub1 (struct nvkm_volt*) ; 
 int stub2 (struct nvkm_volt*) ; 
 int stub3 (struct nvkm_volt*,int) ; 
 int stub4 (struct nvkm_volt*,int) ; 
 int stub5 (struct nvkm_volt*,int,int) ; 
 int stub6 (struct nvkm_volt*) ; 
 int stub7 (struct nvkm_volt*) ; 
