...
struct stat {double st_size; int /*<<< orphan*/  st_mode; } ;
struct fontlist {int isbinary; int isascii; int ishex; char* name; double len; } ;
struct dirent {char* d_name; } ;
typedef  void forever ;
typedef  int /*<<< orphan*/  buffer ;
struct TYPE_10__ {int /*<<< orphan*/  outline; } ;
struct TYPE_9__ {unsigned int num_glyphs; int num_faces; TYPE_4__* glyph; } ;
...
/* Variables and functions */
 ...
 struct fontlist* realloc (struct fontlist*,unsigned int) ; 
 char* results_dir ; 
