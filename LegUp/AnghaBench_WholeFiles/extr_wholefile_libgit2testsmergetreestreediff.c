...
/* Type definitions */
struct TYPE_28__ {int member_0; char* member_1; char* member_3; int /*<<< orphan*/  member_2; } ;
struct TYPE_27__ {int /*<<< orphan*/  member_1; TYPE_6__ member_0; } ;
struct TYPE_26__ {int member_0; char* member_1; char* member_3; int /*<<< orphan*/  member_2; } ;
struct TYPE_25__ {int /*<<< orphan*/  member_1; TYPE_4__ member_0; } ;
struct TYPE_24__ {int member_0; char* member_1; char* member_3; int /*<<< orphan*/  member_2; } ;
struct TYPE_23__ {int /*<<< orphan*/  member_1; TYPE_2__ member_0; } ;
struct merge_index_conflict_data {int /*<<< orphan*/  member_3; TYPE_5__ member_2; TYPE_3__ member_1; TYPE_1__ member_0; } ;
typedef  int /*<<< orphan*/  git_tree ;
typedef  int /*<<< orphan*/  git_oid ;
struct TYPE_29__ {int target_limit; int rename_threshold; TYPE_17__* metric; int /*<<< orphan*/  flags; } ;
typedef  TYPE_7__ git_merge_options ;
struct TYPE_21__ {size_t length; } ;
struct TYPE_30__ {TYPE_10__ conflicts; } ;
typedef  TYPE_8__ git_merge_diff_list ;
struct TYPE_31__ {int /*<<< orphan*/  flags; } ;
typedef  TYPE_9__ git_iterator_options ;
typedef  int /*<<< orphan*/  git_iterator ;
typedef  int /*<<< orphan*/  git_diff_similarity_metric ;
struct TYPE_22__ {void* payload; int /*<<< orphan*/  similarity; int /*<<< orphan*/  free_signature; int /*<<< orphan*/  buffer_signature; int /*<<< orphan*/  file_signature; } ;
...
/* Variables and functions */
 ...
 TYPE_9__ GIT_ITERATOR_OPTIONS_INIT ; 
 ...
 TYPE_7__ GIT_MERGE_OPTIONS_INIT ; 
 int /*<<< orphan*/  TEST_REPO_PATH ; 
 char* TREE_OID_ANCESTOR ; 
 char* TREE_OID_BRANCH ; 
 char* TREE_OID_DF_ANCESTOR ; 
 char* TREE_OID_DF_SIDE1 ; 
 char* TREE_OID_DF_SIDE2 ; 
 char* TREE_OID_MASTER ; 
 char* TREE_OID_RENAMES1 ; 
 char* TREE_OID_RENAMES2 ; 
 char* TREE_OID_RENAME_CONFLICT_ANCESTOR ; 
 char* TREE_OID_RENAME_CONFLICT_OURS ; 
 char* TREE_OID_RENAME_CONFLICT_THEIRS ; 
 int /*<<< orphan*/  cl_assert (int) ; 
 int /*<<< orphan*/  cl_git_pass (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  cl_git_sandbox_cleanup () ; 
 int /*<<< orphan*/  cl_git_sandbox_init (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  git__free (TYPE_17__*) ; 
 TYPE_17__* git__malloc (int) ; 
 ...
 int /*<<< orphan*/  git_iterator_for_tree (int /*<<< orphan*/ **,int /*<<< orphan*/ *,TYPE_9__*) ; 
 int /*<<< orphan*/  git_iterator_free (int /*<<< orphan*/ *) ; 
 TYPE_8__* git_merge_diff_list__alloc (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  git_merge_diff_list__find_differences (TYPE_8__*,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  git_merge_diff_list__find_renames (int /*<<< orphan*/ ,TYPE_8__*,TYPE_7__*) ; 
 int /*<<< orphan*/  git_merge_diff_list__free (TYPE_8__*) ; 
 int /*<<< orphan*/  git_oid_fromstr (int /*<<< orphan*/ *,char const*) ; 
 int /*<<< orphan*/  git_tree_free (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  git_tree_lookup (int /*<<< orphan*/ **,int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
 int merge_test_merge_conflicts (TYPE_10__*,struct merge_index_conflict_data*,size_t) ; 
 int /*<<< orphan*/  repo ; 
