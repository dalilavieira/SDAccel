...
/* Variables and functions */
 ...
 scalar_t__ Curl_timeleft (struct Curl_easy*,int /*<<< orphan*/ *,void*) ; 
 int Curl_write_plain (struct connectdata*,int /*<<< orphan*/ ,char*,scalar_t__,scalar_t__*) ; 
 void* FALSE ; 
 scalar_t__ SOCKET_READABLE (int /*<<< orphan*/ ,scalar_t__) ; 
 int SOCKET_WRITABLE (int /*<<< orphan*/ ,scalar_t__) ; 
 void* TRUE ; 
 int /*<<< orphan*/  curlx_nonblock (int /*<<< orphan*/ ,void*) ; 
