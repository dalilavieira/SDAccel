...
/* Type definitions */
struct TYPE_6__ {scalar_t__ ptBuffers_; } ;
struct TYPE_7__ {TYPE_1__ java_lang_Thread; } ;
struct TYPE_8__ {TYPE_2__ fields; } ;
typedef  TYPE_3__ java_lang_Thread ;
typedef  scalar_t__ U_32 ;
struct TYPE_9__ {int errorMessageBufferSize; char* errorMessageBuffer; char* reportedMessageBuffer; scalar_t__ reportedMessageBufferSize; scalar_t__ reportedErrorCode; scalar_t__ portableErrorCode; int platformErrorCode; } ;
typedef  TYPE_4__* PortlibPTBuffers_t ;
...
/* Variables and functions */
 ...
 void* XMLVM_ATOMIC_MALLOC (scalar_t__) ; 
 ...
 int /*<<< orphan*/  strerror_r (void*,char*,int) ; 
