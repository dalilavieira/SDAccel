...
struct screen_info {unsigned long phys_addr; unsigned long num_pages; int type; } ;
struct efi_boot_memmap {unsigned long* map_size; unsigned long* desc_size; unsigned long* buff_size; int /*<<< orphan*/ * key_ptr; int /*<<< orphan*/ * desc_ver; struct screen_info** map; } ;
typedef  int /*<<< orphan*/  efi_system_table_t ;
typedef  scalar_t__ efi_status_t ;
typedef  unsigned long efi_physical_addr_t ;
typedef  struct screen_info efi_memory_desc_t ;
...
#define  EFI_LOADER_DATA 128 
 ...
 scalar_t__ efi_relocate_kernel (int /*<<< orphan*/ *,unsigned long*,unsigned long,unsigned long,unsigned long,int /*<<< orphan*/ ) ; 
