...
struct nvbios_volt_entry {int vidmask; int ranged; int base; int step; int min; int max; int pwm_freq; int pwm_range; int voltage; int vid; void* type; } ;
struct nvbios_volt {int vidmask; int ranged; int base; int step; int min; int max; int pwm_freq; int pwm_range; int voltage; int vid; void* type; } ;
