...
typedef  char* ext2fs_block_bitmap ;
...
typedef  int blk64_t ;
typedef  int __u64 ;
struct TYPE_42__ {int flags; int blocksize; scalar_t__ group_desc_count; char* block_map; char* inode_map; int /*<<< orphan*/  io; int /*<<< orphan*/  image_io; TYPE_20__* super; TYPE_1__* image_header; int /*<<< orphan*/  device_name; scalar_t__ (* write_bitmaps ) (TYPE_2__*) ;int /*<<< orphan*/  inode_blocks_per_group; } ;
struct TYPE_41__ {int s_inodes_count; scalar_t__ s_first_data_block; } ;
struct TYPE_40__ {int /*<<< orphan*/  offset_blockmap; int /*<<< orphan*/  offset_inodemap; } ;

/* Variables and functions */
 int EXT2FS_B2C (TYPE_2__*,scalar_t__) ; 
 unsigned int EXT2FS_NUM_B2C (TYPE_2__*,int) ; 
 int /*<<< orphan*/  EXT2_BG_BLOCK_UNINIT ; 
 int /*<<< orphan*/  EXT2_BG_INODE_UNINIT ; 
 scalar_t__ EXT2_BLOCKS_PER_GROUP (TYPE_20__*) ; 
 int /*<<< orphan*/  EXT2_CHECK_MAGIC (TYPE_2__*,int /*<<< orphan*/ ) ; 
 int EXT2_CLUSTERS_PER_GROUP (TYPE_20__*) ; 
 ...
 int EXT2_FLAG_RW ; 
 int EXT2_GROUPS_TO_CLUSTERS (TYPE_20__*,scalar_t__) ; 
 int EXT2_INODES_PER_GROUP (TYPE_20__*) ; 
 ...
 scalar_t__ ext2fs_block_bitmap_csum_set (TYPE_2__*,scalar_t__,char*,int) ; 
 int /*<<< orphan*/  ext2fs_block_bitmap_csum_verify (TYPE_2__*,scalar_t__,char*,int) ; 
 int ext2fs_block_bitmap_loc (TYPE_2__*,scalar_t__) ; 
 int ext2fs_blocks_count (TYPE_20__*) ; 
 int /*<<< orphan*/  ext2fs_free_block_bitmap (char*) ; 
 int /*<<< orphan*/  ext2fs_free_inode_bitmap (char*) ; 
 int /*<<< orphan*/  ext2fs_free_mem (char**) ; 
 scalar_t__ ext2fs_get_block_bitmap_range2 (char*,int,int,char*) ; 
 scalar_t__ ext2fs_get_inode_bitmap_range2 (char*,int,int,char*) ; 
 ...
 scalar_t__ ext2fs_has_feature_gdt_csum (TYPE_20__*) ; 
 scalar_t__ ext2fs_has_feature_largedir (TYPE_20__*) ; 
 scalar_t__ ext2fs_has_feature_metadata_csum (TYPE_20__*) ; 
 scalar_t__ ext2fs_inode_bitmap_csum_set (TYPE_2__*,scalar_t__,char*,int) ; 
 int /*<<< orphan*/  ext2fs_inode_bitmap_csum_verify (TYPE_2__*,scalar_t__,char*,int) ; 
 int ext2fs_inode_bitmap_loc (TYPE_2__*,scalar_t__) ; 
 int ext2fs_inode_table_loc (TYPE_2__*,scalar_t__) ; 
 int ext2fs_le32_to_cpu (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ext2fs_mark_block_bitmap2 (char*,int) ; 
 int /*<<< orphan*/  ext2fs_mark_block_bitmap_range2 (char*,int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ext2fs_reserve_super_and_bgd (TYPE_2__*,scalar_t__,char*) ; 
 int /*<<< orphan*/  ext2fs_set_bit (unsigned int,char*) ; 
 scalar_t__ ext2fs_set_block_bitmap_range2 (char*,int,unsigned int,char*) ; 
 scalar_t__ ext2fs_set_inode_bitmap_range2 (char*,int,unsigned int,char*) ; 
 scalar_t__ ext2fs_test_bb_dirty (TYPE_2__*) ; 
 scalar_t__ ext2fs_test_ib_dirty (TYPE_2__*) ; 
 scalar_t__ ext2fs_write_bitmaps (TYPE_2__*) ; 
 scalar_t__ io_channel_alloc_buf (int /*<<< orphan*/ ,int /*<<< orphan*/ ,char**) ; 
 scalar_t__ io_channel_read_blk64 (int /*<<< orphan*/ ,int,int,char*) ; 
