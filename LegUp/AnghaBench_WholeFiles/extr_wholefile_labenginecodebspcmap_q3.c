...
struct TYPE_42__ {int contents; int surf; int flags; int planenum; int /*<<< orphan*/ * winding; int /*<<< orphan*/  texinfo; } ;
typedef  TYPE_2__ side_t ;
typedef  int qboolean ;
struct TYPE_43__ {int patchWidth; size_t shaderNum; int patchHeight; int firstVert; } ;
typedef  TYPE_3__ q3_dsurface_t ;
struct TYPE_44__ {int /*<<< orphan*/ * xyz; } ;
typedef  TYPE_4__ q3_drawVert_t ;
struct TYPE_45__ {scalar_t__ dist; scalar_t__* normal; } ;
typedef  TYPE_5__ q3_dplane_t ;
struct TYPE_46__ {size_t shaderNum; size_t planeNum; } ;
typedef  TYPE_6__ q3_dbrushside_t ;
struct TYPE_47__ {int numSides; int firstSide; size_t shaderNum; } ;
typedef  TYPE_7__ q3_dbrush_t ;
struct TYPE_48__ {int numFacets; TYPE_1__* planes; TYPE_10__* facets; } ;
typedef  TYPE_8__ patchCollide_t ;
struct TYPE_49__ {int numsides; int contents; int entitynum; size_t brushnum; int /*<<< orphan*/ * maxs; int /*<<< orphan*/ * mins; TYPE_2__* original_sides; int /*<<< orphan*/  leafnum; } ;
typedef  TYPE_9__ mapbrush_t ;
struct TYPE_36__ {int numBorders; size_t surfacePlane; size_t* borderPlanes; scalar_t__* borderInward; } ;
typedef  TYPE_10__ facet_t ;
struct TYPE_37__ {size_t firstbrush; int numbrushes; size_t modelnum; scalar_t__ areaportalnum; int /*<<< orphan*/  origin; } ;
typedef  TYPE_11__ entity_t ;
struct TYPE_41__ {scalar_t__* plane; } ;
struct TYPE_40__ {scalar_t__ dist; scalar_t__* normal; } ;
struct TYPE_39__ {int numBrushes; int firstBrush; } ;
struct TYPE_38__ {int contentFlags; int surfaceFlags; int /*<<< orphan*/  shader; } ;

/* Variables and functions */
 int /*<<< orphan*/  AAS_CreateMapBrushes (TYPE_9__*,TYPE_11__*,int) ; 
 int /*<<< orphan*/  AddBrushBevels (TYPE_9__*) ; 
 int /*<<< orphan*/  AddPointToBounds (int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/ * BaseWindingForPlane (scalar_t__*,scalar_t__) ; 
 scalar_t__ BrushExists (TYPE_9__*) ; 
 TYPE_8__* CM_GeneratePatchCollide (int,int,int /*<<< orphan*/ **) ; 
 int CONTENTS_DETAIL ; 
 ...
 int CONTENTS_NOBOTCLIP ; 
 int CONTENTS_PLAYERCLIP ; 
 int CONTENTS_SLIME ; 
 int CONTENTS_SOLID ; 
 int CONTENTS_STRUCTURAL ; 
 int CONTENTS_WATER ; 
 int /*<<< orphan*/  ChopWindingInPlace (int /*<<< orphan*/ **,scalar_t__*,scalar_t__,double) ; 
 int /*<<< orphan*/  ClearBounds (int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  Error (char*) ; 
 void* FindFloatPlane (scalar_t__*,scalar_t__) ; 
 int /*<<< orphan*/  GetVectorForKey (TYPE_11__*,char*,int /*<<< orphan*/ ) ; 
 ...
 int MAX_PATCH_VERTS ; 
 int /*<<< orphan*/  MakeBrushWindings (TYPE_9__*) ; 
 int /*<<< orphan*/  MarkBrushBevels (TYPE_9__*) ; 
 int NODESTACKSIZE ; 
 ...
 char* ValueForKey (TYPE_11__*,char*) ; 
 ...
 TYPE_7__* q3_dbrushes ; 
 TYPE_6__* q3_dbrushsides ; 
 scalar_t__* q3_dbrushsidetextured ; 
 TYPE_16__* q3_dmodels ; 
 TYPE_5__* q3_dplanes ; 
 TYPE_3__* q3_drawSurfaces ; 
 TYPE_4__* q3_drawVerts ; 
 TYPE_12__* q3_dshaders ; 
