...
struct TYPE_6__ {scalar_t__ visual; int accel; } ;
struct TYPE_4__ {int xres_virtual; int yres_virtual; int bits_per_pixel; } ;
struct fb_info {int flags; TYPE_3__ fix; TYPE_2__* fbops; TYPE_1__ var; struct mb862xxfb_par* par; scalar_t__ pseudo_palette; } ;
struct fb_image {unsigned char* data; int width; int height; int dx; int dy; int depth; size_t fg_color; size_t bg_color; } ;
struct fb_fillrect {size_t width; size_t height; size_t dx; size_t dy; size_t color; int rop; } ;
struct fb_copyarea {int sx; int dx; int sy; int dy; int height; int width; } ;
typedef  int __u32 ;
struct TYPE_5__ {void (* fb_fillrect ) (struct fb_info*,struct fb_fillrect const*) ;void (* fb_copyarea ) (struct fb_info*,struct fb_copyarea const*) ;void (* fb_imageblit ) (struct fb_info*,struct fb_image const*) ;} ;
...
#define  ROP_COPY 129 
#define  ROP_XOR 128 
 void cfb_copyarea (struct fb_info*,struct fb_copyarea const*) ; 
 void cfb_fillrect (struct fb_info*,struct fb_fillrect const*) ; 
 ...
 int /*<<< orphan*/  memcpy (size_t*,unsigned char const*,int) ; 
