...
struct cvmx_bootmem_named_block_desc {int size; int base_addr; scalar_t__* name; } ;
struct cvmx_bootmem_desc {int major_version; int head_addr; scalar_t__ named_block_array_addr; unsigned int named_block_num_blocks; int named_block_name_len; int /*<<< orphan*/  lock; scalar_t__ minor_version; } ;
...
/* Variables and functions */
 ...
 scalar_t__ CVMX_BOOTMEM_NAMED_GET_FIELD (int,int /*<<< orphan*/ ) ; 
 int NEXT_OFFSET ; 
 int SIZE_OFFSET ; 
