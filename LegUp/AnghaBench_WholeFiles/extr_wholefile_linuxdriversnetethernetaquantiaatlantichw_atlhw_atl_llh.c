...
/* Variables and functions */
 int /*<<< orphan*/  HW_ATL_GEN_INTR_MAP_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_GEN_INTR_STAT_ADR ; 
 int /*<<< orphan*/  HW_ATL_GLB_CPU_SCRATCH_SCP_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_GLB_CPU_SEM_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_GLB_MIF_ID_ADR ; 
 unsigned long HW_ATL_GLB_REG_RES_DIS_ADR ; 
 unsigned long HW_ATL_GLB_REG_RES_DIS_MSK ; 
 unsigned long HW_ATL_GLB_REG_RES_DIS_SHIFT ; 
 unsigned long HW_ATL_GLB_SOFT_RES_ADR ; 
 unsigned long HW_ATL_GLB_SOFT_RES_MSK ; 
 unsigned long HW_ATL_GLB_SOFT_RES_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_INTR_GLB_CTL_ADR ; 
 int /*<<< orphan*/  HW_ATL_INTR_THR_ADR (unsigned long) ; 
 ...
 unsigned long HW_ATL_ITR_REG_RES_DSBL_ADR ; 
 unsigned long HW_ATL_ITR_REG_RES_DSBL_MSK ; 
 unsigned long HW_ATL_ITR_REG_RES_DSBL_SHIFT ; 
 unsigned long HW_ATL_ITR_RES_ADR ; 
 unsigned long HW_ATL_ITR_RES_MSK ; 
 unsigned long HW_ATL_ITR_RES_SHIFT ; 
 unsigned long HW_ATL_MSM_REG_ACCESS_BUSY_ADR ; 
 unsigned long HW_ATL_MSM_REG_ACCESS_BUSY_MSK ; 
 unsigned long HW_ATL_MSM_REG_ACCESS_BUSY_SHIFT ; 
 unsigned long HW_ATL_MSM_REG_ADDR_ADR ; 
 unsigned long HW_ATL_MSM_REG_ADDR_MSK ; 
 unsigned long HW_ATL_MSM_REG_ADDR_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_MSM_REG_RD_DATA_ADR ; 
 unsigned long HW_ATL_MSM_REG_RD_STROBE_ADR ; 
 unsigned long HW_ATL_MSM_REG_RD_STROBE_MSK ; 
 unsigned long HW_ATL_MSM_REG_RD_STROBE_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_MSM_REG_WR_DATA_ADR ; 
 unsigned long HW_ATL_MSM_REG_WR_STROBE_ADR ; 
 unsigned long HW_ATL_MSM_REG_WR_STROBE_MSK ; 
 unsigned long HW_ATL_MSM_REG_WR_STROBE_SHIFT ; 
 unsigned long HW_ATL_PCI_REG_RES_DSBL_ADR ; 
 unsigned long HW_ATL_PCI_REG_RES_DSBL_MSK ; 
 unsigned long HW_ATL_PCI_REG_RES_DSBL_SHIFT ; 
 unsigned long HW_ATL_RDM_DCADCPUID_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DCADCPUID_MSK ; 
 unsigned long HW_ATL_RDM_DCADCPUID_SHIFT ; 
 unsigned long HW_ATL_RDM_DCADDESC_EN_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DCADDESC_EN_MSK ; 
 unsigned long HW_ATL_RDM_DCADDESC_EN_SHIFT ; 
 unsigned long HW_ATL_RDM_DCADHDR_EN_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DCADHDR_EN_MSK ; 
 unsigned long HW_ATL_RDM_DCADHDR_EN_SHIFT ; 
 unsigned long HW_ATL_RDM_DCADPAY_EN_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DCADPAY_EN_MSK ; 
 unsigned long HW_ATL_RDM_DCADPAY_EN_SHIFT ; 
 unsigned long HW_ATL_RDM_DCA_EN_ADR ; 
 unsigned long HW_ATL_RDM_DCA_EN_MSK ; 
 unsigned long HW_ATL_RDM_DCA_EN_SHIFT ; 
 unsigned long HW_ATL_RDM_DCA_MODE_ADR ; 
 unsigned long HW_ATL_RDM_DCA_MODE_MSK ; 
 unsigned long HW_ATL_RDM_DCA_MODE_SHIFT ; 
 unsigned long HW_ATL_RDM_DESCDDATA_SIZE_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DESCDDATA_SIZE_MSK ; 
 unsigned long HW_ATL_RDM_DESCDDATA_SIZE_SHIFT ; 
 unsigned long HW_ATL_RDM_DESCDEN_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DESCDEN_MSK ; 
 unsigned long HW_ATL_RDM_DESCDEN_SHIFT ; 
 unsigned long HW_ATL_RDM_DESCDHDR_SIZE_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DESCDHDR_SIZE_MSK ; 
 unsigned long HW_ATL_RDM_DESCDHDR_SIZE_SHIFT ; 
 unsigned long HW_ATL_RDM_DESCDHDR_SPLIT_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DESCDHDR_SPLIT_MSK ; 
 unsigned long HW_ATL_RDM_DESCDHDR_SPLIT_SHIFT ; 
 unsigned long HW_ATL_RDM_DESCDHD_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DESCDHD_MSK ; 
 unsigned long HW_ATL_RDM_DESCDHD_SHIFT ; 
 unsigned long HW_ATL_RDM_DESCDLEN_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DESCDLEN_MSK ; 
 unsigned long HW_ATL_RDM_DESCDLEN_SHIFT ; 
 unsigned long HW_ATL_RDM_DESCDRESET_ADR (unsigned long) ; 
 unsigned long HW_ATL_RDM_DESCDRESET_MSK ; 
 unsigned long HW_ATL_RDM_DESCDRESET_SHIFT ; 
 unsigned long HW_ATL_RDM_INT_DESC_WRB_EN_ADR ; 
 unsigned long HW_ATL_RDM_INT_DESC_WRB_EN_MSK ; 
 unsigned long HW_ATL_RDM_INT_DESC_WRB_EN_SHIFT ; 
 unsigned long HW_ATL_RDM_INT_RIM_EN_ADR ; 
 unsigned long HW_ATL_RDM_INT_RIM_EN_MSK ; 
 unsigned long HW_ATL_RDM_INT_RIM_EN_SHIFT ; 
 unsigned long HW_ATL_RDM_RX_DMA_DESC_CACHE_INIT_ADR ; 
 unsigned long HW_ATL_RDM_RX_DMA_DESC_CACHE_INIT_MSK ; 
 unsigned long HW_ATL_RDM_RX_DMA_DESC_CACHE_INIT_SHIFT ; 
 unsigned long HW_ATL_RPB_DMA_SYS_LBK_ADR ; 
 unsigned long HW_ATL_RPB_DMA_SYS_LBK_MSK ; 
 unsigned long HW_ATL_RPB_DMA_SYS_LBK_SHIFT ; 
 unsigned long HW_ATL_RPB_RPF_RX_TC_MODE_ADR ; 
 unsigned long HW_ATL_RPB_RPF_RX_TC_MODE_MSK ; 
 unsigned long HW_ATL_RPB_RPF_RX_TC_MODE_SHIFT ; 
 unsigned long HW_ATL_RPB_RXBBUF_SIZE_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPB_RXBBUF_SIZE_MSK ; 
 unsigned long HW_ATL_RPB_RXBBUF_SIZE_SHIFT ; 
 unsigned long HW_ATL_RPB_RXBHI_THRESH_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPB_RXBHI_THRESH_MSK ; 
 unsigned long HW_ATL_RPB_RXBHI_THRESH_SHIFT ; 
 unsigned long HW_ATL_RPB_RXBLO_THRESH_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPB_RXBLO_THRESH_MSK ; 
 unsigned long HW_ATL_RPB_RXBLO_THRESH_SHIFT ; 
 unsigned long HW_ATL_RPB_RXBXOFF_EN_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPB_RXBXOFF_EN_MSK ; 
 unsigned long HW_ATL_RPB_RXBXOFF_EN_SHIFT ; 
 unsigned long HW_ATL_RPB_RX_BUF_EN_ADR ; 
 unsigned long HW_ATL_RPB_RX_BUF_EN_MSK ; 
 unsigned long HW_ATL_RPB_RX_BUF_EN_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_RPB_RX_DMA_DROP_PKT_CNT_ADR ; 
 unsigned long HW_ATL_RPB_RX_FC_MODE_ADR ; 
 unsigned long HW_ATL_RPB_RX_FC_MODE_MSK ; 
 unsigned long HW_ATL_RPB_RX_FC_MODE_SHIFT ; 
 unsigned long HW_ATL_RPFL2BC_ACT_ADR ; 
 unsigned long HW_ATL_RPFL2BC_ACT_MSK ; 
 unsigned long HW_ATL_RPFL2BC_ACT_SHIFT ; 
 unsigned long HW_ATL_RPFL2BC_EN_ADR ; 
 unsigned long HW_ATL_RPFL2BC_EN_MSK ; 
 unsigned long HW_ATL_RPFL2BC_EN_SHIFT ; 
 unsigned long HW_ATL_RPFL2BC_THRESH_ADR ; 
 unsigned long HW_ATL_RPFL2BC_THRESH_MSK ; 
 unsigned long HW_ATL_RPFL2BC_THRESH_SHIFT ; 
 unsigned long HW_ATL_RPFL2MC_ACCEPT_ALL_ADR ; 
 unsigned long HW_ATL_RPFL2MC_ACCEPT_ALL_MSK ; 
 unsigned long HW_ATL_RPFL2MC_ACCEPT_ALL_SHIFT ; 
 unsigned long HW_ATL_RPFL2MC_ENF_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPFL2MC_ENF_MSK ; 
 unsigned long HW_ATL_RPFL2MC_ENF_SHIFT ; 
 unsigned long HW_ATL_RPFL2PROMIS_MODE_ADR ; 
 unsigned long HW_ATL_RPFL2PROMIS_MODE_MSK ; 
 unsigned long HW_ATL_RPFL2PROMIS_MODE_SHIFT ; 
 unsigned long HW_ATL_RPFL2UC_ACTF_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPFL2UC_ACTF_MSK ; 
 unsigned long HW_ATL_RPFL2UC_ACTF_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_RPFL2UC_DAFLSW_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPFL2UC_DAFMSW_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPFL2UC_DAFMSW_MSK ; 
 unsigned long HW_ATL_RPFL2UC_DAFMSW_SHIFT ; 
 unsigned long HW_ATL_RPFL2UC_ENF_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPFL2UC_ENF_MSK ; 
 unsigned long HW_ATL_RPFL2UC_ENF_SHIFT ; 
 unsigned long HW_ATL_RPF_ET_ACTF_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_ET_ACTF_MSK ; 
 unsigned long HW_ATL_RPF_ET_ACTF_SHIFT ; 
 unsigned long HW_ATL_RPF_ET_ENF_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_ET_ENF_MSK ; 
 unsigned long HW_ATL_RPF_ET_ENF_SHIFT ; 
 unsigned long HW_ATL_RPF_ET_MNG_RXQF_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_ET_MNG_RXQF_MSK ; 
 unsigned long HW_ATL_RPF_ET_MNG_RXQF_SHIFT ; 
 unsigned long HW_ATL_RPF_ET_RXQFEN_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_ET_RXQFEN_MSK ; 
 unsigned long HW_ATL_RPF_ET_RXQFEN_SHIFT ; 
 unsigned long HW_ATL_RPF_ET_RXQF_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_ET_RXQF_MSK ; 
 unsigned long HW_ATL_RPF_ET_RXQF_SHIFT ; 
 unsigned long HW_ATL_RPF_ET_UPFEN_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_ET_UPFEN_MSK ; 
 unsigned long HW_ATL_RPF_ET_UPFEN_SHIFT ; 
 unsigned long HW_ATL_RPF_ET_UPF_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_ET_UPF_MSK ; 
 unsigned long HW_ATL_RPF_ET_UPF_SHIFT ; 
 unsigned long HW_ATL_RPF_ET_VALF_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_ET_VALF_MSK ; 
 unsigned long HW_ATL_RPF_ET_VALF_SHIFT ; 
 unsigned long HW_ATL_RPF_RSS_KEY_ADDR_ADR ; 
 unsigned long HW_ATL_RPF_RSS_KEY_ADDR_MSK ; 
 unsigned long HW_ATL_RPF_RSS_KEY_ADDR_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_RPF_RSS_KEY_WR_DATA_ADR ; 
 unsigned long HW_ATL_RPF_RSS_KEY_WR_ENI_ADR ; 
 unsigned long HW_ATL_RPF_RSS_KEY_WR_ENI_MSK ; 
 unsigned long HW_ATL_RPF_RSS_KEY_WR_ENI_SHIFT ; 
 unsigned long HW_ATL_RPF_RSS_REDIR_ADDR_ADR ; 
 unsigned long HW_ATL_RPF_RSS_REDIR_ADDR_MSK ; 
 unsigned long HW_ATL_RPF_RSS_REDIR_ADDR_SHIFT ; 
 unsigned long HW_ATL_RPF_RSS_REDIR_WR_DATA_ADR ; 
 unsigned long HW_ATL_RPF_RSS_REDIR_WR_DATA_MSK ; 
 unsigned long HW_ATL_RPF_RSS_REDIR_WR_DATA_SHIFT ; 
 unsigned long HW_ATL_RPF_RSS_REDIR_WR_ENI_ADR ; 
 unsigned long HW_ATL_RPF_RSS_REDIR_WR_ENI_MSK ; 
 unsigned long HW_ATL_RPF_RSS_REDIR_WR_ENI_SHIFT ; 
 unsigned long HW_ATL_RPF_TPO_RPF_SYS_LBK_ADR ; 
 unsigned long HW_ATL_RPF_TPO_RPF_SYS_LBK_MSK ; 
 unsigned long HW_ATL_RPF_TPO_RPF_SYS_LBK_SHIFT ; 
 unsigned long HW_ATL_RPF_VL_ACCEPT_UNTAGGED_MODE_ADR ; 
 unsigned long HW_ATL_RPF_VL_ACCEPT_UNTAGGED_MODE_MSK ; 
 unsigned long HW_ATL_RPF_VL_ACCEPT_UNTAGGED_MODE_SHIFT ; 
 unsigned long HW_ATL_RPF_VL_ACT_F_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_VL_ACT_F_MSK ; 
 unsigned long HW_ATL_RPF_VL_ACT_F_SHIFT ; 
 unsigned long HW_ATL_RPF_VL_EN_F_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_VL_EN_F_MSK ; 
 unsigned long HW_ATL_RPF_VL_EN_F_SHIFT ; 
 unsigned long HW_ATL_RPF_VL_ID_F_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPF_VL_ID_F_MSK ; 
 unsigned long HW_ATL_RPF_VL_ID_F_SHIFT ; 
 unsigned long HW_ATL_RPF_VL_INNER_TPID_ADR ; 
 unsigned long HW_ATL_RPF_VL_INNER_TPID_MSK ; 
 unsigned long HW_ATL_RPF_VL_INNER_TPID_SHIFT ; 
 unsigned long HW_ATL_RPF_VL_OUTER_TPID_ADR ; 
 unsigned long HW_ATL_RPF_VL_OUTER_TPID_MSK ; 
 unsigned long HW_ATL_RPF_VL_OUTER_TPID_SHIFT ; 
 unsigned long HW_ATL_RPF_VL_PROMIS_MODE_ADR ; 
 unsigned long HW_ATL_RPF_VL_PROMIS_MODE_MSK ; 
 unsigned long HW_ATL_RPF_VL_PROMIS_MODE_SHIFT ; 
 unsigned long HW_ATL_RPF_VL_UNTAGGED_ACT_ADR ; 
 unsigned long HW_ATL_RPF_VL_UNTAGGED_ACT_MSK ; 
 unsigned long HW_ATL_RPF_VL_UNTAGGED_ACT_SHIFT ; 
 unsigned long HW_ATL_RPOL4CHK_EN_ADR ; 
 unsigned long HW_ATL_RPOL4CHK_EN_MSK ; 
 unsigned long HW_ATL_RPOL4CHK_EN_SHIFT ; 
 unsigned long HW_ATL_RPO_DESCDVL_STRIP_ADR (unsigned long) ; 
 unsigned long HW_ATL_RPO_DESCDVL_STRIP_MSK ; 
 unsigned long HW_ATL_RPO_DESCDVL_STRIP_SHIFT ; 
 unsigned long HW_ATL_RPO_IPV4CHK_EN_ADR ; 
 unsigned long HW_ATL_RPO_IPV4CHK_EN_MSK ; 
 unsigned long HW_ATL_RPO_IPV4CHK_EN_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_RPO_LRO_EN_ADR ; 
 unsigned long HW_ATL_RPO_LRO_INA_IVAL_ADR ; 
 unsigned long HW_ATL_RPO_LRO_INA_IVAL_MSK ; 
 unsigned long HW_ATL_RPO_LRO_INA_IVAL_SHIFT ; 
 unsigned long HW_ATL_RPO_LRO_MAX_IVAL_ADR ; 
 unsigned long HW_ATL_RPO_LRO_MAX_IVAL_MSK ; 
 unsigned long HW_ATL_RPO_LRO_MAX_IVAL_SHIFT ; 
 unsigned long HW_ATL_RPO_LRO_PKT_MIN_ADR ; 
 unsigned long HW_ATL_RPO_LRO_PKT_MIN_MSK ; 
 unsigned long HW_ATL_RPO_LRO_PKT_MIN_SHIFT ; 
 unsigned long HW_ATL_RPO_LRO_PTOPT_EN_ADR ; 
 unsigned long HW_ATL_RPO_LRO_PTOPT_EN_MSK ; 
 unsigned long HW_ATL_RPO_LRO_PTOPT_EN_SHIFT ; 
 unsigned long HW_ATL_RPO_LRO_QSES_LMT_ADR ; 
 unsigned long HW_ATL_RPO_LRO_QSES_LMT_MSK ; 
 unsigned long HW_ATL_RPO_LRO_QSES_LMT_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_RPO_LRO_RSC_MAX_ADR ; 
 unsigned long HW_ATL_RPO_LRO_TB_DIV_ADR ; 
 unsigned long HW_ATL_RPO_LRO_TB_DIV_MSK ; 
 unsigned long HW_ATL_RPO_LRO_TB_DIV_SHIFT ; 
 unsigned long HW_ATL_RPO_LRO_TOT_DSC_LMT_ADR ; 
 unsigned long HW_ATL_RPO_LRO_TOT_DSC_LMT_MSK ; 
 unsigned long HW_ATL_RPO_LRO_TOT_DSC_LMT_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_RX_DMA_DESC_BASE_ADDRLSW_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_RX_DMA_DESC_BASE_ADDRMSW_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_RX_DMA_DESC_STAT_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_RX_DMA_DESC_TAIL_PTR_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_RX_DMA_STAT_COUNTER7_ADR ; 
 int /*<<< orphan*/  HW_ATL_RX_FLR_CONTROL2_ADR ; 
 int /*<<< orphan*/  HW_ATL_RX_FLR_MCST_FLR_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_RX_FLR_MCST_FLR_MSK_ADR ; 
 int /*<<< orphan*/  HW_ATL_RX_FLR_RSS_CONTROL1_ADR ; 
 int /*<<< orphan*/  HW_ATL_RX_INTR_MODERATION_CTL_ADR (unsigned long) ; 
 unsigned long HW_ATL_RX_REG_RES_DSBL_ADR ; 
 unsigned long HW_ATL_RX_REG_RES_DSBL_MSK ; 
 unsigned long HW_ATL_RX_REG_RES_DSBL_SHIFT ; 
 ...
 unsigned long HW_ATL_TDM_DCADCPUID_ADR (unsigned long) ; 
 unsigned long HW_ATL_TDM_DCADCPUID_MSK ; 
 unsigned long HW_ATL_TDM_DCADCPUID_SHIFT ; 
 unsigned long HW_ATL_TDM_DCADDESC_EN_ADR (unsigned long) ; 
 unsigned long HW_ATL_TDM_DCADDESC_EN_MSK ; 
 unsigned long HW_ATL_TDM_DCADDESC_EN_SHIFT ; 
 unsigned long HW_ATL_TDM_DCA_EN_ADR ; 
 unsigned long HW_ATL_TDM_DCA_EN_MSK ; 
 unsigned long HW_ATL_TDM_DCA_EN_SHIFT ; 
 unsigned long HW_ATL_TDM_DCA_MODE_ADR ; 
 unsigned long HW_ATL_TDM_DCA_MODE_MSK ; 
 unsigned long HW_ATL_TDM_DCA_MODE_SHIFT ; 
 unsigned long HW_ATL_TDM_DESCDEN_ADR (unsigned long) ; 
 unsigned long HW_ATL_TDM_DESCDEN_MSK ; 
 unsigned long HW_ATL_TDM_DESCDEN_SHIFT ; 
 unsigned long HW_ATL_TDM_DESCDHD_ADR (unsigned long) ; 
 unsigned long HW_ATL_TDM_DESCDHD_MSK ; 
 unsigned long HW_ATL_TDM_DESCDHD_SHIFT ; 
 unsigned long HW_ATL_TDM_DESCDLEN_ADR (unsigned long) ; 
 unsigned long HW_ATL_TDM_DESCDLEN_MSK ; 
 unsigned long HW_ATL_TDM_DESCDLEN_SHIFT ; 
 unsigned long HW_ATL_TDM_DESCDWRB_THRESH_ADR (unsigned long) ; 
 unsigned long HW_ATL_TDM_DESCDWRB_THRESH_MSK ; 
 unsigned long HW_ATL_TDM_DESCDWRB_THRESH_SHIFT ; 
 unsigned long HW_ATL_TDM_INT_DESC_WRB_EN_ADR ; 
 unsigned long HW_ATL_TDM_INT_DESC_WRB_EN_MSK ; 
 unsigned long HW_ATL_TDM_INT_DESC_WRB_EN_SHIFT ; 
 unsigned long HW_ATL_TDM_INT_MOD_EN_ADR ; 
 unsigned long HW_ATL_TDM_INT_MOD_EN_MSK ; 
 unsigned long HW_ATL_TDM_INT_MOD_EN_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_TDM_LSO_EN_ADR ; 
 unsigned long HW_ATL_THM_LSO_TCP_FLAG_FIRST_ADR ; 
 unsigned long HW_ATL_THM_LSO_TCP_FLAG_FIRST_MSK ; 
 unsigned long HW_ATL_THM_LSO_TCP_FLAG_FIRST_SHIFT ; 
 unsigned long HW_ATL_THM_LSO_TCP_FLAG_LAST_ADR ; 
 unsigned long HW_ATL_THM_LSO_TCP_FLAG_LAST_MSK ; 
 unsigned long HW_ATL_THM_LSO_TCP_FLAG_LAST_SHIFT ; 
 unsigned long HW_ATL_THM_LSO_TCP_FLAG_MID_ADR ; 
 unsigned long HW_ATL_THM_LSO_TCP_FLAG_MID_MSK ; 
 unsigned long HW_ATL_THM_LSO_TCP_FLAG_MID_SHIFT ; 
 unsigned long HW_ATL_TPB_DMA_SYS_LBK_ADR ; 
 unsigned long HW_ATL_TPB_DMA_SYS_LBK_MSK ; 
 unsigned long HW_ATL_TPB_DMA_SYS_LBK_SHIFT ; 
 unsigned long HW_ATL_TPB_TXBBUF_SIZE_ADR (unsigned long) ; 
 unsigned long HW_ATL_TPB_TXBBUF_SIZE_MSK ; 
 unsigned long HW_ATL_TPB_TXBBUF_SIZE_SHIFT ; 
 unsigned long HW_ATL_TPB_TXBHI_THRESH_ADR (unsigned long) ; 
 unsigned long HW_ATL_TPB_TXBHI_THRESH_MSK ; 
 unsigned long HW_ATL_TPB_TXBHI_THRESH_SHIFT ; 
 unsigned long HW_ATL_TPB_TXBLO_THRESH_ADR (unsigned long) ; 
 unsigned long HW_ATL_TPB_TXBLO_THRESH_MSK ; 
 unsigned long HW_ATL_TPB_TXBLO_THRESH_SHIFT ; 
 unsigned long HW_ATL_TPB_TX_BUF_EN_ADR ; 
 unsigned long HW_ATL_TPB_TX_BUF_EN_MSK ; 
 unsigned long HW_ATL_TPB_TX_BUF_EN_SHIFT ; 
 unsigned long HW_ATL_TPB_TX_SCP_INS_EN_ADR ; 
 unsigned long HW_ATL_TPB_TX_SCP_INS_EN_MSK ; 
 unsigned long HW_ATL_TPB_TX_SCP_INS_EN_SHIFT ; 
 unsigned long HW_ATL_TPOL4CHK_EN_ADR ; 
 unsigned long HW_ATL_TPOL4CHK_EN_MSK ; 
 unsigned long HW_ATL_TPOL4CHK_EN_SHIFT ; 
 unsigned long HW_ATL_TPO_IPV4CHK_EN_ADR ; 
 unsigned long HW_ATL_TPO_IPV4CHK_EN_MSK ; 
 unsigned long HW_ATL_TPO_IPV4CHK_EN_SHIFT ; 
 unsigned long HW_ATL_TPO_PKT_SYS_LBK_ADR ; 
 unsigned long HW_ATL_TPO_PKT_SYS_LBK_MSK ; 
 unsigned long HW_ATL_TPO_PKT_SYS_LBK_SHIFT ; 
 unsigned long HW_ATL_TPS_DATA_TCTCREDIT_MAX_ADR (unsigned long) ; 
 unsigned long HW_ATL_TPS_DATA_TCTCREDIT_MAX_MSK ; 
 unsigned long HW_ATL_TPS_DATA_TCTCREDIT_MAX_SHIFT ; 
 unsigned long HW_ATL_TPS_DATA_TCTWEIGHT_ADR (unsigned long) ; 
 unsigned long HW_ATL_TPS_DATA_TCTWEIGHT_MSK ; 
 unsigned long HW_ATL_TPS_DATA_TCTWEIGHT_SHIFT ; 
 unsigned long HW_ATL_TPS_DATA_TC_ARB_MODE_ADR ; 
 unsigned long HW_ATL_TPS_DATA_TC_ARB_MODE_MSK ; 
 unsigned long HW_ATL_TPS_DATA_TC_ARB_MODE_SHIFT ; 
 unsigned long HW_ATL_TPS_DESC_RATE_LIM_ADR ; 
 unsigned long HW_ATL_TPS_DESC_RATE_LIM_MSK ; 
 unsigned long HW_ATL_TPS_DESC_RATE_LIM_SHIFT ; 
 unsigned long HW_ATL_TPS_DESC_RATE_TA_RST_ADR ; 
 unsigned long HW_ATL_TPS_DESC_RATE_TA_RST_MSK ; 
 unsigned long HW_ATL_TPS_DESC_RATE_TA_RST_SHIFT ; 
 unsigned long HW_ATL_TPS_DESC_TCTCREDIT_MAX_ADR (unsigned long) ; 
 unsigned long HW_ATL_TPS_DESC_TCTCREDIT_MAX_MSK ; 
 unsigned long HW_ATL_TPS_DESC_TCTCREDIT_MAX_SHIFT ; 
 unsigned long HW_ATL_TPS_DESC_TCTWEIGHT_ADR (unsigned long) ; 
 unsigned long HW_ATL_TPS_DESC_TCTWEIGHT_MSK ; 
 unsigned long HW_ATL_TPS_DESC_TCTWEIGHT_SHIFT ; 
 unsigned long HW_ATL_TPS_DESC_TC_ARB_MODE_ADR ; 
 unsigned long HW_ATL_TPS_DESC_TC_ARB_MODE_MSK ; 
 unsigned long HW_ATL_TPS_DESC_TC_ARB_MODE_SHIFT ; 
 unsigned long HW_ATL_TPS_DESC_VM_ARB_MODE_ADR ; 
 unsigned long HW_ATL_TPS_DESC_VM_ARB_MODE_MSK ; 
 unsigned long HW_ATL_TPS_DESC_VM_ARB_MODE_SHIFT ; 
 int /*<<< orphan*/  HW_ATL_TX_DMA_DEBUG_CTL_ADR ; 
 int /*<<< orphan*/  HW_ATL_TX_DMA_DESC_BASE_ADDRLSW_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_TX_DMA_DESC_BASE_ADDRMSW_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_TX_DMA_DESC_TAIL_PTR_ADR (unsigned long) ; 
 int /*<<< orphan*/  HW_ATL_TX_INTR_MODERATION_CTL_ADR (unsigned long) ; 
 unsigned long HW_ATL_TX_REG_RES_DSBL_ADR ; 
 unsigned long HW_ATL_TX_REG_RES_DSBL_MSK ; 
 unsigned long HW_ATL_TX_REG_RES_DSBL_SHIFT ; 
 unsigned long aq_hw_read_reg (struct aq_hw_s*,int /*<<< orphan*/ ) ; 
 unsigned long aq_hw_read_reg_bit (struct aq_hw_s*,unsigned long,unsigned long,unsigned long) ; 
 int /*<<< orphan*/  aq_hw_write_reg (struct aq_hw_s*,int /*<<< orphan*/ ,unsigned long) ; 
 int /*<<< orphan*/  aq_hw_write_reg_bit (struct aq_hw_s*,unsigned long,unsigned long,unsigned long,unsigned long) ; 
