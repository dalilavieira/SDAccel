...
struct jsm_channel {int ch_t_tlevel; unsigned char ch_startc; unsigned char ch_stopc; int ch_r_watermark; int ch_r_tlevel; int ch_flags; unsigned char ch_mostat; int ch_r_head; int ch_r_tail; int ch_cached_lsr; int ch_c_iflag; int* ch_equeue; int ch_e_head; int ch_mistat; int ch_c_cflag; TYPE_3__* ch_cls_uart; struct jsm_board* ch_bd; TYPE_4__ uart_port; scalar_t__ ch_e_tail; int /*<<< orphan*/  ch_xoff_sends; int /*<<< orphan*/  ch_xon_sends; int /*<<< orphan*/  ch_lock; int /*<<< orphan*/  ch_portnum; int /*<<< orphan*/  ch_txcount; int /*<<< orphan*/  ch_rxcount; int /*<<< orphan*/  ch_err_frame; int /*<<< orphan*/  ch_err_break; int /*<<< orphan*/  ch_err_parity; void** ch_rqueue; int /*<<< orphan*/  ch_err_overrun; } ;
struct jsm_board {size_t nasync; scalar_t__ bd_dividend; int /*<<< orphan*/  bd_intr_lock; int /*<<< orphan*/  pci_dev; int /*<<< orphan*/ * re_map_membase; struct jsm_channel** channels; } ;
struct circ_buf {int tail; unsigned char* buf; } ;
typedef  int /*<<< orphan*/  irqreturn_t ;
struct TYPE_12__ {unsigned int cflag; scalar_t__ rate; } ;
struct TYPE_10__ {int /*<<< orphan*/  txrx; int /*<<< orphan*/  lcr; int /*<<< orphan*/  lsr; int /*<<< orphan*/  ier; int /*<<< orphan*/  msr; int /*<<< orphan*/  isr_fcr; int /*<<< orphan*/  mcr; int /*<<< orphan*/  spr; } ;
struct TYPE_8__ {int /*<<< orphan*/  tty; } ;
struct TYPE_9__ {TYPE_1__ port; struct circ_buf xmit; } ;
