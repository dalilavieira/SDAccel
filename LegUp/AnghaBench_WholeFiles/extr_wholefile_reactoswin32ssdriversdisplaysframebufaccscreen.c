...
/* Type definitions */
struct TYPE_26__ {scalar_t__ ModeInformationLength; int NumModes; int NumberOfPlanes; int AttributeFlags; int BitsPerPlane; scalar_t__ Length; scalar_t__ VisScreenWidth; scalar_t__ VisScreenHeight; scalar_t__ Frequency; int RedChromaticity_x; int RedChromaticity_y; int GreenChromaticity_x; int GreenChromaticity_y; int BlueChromaticity_x; int BlueChromaticity_y; int WhiteChromaticity_x; int WhiteChromaticity_y; int RedGamma; int GreenGamma; int BlueGamma; int WhiteGamma; int /*<<< orphan*/  WhiteChromaticity_Y; int /*<<< orphan*/  NumberBlueBits; int /*<<< orphan*/  NumberGreenBits; int /*<<< orphan*/  NumberRedBits; int /*<<< orphan*/  YMillimeter; int /*<<< orphan*/  XMillimeter; int /*<<< orphan*/  BlueMask; int /*<<< orphan*/  GreenMask; int /*<<< orphan*/  RedMask; int /*<<< orphan*/  VideoMemoryBitmapHeight; int /*<<< orphan*/  VideoMemoryBitmapWidth; int /*<<< orphan*/  ScreenStride; int /*<<< orphan*/  ModeIndex; } ;
typedef  TYPE_11__ VIDEO_NUM_MODES ;
...
typedef  TYPE_11__* PVIDEO_MODE_INFORMATION ;
typedef  int PUCHAR ;
typedef  TYPE_14__* PPDEV ;
typedef  TYPE_15__* PGDIINFO ;
typedef  TYPE_16__* PDEVINFO ;
typedef  TYPE_17__* LPDEVMODEW ;
...
/* Variables and functions */
 ...
 scalar_t__ EngDeviceIoControl (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ ,TYPE_11__*,int,scalar_t__*) ; 
 int /*<<< orphan*/  EngFreeMem (TYPE_11__*) ; 
 int /*<<< orphan*/  FALSE ; 
