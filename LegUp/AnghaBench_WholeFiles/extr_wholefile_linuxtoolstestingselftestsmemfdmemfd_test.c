...
/* Variables and functions */
 unsigned int CLONE_FILES ; 
 unsigned int CLONE_FS ; 
 unsigned int CLONE_VM ; 
 int EPERM ; 
 int FALLOC_FL_KEEP_SIZE ; 
 int FALLOC_FL_PUNCH_HOLE ; 
 int /*<<< orphan*/  F_ADD_SEALS ; 
 int /*<<< orphan*/  F_GET_SEALS ; 
 unsigned int F_SEAL_GROW ; 
 unsigned int F_SEAL_SEAL ; 
 unsigned int F_SEAL_SHRINK ; 
 ...
 int S_IWUSR ; 
 int /*<<< orphan*/  abort () ; 
 scalar_t__ clone (int (*) (void*),int /*<<< orphan*/ *,unsigned int,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  close (int) ; 
 unsigned long default_huge_page_size () ; 
 int dup (int) ; 
 int fallocate (int,int,int /*<<< orphan*/ ,int) ; 
