...
/* Type definitions */
struct TYPE_19__ {int flags; int /*<<< orphan*/ * method_mont_p; int /*<<< orphan*/  const* q; int /*<<< orphan*/  const* p; int /*<<< orphan*/  pub_key; int /*<<< orphan*/  const* g; TYPE_1__* meth; int /*<<< orphan*/  lock; int /*<<< orphan*/  const* priv_key; } ;
struct TYPE_18__ {int /*<<< orphan*/  const* s; int /*<<< orphan*/  const* r; } ;
struct TYPE_17__ {int /*<<< orphan*/  (* dsa_mod_exp ) (TYPE_3__*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ ,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ;int /*<<< orphan*/  (* bn_mod_exp ) (TYPE_3__*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ;} ;
typedef  TYPE_2__ DSA_SIG ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  BN_consttime_swap (int /*<<< orphan*/ ,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int) ; 
 int /*<<< orphan*/  BN_free (int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  BN_generate_dsa_nonce (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,unsigned char const*,int,int /*<<< orphan*/ *) ; 
 ...
 int /*<<< orphan*/  BN_mod_add_quick (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  BN_mod_exp2_mont (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ ,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
 scalar_t__ BN_mod_exp_mont (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
 ...
 int /*<<< orphan*/  DSA_SIG_free (TYPE_2__*) ; 
 int /*<<< orphan*/  DSA_SIG_get0 (TYPE_2__*,int /*<<< orphan*/  const**,int /*<<< orphan*/  const**) ; 
 TYPE_2__* DSA_SIG_new () ; 
 int /*<<< orphan*/  DSAerr (int /*<<< orphan*/ ,int) ; 
 int ERR_R_BN_LIB ; 
 int OPENSSL_DSA_MAX_MODULUS_BITS ; 
 int bn_get_top (int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  bn_wexpand (int /*<<< orphan*/  const*,int) ; 
 int /*<<< orphan*/  const* default_DSA_method ; 
static  int /*<<< orphan*/  const* dsa_mod_inverse_fermat (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ *) ; 
static  int dsa_sign_setup (TYPE_3__*,int /*<<< orphan*/ *,int /*<<< orphan*/  const**,int /*<<< orphan*/  const**,unsigned char const*,int) ; 
 int /*<<< orphan*/  const openssl_dsa_meth ; 
 int /*<<< orphan*/  stub1 (TYPE_3__*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  stub2 (TYPE_3__*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ ,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
