...
/* Type definitions */
struct TYPE_3__ {scalar_t__ master; scalar_t__ worker_processes; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  lua_pushboolean (int /*<<< orphan*/ *,scalar_t__) ; 
...
static  int ngx_http_lua_ngx_worker_count (int /*<<< orphan*/ *) ; 
static  int ngx_http_lua_ngx_worker_exiting (int /*<<< orphan*/ *) ; 
static  int ngx_http_lua_ngx_worker_id (int /*<<< orphan*/ *) ; 
static  int ngx_http_lua_ngx_worker_pid (int /*<<< orphan*/ *) ; 
 scalar_t__ ngx_pid ; 
