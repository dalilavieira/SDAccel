...
typedef  struct TYPE_77__   TYPE_40__ ;
...
struct TYPE_83__ {int frame_type; int /*<<< orphan*/  frame_height; int /*<<< orphan*/  frame_width; int /*<<< orphan*/  valid; } ;
struct TYPE_82__ {int extradata_size; unsigned int const* extradata; int /*<<< orphan*/  level; int /*<<< orphan*/  profile; } ;
struct TYPE_81__ {int key_frame; scalar_t__ format; TYPE_14__* priv_data; int /*<<< orphan*/  picture_structure; int /*<<< orphan*/  pict_type; int /*<<< orphan*/  height; int /*<<< orphan*/  width; } ;
struct TYPE_80__ {int bit_depth; int /*<<< orphan*/  frame_height; int /*<<< orphan*/  frame_width; TYPE_9__* ref; TYPE_10__* sequence_header; } ;
struct TYPE_79__ {int nb_units; TYPE_4__* units; } ;
struct TYPE_78__ {int type; TYPE_11__* content; } ;
struct TYPE_77__ {TYPE_8__* log_ctx; TYPE_6__* priv_data; } ;
struct TYPE_76__ {int index; unsigned int size_in_bits_plus8; unsigned int* buffer; int size_in_bits; unsigned int const* buffer_end; } ;
struct TYPE_70__ {size_t frame_to_show_map_idx; int frame_type; int /*<<< orphan*/  show_frame; scalar_t__ show_existing_frame; } ;
struct TYPE_74__ {TYPE_12__ header; } ;
struct TYPE_75__ {TYPE_12__ frame_header; TYPE_1__ frame; } ;
struct TYPE_73__ {int type; } ;
struct TYPE_72__ {int parsed_extradata; TYPE_40__* cbc; TYPE_5__ temporal_unit; } ;
struct TYPE_71__ {size_t subsampling_x; size_t subsampling_y; int /*<<< orphan*/  mono_chrome; } ;
struct TYPE_69__ {TYPE_2__ obu; } ;
struct TYPE_68__ {int /*<<< orphan*/ * seq_level_idx; int /*<<< orphan*/  seq_profile; TYPE_13__ color_config; } ;
typedef  TYPE_3__ GetBitContext ;
typedef  TYPE_4__ CodedBitstreamUnit ;
typedef  TYPE_5__ CodedBitstreamFragment ;
typedef  TYPE_6__ CodedBitstreamAV1Context ;
typedef  TYPE_7__ AVCodecParserContext ;
typedef  TYPE_8__ AVCodecContext ;
typedef  TYPE_9__ AV1ReferenceFrameState ;
typedef  TYPE_10__ AV1RawSequenceHeader ;
typedef  TYPE_11__ AV1RawOBU ;
typedef  TYPE_12__ AV1RawFrameHeader ;
typedef  TYPE_13__ AV1RawColorConfig ;
typedef  TYPE_14__ AV1ParseContext ;
typedef  TYPE_15__ AV1OBU ;
...
#define  AV1_FRAME_SWITCH 128 
 ...
 int ff_av1_extract_obu (TYPE_15__*,unsigned int const*,int,TYPE_8__*) ; 
 int /*<<< orphan*/  ff_cbs_close (TYPE_40__**) ; 
 int /*<<< orphan*/  ff_cbs_fragment_free (TYPE_40__*,TYPE_5__*) ; 
 int /*<<< orphan*/  ff_cbs_fragment_reset (TYPE_40__*,TYPE_5__*) ; 
 int ff_cbs_read (TYPE_40__*,TYPE_5__*,unsigned int const*,int) ; 
