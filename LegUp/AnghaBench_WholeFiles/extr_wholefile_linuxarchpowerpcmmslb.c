...
struct TYPE_9__ {unsigned long slb_addr_limit; } ;
struct mm_struct {TYPE_4__ context; } ;
typedef  enum slb_index { ____Placeholder_slb_index } slb_index ;
typedef  enum ctx_state { ____Placeholder_ctx_state } ctx_state ;
struct TYPE_10__ {struct mm_struct* mm; } ;
struct TYPE_8__ {unsigned long slb_cache_ptr; unsigned long kstack; unsigned long* slb_cache; unsigned long vmalloc_sllp; int stab_rr; } ;
struct TYPE_7__ {unsigned long sllp; } ;
struct TYPE_6__ {int /*<<< orphan*/  vsid; int /*<<< orphan*/  esid; } ;
...
/* Variables and functions */
 ...
 int get_ea_context (TYPE_4__*,unsigned long) ; 
 ...
 unsigned int* slb_compare_rr_to_size ; 
 unsigned long slb_esid_mask (int) ; 
 unsigned int* slb_miss_kernel_load_io ; 
 unsigned int* slb_miss_kernel_load_linear ; 
...
__attribute__((used)) static void __slb_flush_and_rebolt(void)
{
