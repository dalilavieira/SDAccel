...
/* Variables and functions */
 int MAX (int,int) ; 
 int /*<<< orphan*/  kiss_fftnd (scalar_t__,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
 scalar_t__ kiss_fftnd_alloc (int const*,int,int,char*,size_t*) ; 
 int /*<<< orphan*/  kiss_fftr (scalar_t__,int /*<<< orphan*/  const*,int /*<<< orphan*/ *) ; 
 scalar_t__ kiss_fftr_alloc (int,int,TYPE_1__*,size_t*) ; 
 int /*<<< orphan*/  kiss_fftri (scalar_t__,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
