...
struct TYPE_5__ {scalar_t__ value; scalar_t__ enabled; scalar_t__ running; } ;
struct TYPE_4__ {int pinned; int exclude_kernel; int exclude_hv; int exclude_idle; } ;
struct event {TYPE_2__ result; TYPE_1__ attr; } ;
typedef  scalar_t__ pid_t ;
struct TYPE_6__ {int* pmc_enable; } ;
