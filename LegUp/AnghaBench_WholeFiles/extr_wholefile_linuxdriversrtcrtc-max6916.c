...
/* Variables and functions */
 ...
 unsigned char MAX6916_CONTROL_REG ; 
 unsigned char MAX6916_SECONDS_REG ; 
 unsigned char MAX6916_STATUS_REG ; 
 ...
 int /*<<< orphan*/  dev_info (struct device*,char*,unsigned char) ; 
