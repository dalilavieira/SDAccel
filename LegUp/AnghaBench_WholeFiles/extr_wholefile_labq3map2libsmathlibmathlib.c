...
/* Variables and functions */
 ...
 float DEG2RAD (float) ; 
 float DotProduct (double* const,double* const) ; 
 ...
 int PLANE_Z ; 
 double Q_PI ; 
 float RAD2DEG (scalar_t__) ; 
 size_t ROLL ; 
 int /*<<< orphan*/  VectorAdd (double*,double*,double*) ; 
 int /*<<< orphan*/  VectorClear (double*) ; 
 int /*<<< orphan*/  VectorCopy (double*,double*) ; 
 void VectorMA (double* const,float,double* const,double*) ; 
 float VectorNormalize (double* const,double*) ; 
 int /*<<< orphan*/  VectorScale (double* const,float,double*) ; 
 int /*<<< orphan*/  VectorSubtract (double* const,double* const,double*) ; 
 size_t YAW ; 
 scalar_t__ acos (double) ; 
 scalar_t__ atan2 (double,double) ; 
 float cos (float) ; 
 float fabs (double) ; 
