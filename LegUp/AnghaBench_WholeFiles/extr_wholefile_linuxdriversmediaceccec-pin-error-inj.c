...
struct TYPE_5__ {int len; size_t* msg; } ;
struct TYPE_4__ {size_t* msg; } ;
struct cec_pin {int* error_inj; int rx_bit; int rx_toggle; int tx_toggle; int tx_ignore_nack_until_eom; int tx_custom_pulse; int tx_custom_low_usecs; int tx_custom_high_usecs; int** error_inj_args; TYPE_2__ tx_msg; TYPE_1__ rx_msg; } ;
struct cec_adapter {struct cec_pin* pin; } ;
struct TYPE_6__ {char* cmd; unsigned int mode_offset; int arg_idx; } ;
