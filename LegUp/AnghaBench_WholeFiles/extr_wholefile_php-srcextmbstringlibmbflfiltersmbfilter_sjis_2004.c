...
/* Type definitions */
struct TYPE_10__ {int status; int cache; scalar_t__ illegal_mode; int (* flush_function ) (int /*<<< orphan*/ ) ;int /*<<< orphan*/  data; int /*<<< orphan*/  (* output_function ) (int,int /*<<< orphan*/ ) ;TYPE_2__* to; TYPE_1__* from; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  stub57 (int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub58 (int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub59 (int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub6 (int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub60 (int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub61 (int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub62 (int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub63 (int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub64 (int,int /*<<< orphan*/ ) ; 
 int stub65 (int /*<<< orphan*/ ) ; 
