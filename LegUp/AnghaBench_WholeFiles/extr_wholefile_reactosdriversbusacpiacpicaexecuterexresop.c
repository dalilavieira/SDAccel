...
struct TYPE_29__ {scalar_t__ Class; scalar_t__ RuntimeArgs; int /*<<< orphan*/  Name; } ;
struct TYPE_26__ {int Flags; scalar_t__ Type; } ;
struct TYPE_25__ {int const Class; } ;
struct TYPE_28__ {TYPE_2__ Common; TYPE_1__ Reference; } ;
struct TYPE_27__ {int /*<<< orphan*/  NumOperands; int /*<<< orphan*/  Operands; } ;
