...
struct sockaddr_in {void* sin_port; TYPE_1__ sin_addr; void* sin_family; int /*<<< orphan*/  member_0; } ;
struct sockaddr {int dummy; } ;
struct attack_target {int netmask; void* addr; } ;
struct attack_option {int dummy; } ;
struct attack_http_state {scalar_t__ state; int fd; char* path; char* orig_method; char* method; char* domain; char* user_agent; int keepalive; int last_recv; int content_length; scalar_t__ protection_type; char* rdbuf; int rdbuf_pos; int num_cookies; char** cookies; int last_send; int chunked; void* dst_addr; } ;
struct attack_cfnull_state {scalar_t__ state; int fd; char* domain; char* user_agent; int last_recv; int to_send; int last_send; void* dst_addr; } ;
