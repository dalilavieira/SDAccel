...
/* Type definitions */
struct TYPE_3__ {int version; unsigned char sectype; unsigned char len; unsigned char width; unsigned char height; } ;
struct TYPE_4__ {TYPE_1__ vnc; } ;
struct ProtocolState {unsigned int state; TYPE_2__ sub; } ;
struct InteractiveData {int dummy; } ;
struct BannerOutput {int dummy; } ;
typedef  void const Banner1 ;
