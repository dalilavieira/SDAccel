...
struct TYPE_50__ {int height; int width; } ;
struct TYPE_49__ {int key_frame; unsigned int** data; int* linesize; int /*<<< orphan*/  pict_type; } ;
struct TYPE_48__ {unsigned int* data; int size; } ;
struct TYPE_47__ {int index; unsigned int size_in_bits_plus8; unsigned int* buffer; int size_in_bits; unsigned int const* buffer_end; } ;
