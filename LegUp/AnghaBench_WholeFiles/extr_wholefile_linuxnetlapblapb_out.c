...
/* Type definitions */
struct sk_buff {int data; scalar_t__ sk; } ;
struct lapb_cb {int mode; int vs; int vr; unsigned short va; unsigned short window; int condition; scalar_t__ n2count; int /*<<< orphan*/  state; int /*<<< orphan*/  dev; int /*<<< orphan*/  ack_queue; int /*<<< orphan*/  write_queue; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  lapb_send_control (struct lapb_cb*,int /*<<< orphan*/ ,int,int) ; 
 ...
 void lapb_transmit_buffer (struct lapb_cb*,struct sk_buff*,int) ; 
