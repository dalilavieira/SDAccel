...
struct TYPE_12__ {size_t fallback_style; size_t default_script; int /*<<< orphan*/  no_stem_darkening; scalar_t__* darken_params; } ;
struct TYPE_11__ {size_t script; scalar_t__ coverage; } ;
