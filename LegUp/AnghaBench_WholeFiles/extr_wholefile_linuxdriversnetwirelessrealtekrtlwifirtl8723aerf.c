...
struct rtl_phy {int rf_type; int* rfreg_chnlval; int** mcs_txpwrlevel_origoffset; int const current_chan_bw; int pwrgroup_cnt; int num_total_rfpath; struct bb_reg_def* phyreg_def; } ;
...
struct rtl_mac {int act_scanning; struct ieee80211_vif* vif; } ;
struct rtl_hal {scalar_t__ state; } ;
struct rtl_efuse {scalar_t__ eeprom_regulatory; int** txpwr_legacyhtdiff; int** txpwr_ht20diff; int** pwrgroup_ht40; int** pwrgroup_ht20; } ;
...
static  int _rtl8723e_phy_rf6052_config_parafile (struct ieee80211_hw*) ; 
