...
struct TYPE_19__ {unsigned char brd_type; } ;
typedef  TYPE_2__ lboard_t ;
typedef  int /*<<< orphan*/  klinfo_t ;
struct TYPE_18__ {int physid; scalar_t__ virtid; } ;
struct TYPE_20__ {TYPE_1__ cpu_info; } ;
typedef  TYPE_3__ klcpu_t ;
struct TYPE_21__ {int /*<<< orphan*/ * g_nasidtable; } ;
typedef  TYPE_4__ gda_t ;
typedef  scalar_t__ cpuid_t ;
typedef  size_t cnodeid_t ;

/* Variables and functions */
 size_t CPUID_TO_COMPACT_NODEID (scalar_t__) ; 
 int CPUS_PER_NODE ; 
 TYPE_4__* GDA ; 
 size_t INVALID_CNODEID ; 
 int /*<<< orphan*/  INVALID_NASID ; 
 int /*<<< orphan*/ * KLCF_COMP (TYPE_2__*,int) ; 
 unsigned char KLCF_COMP_TYPE (int /*<<< orphan*/ *) ; 
 TYPE_2__* KLCF_NEXT (TYPE_2__*) ; 
 int KLCF_NUM_COMPS (TYPE_2__*) ; 
 scalar_t__ KLCLASS (unsigned char) ; 
 unsigned char KLSTRUCT_CPU ; 
 unsigned char KLTYPE_IP27 ; 
