...
/* Type definitions */
struct TYPE_50__ {int adapter_index; char obj_type; int obj_index; scalar_t__ read_only; scalar_t__ spare; } ;
union handle_word {long w; TYPE_19__ h; } ;
typedef  short u8 ;
typedef  long u32 ;
typedef  int u16 ;
struct hpios_spinlock {scalar_t__ lock_context; int /*<<< orphan*/  lock; } ;
struct TYPE_53__ {int /*<<< orphan*/  state; int /*<<< orphan*/  auxiliary_data_available; } ;
struct TYPE_52__ {int /*<<< orphan*/  state; int /*<<< orphan*/  auxiliary_data_available; } ;
struct TYPE_54__ {TYPE_21__ stream_info; TYPE_20__ legacy_stream_info; } ;
struct hpi_stream_res {TYPE_22__ u; } ;
struct hpi_response_header {int error; } ;
struct TYPE_49__ {long param1; long param2; short* an_log_value; } ;
struct TYPE_45__ {long* data; long bLER; } ;
struct TYPE_46__ {short s_level; TYPE_14__ rds; } ;
struct TYPE_42__ {long status; long readable_size; long writeable_size; } ;
struct TYPE_43__ {TYPE_11__ status; } ;
struct TYPE_79__ {int remaining_chars; char* sz_data; } ;
struct TYPE_47__ {TYPE_15__ tuner; TYPE_12__ cobranet; TYPE_8__ chars8; } ;
struct TYPE_76__ {int control_index; int src_node_type; int src_node_index; int dst_node_type; int dst_node_index; } ;
struct TYPE_73__ {long outstream_group_map; long instream_group_map; } ;
struct TYPE_51__ {short* p_buffer; struct hpi_hostbuffer_status* p_status; } ;
struct TYPE_65__ {int state; long buffer_size; long data_available; long samples_transferred; long auxiliary_data_available; } ;
struct TYPE_66__ {TYPE_3__ group_info; TYPE_1__ hostbuffer_info; TYPE_32__ stream_info; } ;
struct TYPE_67__ {TYPE_33__ u; } ;
struct TYPE_63__ {int parameter1; int parameter2; } ;
struct TYPE_59__ {int adapter_type; int num_outstreams; int num_instreams; int version; long serial_number; } ;
struct TYPE_57__ {long adapter_mode; } ;
struct TYPE_64__ {TYPE_30__ property_get; TYPE_27__ info; TYPE_25__ mode; } ;
struct TYPE_55__ {long data; int adapter_type; scalar_t__ adapter_index; scalar_t__ num_adapters; } ;
struct TYPE_68__ {TYPE_18__ c; TYPE_16__ cu; TYPE_5__ m; TYPE_34__ d; TYPE_31__ ax; TYPE_23__ s; } ;
struct hpi_response {int error; TYPE_35__ u; } ;
struct hpi_res_cobranet_hmiread {int byte_count; short* bytes; struct hpi_response_header h; } ;
struct hpi_msg_format {long sample_rate; long bit_rate; long attributes; int channels; int format; } ;
struct hpi_message_header {int adapter_index; int obj_index; int size; } ;
struct TYPE_80__ {long byte_count; long hmi_address; int /*<<< orphan*/  attribute; } ;
struct hpi_msg_cobranet_hmiwrite {short* bytes; struct hpi_message_header h; TYPE_9__ p; } ;
struct TYPE_41__ {long byte_count; long hmi_address; int /*<<< orphan*/  attribute; } ;
struct hpi_msg_cobranet_hmiread {struct hpi_message_header h; TYPE_10__ p; } ;
struct TYPE_48__ {int attribute; long param1; long param2; short* an_log_value; } ;
struct TYPE_44__ {int /*<<< orphan*/  attribute; } ;
struct TYPE_77__ {int command; int index; } ;
struct TYPE_78__ {TYPE_6__ store; } ;
struct TYPE_75__ {int node_type1; int node_index1; int node_type2; int node_index2; int control_type; int control_index; } ;
struct TYPE_62__ {int stream_index; char object_type; } ;
struct TYPE_70__ {short* pb_data; long data_size; struct hpi_msg_format format; } ;
struct TYPE_69__ {long punch_in_sample; long punch_out_sample; } ;
struct TYPE_71__ {short velocity; long time_scale; TYPE_2__ stream; TYPE_37__ data; TYPE_36__ pio; } ;
struct TYPE_72__ {TYPE_38__ u; } ;
struct TYPE_60__ {int property; int parameter1; int parameter2; } ;
struct TYPE_58__ {int index; } ;
struct TYPE_56__ {long adapter_mode; int query_or_set; } ;
struct TYPE_61__ {TYPE_28__ property_set; TYPE_26__ module_info; TYPE_24__ mode; } ;
struct TYPE_74__ {TYPE_17__ c; TYPE_13__ cu; TYPE_7__ mx; TYPE_4__ m; TYPE_39__ d; TYPE_29__ ax; } ;
struct hpi_message {int obj_index; int adapter_index; TYPE_40__ u; } ;
struct hpi_hostbuffer_status {int dummy; } ;
struct hpi_format {long sample_rate; long bit_rate; long attributes; int channels; int format; scalar_t__ unused; scalar_t__ mode_legacy; } ;
struct hpi_anc_frame {int dummy; } ;
struct consistent_dma_area {long dma_handle; scalar_t__ size; void* vaddr; } ;
...
/* Variables and functions */
 ...
 long HPI_COBRANET_HMI_cobra_if_phy_address ; 
 long HPI_COBRANET_HMI_cobra_ip_mon_currentIP ; 
 long HPI_COBRANET_HMI_cobra_ip_mon_staticIP ; 
 ...
 int HPI_ERROR_NO_INTERADAPTER_GROUPS ; 
 int HPI_ERROR_RESPONSE_BUFFER_TOO_SMALL ; 
#define  HPI_FORMAT_AA_TAGIT1_HITS 145 
#define  HPI_FORMAT_AA_TAGIT1_HITS_EX1 144 
#define  HPI_FORMAT_AA_TAGIT1_INSERTS 143 
#define  HPI_FORMAT_DOLBY_AC2 142 
#define  HPI_FORMAT_MPEG_L1 141 
#define  HPI_FORMAT_MPEG_L2 140 
#define  HPI_FORMAT_MPEG_L3 139 
#define  HPI_FORMAT_OEM1 138 
#define  HPI_FORMAT_OEM2 137 
#define  HPI_FORMAT_PCM16_BIGENDIAN 136 
#define  HPI_FORMAT_PCM16_SIGNED 135 
#define  HPI_FORMAT_PCM24_SIGNED 134 
#define  HPI_FORMAT_PCM32_FLOAT 133 
#define  HPI_FORMAT_PCM32_SIGNED 132 
#define  HPI_FORMAT_PCM8_UNSIGNED 131 
#define  HPI_FORMAT_RAW_BITSTREAM 130 
 ...
 int const HPI_OBJ_ADAPTER ; 
 int const HPI_OBJ_CONTROL ; 
#define  HPI_OBJ_ISTREAM 129 
 int const HPI_OBJ_MIXER ; 
#define  HPI_OBJ_OSTREAM 128 
 int const HPI_OBJ_SUBSYSTEM ; 
 ...
 void* HPI_VOLUME_AUTOFADE ; 
 int HPI_VOLUME_AUTOFADE_LOG ; 
 int HPI_VOLUME_GAIN ; 
 int HPI_VOLUME_MUTE ; 
 int HPI_VOLUME_NUM_CHANNELS ; 
 int HPI_VOLUME_RANGE ; 
 void* HPI_VOX_THRESHOLD ; 
 scalar_t__ IN_LOCK_BH ; 
 scalar_t__ IN_LOCK_IRQ ; 
 int hpi_adapter_set_mode_ex (int,long,int) ; 
 int hpi_control_param1_get (long,int,long*) ; 
 int hpi_control_param2_get (long,int,long*,long*) ; 
 int /*<<< orphan*/  hpi_init_message_response (struct hpi_message*,struct hpi_response*,int const,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  hpi_init_message_responseV1 (struct hpi_message_header*,int,struct hpi_response_header*,int,int const,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  hpi_send_recv (struct hpi_message*,struct hpi_response*) ; 
 scalar_t__ irqs_disabled () ; 
 int /*<<< orphan*/  memcpy (short*,short*,int) ; 
 long roundup_pow_of_two (long) ; 
