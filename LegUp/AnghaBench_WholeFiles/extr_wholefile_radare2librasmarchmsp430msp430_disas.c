...
typedef  int ut8 ;
typedef  int ut16 ;
struct msp430_cmd {char* operands; char* instr; int opcode; int jmp_addr; int jmp_cond; void* type; } ;
typedef  int st16 ;
...
#define  MSP430_CALL 141 
 ...
 int MSP430_MOV ; 
 void* MSP430_ONEOP ; 
#define  MSP430_PC 140 
#define  MSP430_PUSH 139 
#define  MSP430_R3 138 
#define  MSP430_RETI 137 
#define  MSP430_RRA 136 
#define  MSP430_RRC 135 
 int MSP430_SP ; 
#define  MSP430_SR 134 
 int MSP430_SUB ; 
 int MSP430_SUBC ; 
#define  MSP430_SWPB 133 
#define  MSP430_SXT 132 
 void* MSP430_TWOOP ; 
