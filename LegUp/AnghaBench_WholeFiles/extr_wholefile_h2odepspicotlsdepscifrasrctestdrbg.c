...
/* Variables and functions */
 ...
 int /*<<< orphan*/  cf_hash_drbg_sha256_gen (int /*<<< orphan*/ *,char*,int) ; 
 int /*<<< orphan*/  cf_hash_drbg_sha256_gen_additional (int /*<<< orphan*/ *,char*,int,char*,int) ; 
 int /*<<< orphan*/  cf_hash_drbg_sha256_init (int /*<<< orphan*/ *,char*,int,char*,int,char*,int) ; 
 int /*<<< orphan*/  cf_hash_drbg_sha256_reseed (int /*<<< orphan*/ *,char*,int,char*,int) ; 
 int /*<<< orphan*/  cf_hmac_drbg_gen (int /*<<< orphan*/ *,char*,int) ; 
 int /*<<< orphan*/  cf_hmac_drbg_gen_additional (int /*<<< orphan*/ *,char*,int,char*,int) ; 
 int /*<<< orphan*/  cf_hmac_drbg_init (int /*<<< orphan*/ *,int /*<<< orphan*/ *,char*,int,char*,int,int /*<<< orphan*/ *,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  cf_hmac_drbg_reseed (int /*<<< orphan*/ *,char*,int,char*,int) ; 
 int /*<<< orphan*/  cf_sha1 ; 
