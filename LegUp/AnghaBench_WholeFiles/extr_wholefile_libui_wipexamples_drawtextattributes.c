...
struct TYPE_12__ {int X; int Y; scalar_t__ Height; scalar_t__ Width; } ;
...
struct TYPE_14__ {char* Family; int Double; uintptr_t Value; double R; double G; double B; double A; int /*<<< orphan*/ * Features; void* Type; } ;
typedef  TYPE_3__ uiAttributeSpec ;
struct TYPE_15__ {int /*<<< orphan*/  Context; scalar_t__ AreaWidth; scalar_t__ AreaHeight; } ;
typedef  TYPE_4__ uiAreaDrawParams ;
struct example {char* name; void (* draw ) (TYPE_4__*) ;int /*<<< orphan*/ * key; int /*<<< orphan*/ * mouse; int /*<<< orphan*/  panel; } ;
struct TYPE_17__ {int /*<<< orphan*/  Align; TYPE_5__* DefaultFont; int /*<<< orphan*/  String; scalar_t__ Width; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  uiAttributedStringSetAttribute (int /*<<< orphan*/ ,TYPE_3__*,size_t,size_t) ; 
 ...
 int /*<<< orphan*/  uiOpenTypeFeaturesAdd (int /*<<< orphan*/ *,char const,char const,char const,char const,int) ; 
