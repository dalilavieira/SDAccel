...
struct v4l2_subdev_mbus_code_enum {scalar_t__ index; void* code; } ;
struct v4l2_mbus_framefmt {int width; int height; int /*<<< orphan*/  field; int /*<<< orphan*/  colorspace; void* code; } ;
...
struct adv748x_state {scalar_t__* endpoints; int /*<<< orphan*/  mutex; } ;
struct TYPE_9__ {int error; int /*<<< orphan*/ * lock; } ;
struct TYPE_8__ {int /*<<< orphan*/  entity; TYPE_2__* ctrl_handler; } ;
struct adv748x_afe {int curr_norm; int streaming; unsigned int input; TYPE_2__ ctrl_hdl; TYPE_1__ sd; struct media_pad* pads; } ;
...
#define  V4L2_CID_TEST_PATTERN 128 
 ...
 int /*<<< orphan*/  v4l2_ctrl_new_std (TYPE_2__*,int /*<<< orphan*/ *,int const,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  v4l2_ctrl_new_std_menu_items (TYPE_2__*,int /*<<< orphan*/ *,int const,scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
