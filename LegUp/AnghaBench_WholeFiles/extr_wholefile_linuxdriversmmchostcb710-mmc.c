...
struct mmc_request {struct mmc_command* stop; struct mmc_command* cmd; } ;
struct mmc_ios {int clock; scalar_t__ power_mode; scalar_t__ bus_width; } ;
struct mmc_host {int f_max; int f_min; int ocr_avail; int /*<<< orphan*/  caps; int /*<<< orphan*/ * ops; } ;
struct mmc_data {int blksz; int blocks; int flags; int bytes_xfered; int error; int /*<<< orphan*/  sg_len; int /*<<< orphan*/  sg; } ;
struct mmc_command {unsigned int flags; int opcode; int* resp; int error; size_t arg; struct mmc_data* data; } ;
struct cb710_slot {scalar_t__ iobase; int /*<<< orphan*/  pdev; } ;
struct cb710_mmc_reader {scalar_t__ last_power_mode; int /*<<< orphan*/  finish_req_tasklet; int /*<<< orphan*/  irq_lock; struct mmc_request* mrq; } ;
struct cb710_chip {struct pci_dev* pdev; } ;
...
/* Variables and functions */
 ...
 scalar_t__ CB710_MMC_CMD_PARAM_PORT ; 
 scalar_t__ CB710_MMC_CMD_TYPE_PORT ; 
 ...
 scalar_t__ CB710_MMC_CONFIGB_PORT ; 
 scalar_t__ CB710_MMC_CONFIG_PORT ; 
 scalar_t__ CB710_MMC_DATA_PORT ; 
 int CB710_MMC_DATA_READ ; 
 unsigned short CB710_MMC_IE_CARD_INSERTION_STATUS ; 
 int CB710_MMC_IE_CISTATUS_MASK ; 
 unsigned short CB710_MMC_IE_IRQ_ENABLE ; 
 unsigned short CB710_MMC_IE_TEST_MASK ; 
 scalar_t__ CB710_MMC_IRQ_ENABLE_PORT ; 
 scalar_t__ CB710_MMC_RESPONSE0_PORT ; 
 scalar_t__ CB710_MMC_RESPONSE1_PORT ; 
 scalar_t__ CB710_MMC_RESPONSE2_PORT ; 
 scalar_t__ CB710_MMC_RESPONSE3_PORT ; 
 ...
 scalar_t__ CB710_MMC_STATUS_PORT ; 
 scalar_t__ CB710_MMC_TRANSFER_SIZE_PORT ; 
 int EILSEQ ; 
 int EINVAL ; 
 int EIO ; 
 int ENOMEM ; 
...
#define  MMC_CMD_AC 134 
#define  MMC_CMD_ADTC 133 
#define  MMC_CMD_BC 132 
#define  MMC_CMD_BCR 131 
...
#define  MMC_POWER_UP 128 
 ...
 unsigned short cb710_read_port_16 (struct cb710_slot*,scalar_t__) ; 
 int cb710_read_port_32 (struct cb710_slot*,scalar_t__) ; 
 int cb710_read_port_8 (struct cb710_slot*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  cb710_set_irq_handler (struct cb710_slot*,int (*) (struct cb710_slot*)) ; 
 ...
 int /*<<< orphan*/  cb710_write_port_16 (struct cb710_slot*,scalar_t__,int) ; 
 int /*<<< orphan*/  cb710_write_port_32 (struct cb710_slot*,scalar_t__,size_t) ; 
