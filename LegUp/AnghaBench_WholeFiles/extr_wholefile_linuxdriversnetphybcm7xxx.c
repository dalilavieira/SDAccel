...
typedef  struct bcm7xxx_regs   TYPE_3__ ;
...
struct phy_device {int phy_id; TYPE_1__ mdio; struct bcm7xxx_phy_priv* priv; TYPE_2__* drv; int /*<<< orphan*/  dev_flags; } ;
struct ethtool_tunable {int id; } ;
struct ethtool_stats {int dummy; } ;
struct bcm7xxx_phy_priv {int /*<<< orphan*/  stats; } ;
struct bcm7xxx_regs {int reg; int value; } ;
struct TYPE_5__ {int phy_id_mask; int /*<<< orphan*/  name; } ;
...
/* Variables and functions */
 ...
 unsigned int ARRAY_SIZE (TYPE_3__ const*) ; 
 int BMCR_ANENABLE ; 
 int BMCR_ANRESTART ; 
 int BMCR_SPEED100 ; 
 ...
 int ENOMEM ; 
 int EOPNOTSUPP ; 
#define  ETHTOOL_PHY_DOWNSHIFT 131 
...
#define  MII_BCM7XXX_TEST 128 
 ...
 int bcm_phy_downshift_set (struct phy_device*,int) ; 
