...
struct TYPE_4__ {int /*<<< orphan*/  const* N; int /*<<< orphan*/  const* g; } ;
typedef  TYPE_1__ SRP_gN ;
typedef  int /*<<< orphan*/  const BIGNUM ;

/* Variables and functions */
 int /*<<< orphan*/  ADD_TEST (int (*) ()) ; 
 int /*<<< orphan*/  const* BN_bin2bn (unsigned char*,int,int /*<<< orphan*/ *) ; 
 ...
 int BN_hex2bn (int /*<<< orphan*/  const**,char const*) ; 
 int RANDOM_SIZE ; 
 int /*<<< orphan*/  RAND_bytes (unsigned char*,int) ; 
 int /*<<< orphan*/  const* SRP_Calc_A (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  const* SRP_Calc_B (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  const* SRP_Calc_client_key (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  const* SRP_Calc_server_key (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  const* SRP_Calc_u (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  const* SRP_Calc_x (int /*<<< orphan*/  const*,char const*,char const*) ; 
 int SRP_Verify_A_mod_N (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int SRP_Verify_B_mod_N (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int SRP_create_verifier_BN (char const*,char const*,int /*<<< orphan*/  const**,int /*<<< orphan*/  const**,int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 TYPE_1__* SRP_get_default_gN (char*) ; 
 int TEST_BN_eq (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  TEST_BN_ne_zero (int /*<<< orphan*/  const*) ; 
 ...
 int /*<<< orphan*/  test_output_bignum (char*,int /*<<< orphan*/  const*) ; 
