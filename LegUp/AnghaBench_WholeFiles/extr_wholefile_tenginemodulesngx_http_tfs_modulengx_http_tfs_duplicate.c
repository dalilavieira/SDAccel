...
struct TYPE_43__ {scalar_t__ len; scalar_t__ data; } ;
typedef  TYPE_10__ ngx_str_t ;
typedef  int /*<<< orphan*/  ngx_pool_t ;
typedef  int /*<<< orphan*/  ngx_log_t ;
typedef  scalar_t__ ngx_int_t ;
typedef  int /*<<< orphan*/  ngx_http_tfs_tair_server_addr_info_t ;
struct TYPE_58__ {scalar_t__ cluster_id; TYPE_8__* segment_data; } ;
struct TYPE_55__ {int /*<<< orphan*/  use_cache; int /*<<< orphan*/  remote_ctx; } ;
struct TYPE_51__ {scalar_t__ block_id; scalar_t__ seq_id; scalar_t__ suffix; } ;
struct TYPE_46__ {scalar_t__ cluster_id; TYPE_2__ file; } ;
struct TYPE_52__ {int code; } ;
struct TYPE_54__ {TYPE_13__ fsname; TYPE_10__ file_suffix; int /*<<< orphan*/  unlink_type; TYPE_3__ action; } ;
struct TYPE_44__ {int state; TYPE_9__ file; int /*<<< orphan*/ * out_bufs; void* use_dedup; void* is_stat_dup_file; TYPE_6__ block_cache_ctx; int /*<<< orphan*/ * log; int /*<<< orphan*/  data; TYPE_5__ r_ctx; TYPE_4__* tfs_peer; int /*<<< orphan*/ * pool; int /*<<< orphan*/  meta_segment_data; TYPE_12__* rc_info_node; } ;
typedef  TYPE_11__ ngx_http_tfs_t ;
struct TYPE_45__ {int /*<<< orphan*/  remote_block_cache_info; int /*<<< orphan*/  use_remote_block_cache; } ;
typedef  TYPE_12__ ngx_http_tfs_rcs_info_t ;
typedef  TYPE_13__ ngx_http_tfs_raw_fsname_t ;
struct TYPE_47__ {int md5_sumed; TYPE_10__ dup_file_suffix; TYPE_10__ dup_file_name; int /*<<< orphan*/  save_body_buffer; int /*<<< orphan*/  file_data; int /*<<< orphan*/  file_ref_count; TYPE_11__* data; int /*<<< orphan*/  tair_instance; int /*<<< orphan*/ * tair_key; int /*<<< orphan*/  dup_version; } ;
typedef  TYPE_14__ ngx_http_tfs_dedup_ctx_t ;
struct TYPE_48__ {int /*<<< orphan*/  version; TYPE_1__* value; } ;
typedef  TYPE_15__ ngx_http_tair_key_value_t ;
struct TYPE_49__ {scalar_t__ len; int /*<<< orphan*/ * data; void* type; } ;
typedef  TYPE_16__ ngx_http_tair_data_t ;
typedef  int /*<<< orphan*/  ngx_array_t ;
typedef  int /*<<< orphan*/  int32_t ;
struct TYPE_56__ {int /*<<< orphan*/  file_id; int /*<<< orphan*/  block_id; } ;
struct TYPE_57__ {TYPE_7__ segment_info; } ;
struct TYPE_53__ {int /*<<< orphan*/  body_buffer; } ;
struct TYPE_50__ {scalar_t__ len; int /*<<< orphan*/ * data; } ;
...
#define  NGX_HTTP_TFS_ACTION_WRITE_FILE 136 
 ...
 void* NGX_HTTP_TFS_DUPLICATE_KEY_SIZE ; 
...
static  void ngx_http_tfs_dedup_callback (TYPE_14__*,scalar_t__) ; 
static  void ngx_http_tfs_dedup_get_handler (TYPE_15__*,scalar_t__,void*) ; 
static  void ngx_http_tfs_dedup_remove_handler (scalar_t__,void*) ; 
static  void ngx_http_tfs_dedup_set_handler (scalar_t__,void*) ; 
 int /*<<< orphan*/  ngx_http_tfs_finalize_request (int /*<<< orphan*/ ,TYPE_11__*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ngx_http_tfs_finalize_state (TYPE_11__*,scalar_t__) ; 
 ...
 int /*<<< orphan*/  ngx_http_tfs_lookup_block_cache (TYPE_11__*) ; 
 scalar_t__ ngx_http_tfs_raw_fsname_parse (TYPE_10__*,TYPE_10__*,TYPE_13__*) ; 
 scalar_t__ ngx_http_tfs_sum_md5 (int /*<<< orphan*/ ,int /*<<< orphan*/ *,scalar_t__*,int /*<<< orphan*/ *) ; 
 scalar_t__ ngx_http_tfs_tair_delete_helper (int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *,void (*) (scalar_t__,void*),TYPE_14__*) ; 
 scalar_t__ ngx_http_tfs_tair_get_helper (int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *,TYPE_16__*,void (*) (TYPE_15__*,scalar_t__,void*),TYPE_14__*) ; 
 scalar_t__ ngx_http_tfs_tair_put_helper (int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *,TYPE_16__*,TYPE_16__*,int /*<<< orphan*/ ,int /*<<< orphan*/ ,void (*) (scalar_t__,void*),TYPE_14__*) ; 
 int /*<<< orphan*/  ngx_log_debug3 (int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ ,char*,TYPE_10__*,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ngx_log_error (int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ ,char*) ; 
 int /*<<< orphan*/  ngx_memcpy (int /*<<< orphan*/ *,int /*<<< orphan*/ *,scalar_t__) ; 
 TYPE_10__ ngx_null_string ; 
 void* ngx_pcalloc (int /*<<< orphan*/ *,scalar_t__) ; 
