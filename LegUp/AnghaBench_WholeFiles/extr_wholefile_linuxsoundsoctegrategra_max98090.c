...
struct TYPE_9__ {void* cpu_of_node; void* platform_of_node; void* codec_of_node; } ;
...
/* Variables and functions */
 ...
 struct tegra_max98090* devm_kzalloc (TYPE_4__*,int,int /*<<< orphan*/ ) ; 
