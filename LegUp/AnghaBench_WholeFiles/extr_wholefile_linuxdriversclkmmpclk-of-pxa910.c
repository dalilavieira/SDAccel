...
struct pxa910_clk_unit {scalar_t__ apbc_base; scalar_t__ apmu_base; struct mmp_clk_unit unit; scalar_t__ apbcp_base; scalar_t__ mpmu_base; } ;
struct mmp_clk_reset_cell {int bits; int /*<<< orphan*/  lock; scalar_t__ flags; scalar_t__ reg; int /*<<< orphan*/  clk_id; } ;
struct device_node {int dummy; } ;
struct clk {int dummy; } ;
struct TYPE_18__ {int /*<<< orphan*/  lock; scalar_t__ offset; int /*<<< orphan*/  id; } ;
