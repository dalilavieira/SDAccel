...
struct table_value {int val_len; char* val; } ;

/* Variables and functions */
 size_t TABLE_ATK_ACCEPT ; 
 size_t TABLE_ATK_ACCEPT_LNG ; 
 size_t TABLE_ATK_CHUNKED ; 
 size_t TABLE_ATK_CLOUDFLARE_NGINX ; 
 size_t TABLE_ATK_CONNECTION_HDR ; 
 size_t TABLE_ATK_CONTENT_LENGTH_HDR ; 
 size_t TABLE_ATK_CONTENT_TYPE ; 
 size_t TABLE_ATK_DOSARREST ; 
 size_t TABLE_ATK_KEEP_ALIVE ; 
 size_t TABLE_ATK_KEEP_ALIVE_HDR ; 
 size_t TABLE_ATK_LOCATION_HDR ; 
 size_t TABLE_ATK_NSERV ; 
 size_t TABLE_ATK_REFRESH_HDR ; 
 size_t TABLE_ATK_RESOLVER ; 
 size_t TABLE_ATK_SET_COOKIE ; 
 size_t TABLE_ATK_SET_COOKIE_HDR ; 
 size_t TABLE_ATK_TRANSFER_ENCODING_HDR ; 
 size_t TABLE_ATK_VSE ; 
 size_t TABLE_CNC_DOMAIN ; 
 size_t TABLE_CNC_PORT ; 
 size_t TABLE_EXEC_SUCCESS ; 
 size_t TABLE_HTTP_FIVE ; 
 size_t TABLE_HTTP_FOUR ; 
 size_t TABLE_HTTP_ONE ; 
 size_t TABLE_HTTP_THREE ; 
 size_t TABLE_HTTP_TWO ; 
 size_t TABLE_KILLER_ANIME ; 
 size_t TABLE_KILLER_DELETED ; 
 size_t TABLE_KILLER_EXE ; 
 size_t TABLE_KILLER_FD ; 
 size_t TABLE_KILLER_PROC ; 
 size_t TABLE_KILLER_SAFE ; 
 size_t TABLE_KILLER_STATUS ; 
 size_t TABLE_MEM_QBOT ; 
 size_t TABLE_MEM_QBOT2 ; 
 size_t TABLE_MEM_QBOT3 ; 
 size_t TABLE_MEM_REMAITEN ; 
 size_t TABLE_MEM_UPX ; 
 size_t TABLE_MEM_ZOLLARD ; 
 size_t TABLE_SCAN_CB_DOMAIN ; 
 size_t TABLE_SCAN_CB_PORT ; 
 size_t TABLE_SCAN_ENABLE ; 
 size_t TABLE_SCAN_KILL_9 ; 
 size_t TABLE_SCAN_NCORRECT ; 
 size_t TABLE_SCAN_PS ; 
 size_t TABLE_SCAN_QUERY ; 
 size_t TABLE_SCAN_RESP ; 
 size_t TABLE_SCAN_SH ; 
 size_t TABLE_SCAN_SHELL ; 
 size_t TABLE_SCAN_SYSTEM ; 
static  void add_entry (size_t,char*,int) ; 
 char* malloc (int) ; 
 struct table_value* table ; 
 int table_key ; 
static  void toggle_obf (size_t) ; 
