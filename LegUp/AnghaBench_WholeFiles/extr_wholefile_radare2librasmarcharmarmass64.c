...
typedef  int ut64 ;
typedef  int ut32 ;
struct TYPE_23__ {char* name; scalar_t__ val; } ;
struct TYPE_22__ {char const* mnemonic; int operands_count; int /*<<< orphan*/  member_0; TYPE_1__* operands; } ;
struct TYPE_21__ {int reg_type; int type; int reg; int immediate; int shift_amount; scalar_t__ shift; int mem_option; scalar_t__ sp_val; int sign; } ;
...
__attribute__((used)) static bool parseOperands(char* str, ArmOp *op) {
	char *t = strdup (str);
	int operand = 0;
	char *token = t;
	char *x;
