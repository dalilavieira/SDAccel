...
/* Type definitions */
struct TYPE_53__ {int numpoints; double** p; } ;
typedef  TYPE_2__ winding_t ;
typedef  double* vec4_t ;
typedef  double* vec3_t ;
struct TYPE_54__ {int compileFlags; scalar_t__ autosprite; int /*<<< orphan*/ * shaderText; } ;
typedef  TYPE_3__ shaderInfo_t ;
typedef  int /*<<< orphan*/  qboolean ;
struct TYPE_56__ {int width; int height; TYPE_8__* verts; } ;
struct TYPE_55__ {double* eMins; double* eMaxs; struct TYPE_55__* next; TYPE_3__* shaderInfo; TYPE_5__ mesh; int /*<<< orphan*/  longestCurve; } ;
typedef  TYPE_4__ parseMesh_t ;
typedef  TYPE_5__ mesh_t ;
struct TYPE_57__ {int numVerts; size_t planeNum; int patchWidth; int patchHeight; scalar_t__ type; int numIndexes; size_t* indexes; scalar_t__* mins; scalar_t__* maxs; TYPE_3__* shaderInfo; TYPE_8__* verts; scalar_t__ planar; int /*<<< orphan*/  longestCurve; TYPE_1__* sideRef; int /*<<< orphan*/  lightmapScale; int /*<<< orphan*/  fogNum; int /*<<< orphan*/  recvShadows; int /*<<< orphan*/  castShadows; int /*<<< orphan*/  entityNum; } ;
typedef  TYPE_6__ mapDrawSurface_t ;
struct TYPE_58__ {double* origin; int firstDrawSurf; TYPE_4__* patches; int /*<<< orphan*/ * epairs; } ;
typedef  TYPE_7__ entity_t ;
typedef  double dvec_t ;
typedef  double* dvec3_t ;
struct TYPE_59__ {double* xyz; double* st; double** texMat; int numPlanes; double* mins; double* maxs; double* center; int radius; int radius2; double** planes; double* normal; int** color; TYPE_3__* si; } ;
typedef  TYPE_8__ decalProjector_t ;
typedef  TYPE_8__ bspDrawVert_t ;
struct TYPE_52__ {int /*<<< orphan*/ * side; } ;
struct TYPE_51__ {double* normal; double dist; } ;

/* Variables and functions */
 int /*<<< orphan*/  AddPointToBounds (double*,double*,double*) ; 
 TYPE_6__* AllocDrawSurface (int /*<<< orphan*/ ) ; 
 TYPE_2__* AllocWinding (int) ; 
 int C_NOMARKS ; 
 int /*<<< orphan*/  ClearBounds (double*,double*) ; 
 int /*<<< orphan*/  ClipWindingEpsilon (TYPE_2__*,double*,double,float,TYPE_2__**,TYPE_2__**) ; 
 double DotProduct (double*,double*) ; 
 TYPE_7__* FindTargetEntity (char const*) ; 
 int /*<<< orphan*/  FreeMesh (TYPE_5__*) ; 
 ...
 scalar_t__ PlaneFromPoints (double*,double*,double*,double*) ; 
 int /*<<< orphan*/  PutMeshOnCurve (TYPE_5__) ; 
 scalar_t__ Q_stricmp (char const*,char*) ; 
 int /*<<< orphan*/  RAD2DEG (int /*<<< orphan*/ ) ; 
 TYPE_5__* RemoveLinearMeshColumnsRows (TYPE_5__*) ; 
...
__attribute__((used)) static void TransformDecalProjector( decalProjector_t *in, vec3_t axis[ 3 ], vec3_t origin, decalProjector_t *out ){
	int i;
