...
struct flexcop_i2c_adapter {struct flexcop_device* fc; int /*<<< orphan*/  port; scalar_t__ no_base_addr; } ;
struct flexcop_device {scalar_t__ dev_type; int (* i2c_request ) (struct flexcop_i2c_adapter*,scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int) ;int init_state; TYPE_12__* fc_i2c_adap; int /*<<< orphan*/  dev; int /*<<< orphan*/  i2c_mutex; int /*<<< orphan*/  (* write_ibi_reg ) (struct flexcop_device*,int /*<<< orphan*/ ,TYPE_4__) ;TYPE_4__ (* read_ibi_reg ) (struct flexcop_device*,int /*<<< orphan*/ ) ;} ;
struct TYPE_21__ {int working_start; int total_bytes; int data1_reg; int chipaddr; int baseaddr; int /*<<< orphan*/  twoWS_port_reg; scalar_t__ twoWS_rw; scalar_t__ no_base_addr_ack_error; scalar_t__ st_done; } ;
struct TYPE_20__ {int data2_reg; int data3_reg; int data4_reg; } ;
struct TYPE_23__ {TYPE_2__ tw_sm_c_100; scalar_t__ raw; TYPE_1__ tw_sm_c_104; } ;
typedef  TYPE_4__ flexcop_ibi_value ;
typedef  scalar_t__ flexcop_access_op_t ;
struct TYPE_22__ {int /*<<< orphan*/  parent; } ;
struct TYPE_18__ {TYPE_3__ dev; int /*<<< orphan*/ * algo_data; int /*<<< orphan*/ * algo; int /*<<< orphan*/  name; } ;
struct TYPE_19__ {TYPE_11__ i2c_adap; int /*<<< orphan*/  port; struct flexcop_device* fc; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  i2c_set_adapdata (TYPE_11__*,TYPE_12__*) ; 
 TYPE_4__ ibi_zero ; 
 ...
 TYPE_4__ stub3 (struct flexcop_device*,int /*<<< orphan*/ ) ; 
 TYPE_4__ stub4 (struct flexcop_device*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub5 (struct flexcop_device*,int /*<<< orphan*/ ,TYPE_4__) ; 
 int stub6 (struct flexcop_i2c_adapter*,scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int) ; 
 int stub7 (struct flexcop_i2c_adapter*,scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int) ; 
...
__attribute__((used)) static int flexcop_i2c_read4(struct flexcop_i2c_adapter *i2c,
