...
struct optimistic_spin_node {int cpu; struct optimistic_spin_node* locked; struct optimistic_spin_node* next; struct optimistic_spin_node* prev; } ;

/* Variables and functions */
 int OSQ_UNLOCKED_VAL ; 
 struct optimistic_spin_node* READ_ONCE (struct optimistic_spin_node*) ; 
 int /*<<< orphan*/  WRITE_ONCE (struct optimistic_spin_node*,...) ; 
 int atomic_cmpxchg_acquire (int /*<<< orphan*/ *,int,int) ; 
 int atomic_cmpxchg_release (int /*<<< orphan*/ *,int,int) ; 
 ...
 struct optimistic_spin_node* xchg (struct optimistic_spin_node**,int /*<<< orphan*/ *) ; 
