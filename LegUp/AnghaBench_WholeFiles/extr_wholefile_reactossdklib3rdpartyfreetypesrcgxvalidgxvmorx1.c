...
/* Type definitions */
struct TYPE_26__ {scalar_t__ u; } ;
struct TYPE_25__ {void* u; } ;
struct TYPE_24__ {int ul; } ;
struct TYPE_21__ {int /*<<< orphan*/  optdata; } ;
struct TYPE_23__ {int lookuptbl_head; void (* lookupval_func ) (int,TYPE_7__*,TYPE_4__*) ;TYPE_6__ (* lookupfmt4_trans ) (int,TYPE_7__*,int,TYPE_4__*) ;int /*<<< orphan*/  lookupval_sign; TYPE_2__ xstatetable; TYPE_1__* face; } ;
struct TYPE_22__ {int substitutionTable; int substitutionTable_length; scalar_t__ substitutionTable_num_lookupTables; } ;
struct TYPE_20__ {scalar_t__ num_glyphs; } ;
...
typedef  TYPE_6__ GXV_LookupValueDesc ;
typedef  TYPE_7__* GXV_LookupValueCPtr ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  gxv_LookupTable_validate (int,int,TYPE_4__*) ; 
