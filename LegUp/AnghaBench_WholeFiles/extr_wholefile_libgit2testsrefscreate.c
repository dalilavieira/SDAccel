...
/* Variables and functions */
 ...
 int git_reference_create (TYPE_1__**,int /*<<< orphan*/ *,char const*,int /*<<< orphan*/ *,int,char*) ; 
 int /*<<< orphan*/  git_reference_free (TYPE_1__*) ; 
 int git_reference_lookup (TYPE_1__**,int /*<<< orphan*/ *,char const*) ; 
 int git_reference_resolve (TYPE_1__**,TYPE_1__*) ; 
 size_t git_reference_symbolic_create (TYPE_1__**,int /*<<< orphan*/ *,char const*,char const*,int,int /*<<< orphan*/ *) ; 
