...
struct TYPE_44__ {int (* get_format ) (TYPE_9__*,int const*) ;TYPE_2__* opaque; scalar_t__ extradata_size; int /*<<< orphan*/  extradata; scalar_t__ codec_id; TYPE_30__* hw_frames_ctx; int /*<<< orphan*/  coded_height; int /*<<< orphan*/  coded_width; int /*<<< orphan*/  sw_pix_fmt; } ;
struct TYPE_43__ {int nb_streams; TYPE_3__** streams; } ;
struct TYPE_42__ {int height; int* linesize; int /*<<< orphan*/  width; scalar_t__* data; } ;
struct TYPE_41__ {int format; int initial_pool_size; void* height; void* width; int /*<<< orphan*/  sw_format; TYPE_4__* hwctx; } ;
struct TYPE_40__ {scalar_t__ stream_index; scalar_t__ size; int /*<<< orphan*/ * data; int /*<<< orphan*/  member_0; } ;
struct TYPE_39__ {int /*<<< orphan*/  frame_type; } ;
struct TYPE_38__ {scalar_t__ index; TYPE_1__* codecpar; int /*<<< orphan*/  discard; } ;
struct TYPE_37__ {scalar_t__ data; } ;
struct TYPE_36__ {int /*<<< orphan*/  hw_device_ref; int /*<<< orphan*/ * member_0; } ;
struct TYPE_35__ {scalar_t__ codec_id; scalar_t__ extradata_size; int /*<<< orphan*/  extradata; } ;
...
/* Variables and functions */
 ...
 TYPE_30__* av_hwframe_ctx_alloc (int /*<<< orphan*/ ) ; 
 int av_hwframe_ctx_init (TYPE_30__*) ; 
 int av_hwframe_transfer_data (TYPE_7__*,TYPE_7__*,int /*<<< orphan*/ ) ; 
 ...
 TYPE_9__* avcodec_alloc_context3 (int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/ * avcodec_find_decoder_by_name (char*) ; 
 int /*<<< orphan*/  avcodec_free_context (TYPE_9__**) ; 
 int avcodec_open2 (TYPE_9__*,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
 int avcodec_receive_frame (TYPE_9__*,TYPE_7__*) ; 
 int avcodec_send_packet (TYPE_9__*,TYPE_5__*) ; 
 int /*<<< orphan*/  avformat_close_input (TYPE_8__**) ; 
 int avformat_open_input (TYPE_8__**,char*,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
