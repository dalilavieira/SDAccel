...
typedef  struct TYPE_97__   TYPE_4__ ;
typedef  struct TYPE_96__   TYPE_3__ ;
typedef  struct TYPE_95__   TYPE_2__ ;
typedef  struct TYPE_94__   TYPE_1__ ;

/* Type definitions */
struct TYPE_96__ {int* fixed_res; char* mixplayb; char* mixcapt; char* mixspdif; TYPE_2__* card; int /*<<< orphan*/  mmio; int /*<<< orphan*/  lock; TYPE_1__* rmidi; int /*<<< orphan*/  irq; TYPE_4__* dma_wt; TYPE_4__* dma_adb; struct pcm_vol* pcm_vol; int /*<<< orphan*/ * a3d; } ;
...
struct TYPE_97__ {int dma_ctrl; int period_real; int period_virt; int period_bytes; int nr_periods; int cfg0; int cfg1; int dma_unknown; int fifo_status; int* resources; int dma; int dir; int type; int nr_ch; int /*<<< orphan*/  substream; scalar_t__ fifo_enabled; } ;
typedef  TYPE_4__ stream_t ;
typedef  int snd_pcm_format_t ;
typedef  int /*<<< orphan*/  irqreturn_t ;
struct TYPE_95__ {int /*<<< orphan*/  dev; } ;
struct TYPE_94__ {int /*<<< orphan*/  private_data; } ;
typedef  int ADBRamLink ;

/* Variables and functions */
 unsigned char ADB_A3DIN (int) ; 
 unsigned char ADB_CODECIN (int) ; 
 unsigned char ADB_CODECOUT (int) ; 
 unsigned char ADB_DMA (unsigned char) ; 
 unsigned char ADB_EQIN (int) ; 
 unsigned char ADB_EQOUT (int) ; 
 int ADB_MASK ; 
 unsigned char ADB_MIXIN (unsigned char) ; 
 unsigned char ADB_MIXOUT (unsigned char) ; 
 unsigned char ADB_SHIFT ; 
 unsigned char ADB_SPDIFOUT (int) ; 
 unsigned char ADB_SRCIN (unsigned char) ; 
 unsigned char ADB_SRCOUT (int) ; 
 int ADB_SUBBUF_MASK ; 
 ...
 int EN_SPDIF ; 
 int FIFO_MASK ; 
#define  FIFO_PAUSE 137 
 int FIFO_RDONLY ; 
 int FIFO_SIZE ; 
 int FIFO_SIZE_BITS ; 
#define  FIFO_START 136 
#define  FIFO_STOP 135 
 int FIFO_U0 ; 
 int FIFO_U1 ; 
 int FIFO_VALID ; 
 int FMT_MASK ; 
 ...
 unsigned char MIX_CAPT (int) ; 
 unsigned char MIX_DEFIGAIN ; 
 unsigned char MIX_DEFOGAIN ; 
 unsigned char MIX_PLAYB (int) ; 
 unsigned char MIX_SPDIF (int) ; 
 int NR_ADB ; 
 int NR_MIXOUT ; 
...
#define  SNDRV_PCM_FORMAT_U8 128 
 ...
 int VORTEX_ADBDMA_BUFCFG0 ; 
 int VORTEX_ADBDMA_BUFCFG1 ; 
 int VORTEX_ADBDMA_CTRL ; 
 int VORTEX_ADBDMA_START ; 
 int VORTEX_ADBDMA_STAT ; 
 int VORTEX_ADB_CHNBASE ; 
 int VORTEX_ADB_CHNBASE_COUNT ; 
 int VORTEX_ADB_RTBASE ; 
 int VORTEX_ADB_RTBASE_COUNT ; 
 int VORTEX_ADB_SR ; 
 unsigned short VORTEX_CODEC_ADDMASK ; 
 unsigned short VORTEX_CODEC_ADDSHIFT ; 
 int VORTEX_CODEC_CHN ; 
 ...
 int VORTEX_FIFO_ADBDATA ; 
 int VORTEX_FIFO_WTCTRL ; 
 int VORTEX_FIFO_WTDATA ; 
 int VORTEX_IRQ_CTRL ; 
 ...
 int VORTEX_MIXER_SR ; 
 int VORTEX_MIX_ENIN ; 
 unsigned char VORTEX_MIX_INVOL_A ; 
 unsigned char VORTEX_MIX_INVOL_B ; 
 int VORTEX_MIX_SMP ; 
 unsigned char VORTEX_MIX_VOL_A ; 
 unsigned char VORTEX_MIX_VOL_B ; 
 int VORTEX_PCM_A3D ; 
 int VORTEX_PCM_ADB ; 
 ...
 int VORTEX_SPDIF_CFG0 ; 
 int VORTEX_SPDIF_CFG1 ; 
 int VORTEX_SPDIF_FLAGS ; 
 int VORTEX_SPDIF_SMPRATE ; 
 int VORTEX_SRCBLOCK_SR ; 
 int VORTEX_SRC_CHNBASE ; 
 unsigned char VORTEX_SRC_CONVRATIO ; 
 unsigned char VORTEX_SRC_DATA ; 
 unsigned char VORTEX_SRC_DATA0 ; 
 unsigned char VORTEX_SRC_DRIFT0 ; 
 unsigned char VORTEX_SRC_DRIFT1 ; 
 unsigned char VORTEX_SRC_DRIFT2 ; 
 int VORTEX_SRC_RTBASE ; 
 int VORTEX_SRC_SOURCE ; 
 int VORTEX_SRC_SOURCESIZE ; 
 unsigned char VORTEX_SRC_U0 ; 
 unsigned char VORTEX_SRC_U1 ; 
 unsigned char VORTEX_SRC_U2 ; 
 int VORTEX_STAT ; 
 int VORTEX_WTDMA_BUFBASE ; 
 int VORTEX_WTDMA_BUFCFG0 ; 
 int VORTEX_WTDMA_BUFCFG1 ; 
 int VORTEX_WTDMA_CTRL ; 
 int VORTEX_WTDMA_START ; 
 int VORTEX_WTDMA_STAT ; 
 int WT_SUBBUF_MASK ; 
 int WT_SUBBUF_SHIFT ; 
 ...
 int /*<<< orphan*/  vortex_Vort3D_InitializeSource (int /*<<< orphan*/ *,int,TYPE_3__*) ; 
 int /*<<< orphan*/  vortex_Vort3D_connect (TYPE_3__*,int) ; 
 int /*<<< orphan*/  vortex_Vort3D_disable (TYPE_3__*) ; 
 int /*<<< orphan*/  vortex_Vort3D_enable (TYPE_3__*) ; 
 int /*<<< orphan*/  vortex_eq_free (TYPE_3__*) ; 
 int /*<<< orphan*/  vortex_eq_init (TYPE_3__*) ; 
 int /*<<< orphan*/  vortex_wt_connect (TYPE_3__*,int) ; 
 int /*<<< orphan*/  vortex_wt_init (TYPE_3__*) ; 
