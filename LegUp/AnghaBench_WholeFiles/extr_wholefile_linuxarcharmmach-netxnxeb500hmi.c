...
/* Type definitions */
struct TYPE_8__ {int length; scalar_t__ msb_right; } ;
struct fb_var_screeninfo {TYPE_4__ green; } ;
struct TYPE_5__ {int length; scalar_t__ msb_right; } ;
struct TYPE_6__ {TYPE_1__ green; } ;
