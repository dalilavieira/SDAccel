...
struct TYPE_33__ {int s4; int direction; unsigned char* buf; char left; char right; unsigned int width; TYPE_2__* pass; int /*<<< orphan*/  isbn10_config; int /*<<< orphan*/  ean13_config; int /*<<< orphan*/  upca_config; int /*<<< orphan*/  upce_config; int /*<<< orphan*/  isbn13_config; int /*<<< orphan*/  ean8_config; int /*<<< orphan*/  ean5_config; int /*<<< orphan*/  ean2_config; } ;
struct TYPE_31__ {scalar_t__* buf; int buflen; int direction; int idx; int /*<<< orphan*/  lock; TYPE_3__ ean; scalar_t__ modifiers; } ;
typedef  TYPE_1__ zbar_decoder_t ;
struct TYPE_32__ {int* raw; int state; unsigned int width; } ;
typedef  TYPE_2__ ean_pass_t ;
typedef  TYPE_3__ ean_decoder_t ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  acquire_lock (TYPE_1__*,char) ; 
 unsigned int calc_s (TYPE_1__*,int,int) ; 
 int /*<<< orphan*/  dbprintf (int,char*,...) ; 
 int decode_e (unsigned int,unsigned int,int) ; 
 int* digits ; 
 int /*<<< orphan*/  dsprintbuf (TYPE_3__*) ; 
 int /*<<< orphan*/  ean_get_config (TYPE_3__*,char) ; 
 scalar_t__ get_color (TYPE_1__*) ; 
 unsigned int get_width (TYPE_1__*,int) ; 
 void** parity_decode ; 
 int /*<<< orphan*/  zassert (int,char,char*,unsigned char,unsigned char,unsigned int,...) ; 
...
__attribute__((used)) static inline zbar_symbol_type_t integrate_partial (ean_decoder_t *ean,
                                                    ean_pass_t *pass,
