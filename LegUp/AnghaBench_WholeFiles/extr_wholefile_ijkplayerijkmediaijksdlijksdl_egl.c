...
/* Type definitions */
struct TYPE_27__ {scalar_t__ window; scalar_t__ display; scalar_t__ surface; scalar_t__ context; struct TYPE_27__* opaque; int /*<<< orphan*/ * opaque_class; int /*<<< orphan*/  renderer; int /*<<< orphan*/  height; int /*<<< orphan*/  width; } ;
struct TYPE_26__ {int w; int h; int /*<<< orphan*/  format; } ;
typedef  TYPE_1__ SDL_VoutOverlay ;
typedef  TYPE_2__ IJK_EGL_Opaque ;
...
#define  EGL_WINDOW_BIT 128 
 int /*<<< orphan*/  IJK_GLES2_Renderer_create (TYPE_1__*) ; 
 int /*<<< orphan*/  IJK_GLES2_Renderer_freeP (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  IJK_GLES2_Renderer_isFormat (int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  IJK_GLES2_Renderer_isValid (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  IJK_GLES2_Renderer_renderOverlay (int /*<<< orphan*/ ,TYPE_1__*) ; 
 int /*<<< orphan*/  IJK_GLES2_Renderer_reset (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  IJK_GLES2_Renderer_setupGLES () ; 
 int /*<<< orphan*/  IJK_GLES2_Renderer_use (int /*<<< orphan*/ ) ; 
 ...
 int /*<<< orphan*/  eglQuerySurface (scalar_t__,scalar_t__,int /*<<< orphan*/ ,int*) ; 
...
__attribute__((used)) static EGLBoolean IJK_EGL_prepareRenderer(IJK_EGL* egl, SDL_VoutOverlay *overlay)
{
    assert(egl);
    assert(egl->opaque);
