...
/* Type definitions */
struct TYPE_11__ {size_t len; scalar_t__ buf; } ;
typedef  TYPE_1__ vstr_t ;
struct TYPE_12__ {scalar_t__ escape_seq; size_t orig_line_len; int cursor_pos; int* escape_seq_buf; int hist_cur; char const* prompt; TYPE_1__* line; } ;
...
/* Variables and functions */
 ...
 void readline_push_history (char const*) ; 
 TYPE_8__ rl ; 
 char* str_dup_maybe (char const*) ; 
 scalar_t__ strcmp (char*,char const*) ; 
 int /*<<< orphan*/  vstr_add_str (TYPE_1__*,char*) ; 
 ...
 size_t vstr_len (TYPE_1__*) ; 
 char const* vstr_null_terminated_str (TYPE_1__*) ; 
