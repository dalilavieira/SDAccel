...
/* Variables and functions */
 ...
 char const* DIFF_DELETE_AND_READD_FILE ; 
 char const* DIFF_DELETE_FILE ; 
 char const* DIFF_MODIFY_TWO_FILES ; 
 char const* DIFF_REMOVE_FILE_TWICE ; 
 char const* DIFF_RENAME_1_TO_2 ; 
 char const* DIFF_RENAME_2_TO_1 ; 
 char const* DIFF_RENAME_AFTER_MODIFY ; 
 char const* DIFF_RENAME_AFTER_MODIFY_TARGET_PATH ; 
 char const* DIFF_RENAME_AND_MODIFY_DELTAS ; 
 char const* DIFF_RENAME_AND_MODIFY_FILE ; 
 char const* DIFF_RENAME_AND_MODIFY_SOURCE_PATH ; 
 char const* DIFF_RENAME_A_TO_B_TO_C ; 
 char const* DIFF_RENAME_A_TO_B_TO_C_EXACT ; 
 char const* DIFF_RENAME_CIRCULAR ; 
 char const* DIFF_RENAME_FILE ; 
 char const* DIFF_TWO_DELTAS_ONE_FILE ; 
 char const* DIFF_TWO_DELTAS_ONE_NEW_FILE ; 
