...
struct TYPE_5__ {int high_bitdepth; scalar_t__ seq_profile; int twelve_bit; int monochrome; int chroma_subsampling_x; int chroma_subsampling_y; int chroma_sample_position; int seq_level_idx_0; int seq_tier_0; } ;
...
#define  AV1_OBU_METADATA 133 
#define  AV1_OBU_PADDING 132 
#define  AV1_OBU_REDUNDANT_FRAME_HEADER 131 
#define  AV1_OBU_SEQUENCE_HEADER 130 
