...
struct TYPE_10__ {int dynamic_txpower_enable; int current_turbo_edca; int is_any_nonbepkts; int is_cur_rdlstate; void* dynamic_txhighpower_lvl; void* last_dtp_lvl; } ;
struct TYPE_7__ {int (* read16_sync ) (struct rtl_priv*,int) ;int (* read32_sync ) (struct rtl_priv*,int) ;int /*<<< orphan*/  (* write32_async ) (struct rtl_priv*,int,int) ;int /*<<< orphan*/  (* write16_async ) (struct rtl_priv*,int,int) ;int /*<<< orphan*/  const (* read8_sync ) (struct rtl_priv*,int) ;int /*<<< orphan*/  (* write8_async ) (struct rtl_priv*,int,int /*<<< orphan*/  const) ;} ;
struct rtl_priv {struct ps_t dm_pstable; TYPE_5__ dm; TYPE_4__* cfg; TYPE_2__ io; } ;
