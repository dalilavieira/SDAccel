...
/* Type definitions */
struct TYPE_20__ {void (* handler ) (void*) ;TYPE_4__* data; } ;
typedef  TYPE_2__ ngx_pool_cleanup_t ;
typedef  int ngx_int_t ;
struct TYPE_21__ {int /*<<< orphan*/  pool; TYPE_1__* connection; } ;
typedef  TYPE_3__ ngx_http_request_t ;
struct TYPE_22__ {int ref; int /*<<< orphan*/ * vm; } ;
typedef  TYPE_4__ ngx_http_lua_ngx_ctx_cleanup_data_t ;
struct TYPE_23__ {int ctx_ref; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/ * ngx_http_lua_get_lua_vm (TYPE_3__*,TYPE_5__*) ; 
 TYPE_3__* ngx_http_lua_get_req (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  ngx_http_lua_module ; 
static  int ngx_http_lua_ngx_ctx_add_cleanup (TYPE_3__*,int) ; 
static  void ngx_http_lua_ngx_ctx_cleanup (void*) ; 
 int ngx_http_lua_ngx_set_ctx_helper (int /*<<< orphan*/ *,TYPE_3__*,TYPE_5__*,int) ; 
