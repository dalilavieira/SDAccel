...
typedef  int ULONG ;
struct TYPE_6__ {int SymbolsOffset; int SymbolsLength; int StringsOffset; int StringsLength; } ;
struct TYPE_5__ {int SymbolsCount; int StringsLength; int /*<<< orphan*/  Strings; int /*<<< orphan*/  Symbols; } ;
