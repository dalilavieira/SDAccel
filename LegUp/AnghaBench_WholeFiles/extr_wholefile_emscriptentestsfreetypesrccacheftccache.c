...
/* Type definitions */
struct TYPE_16__ {int p; int mask; int slack; TYPE_1__** buckets; int /*<<< orphan*/  memory; } ;
struct TYPE_15__ {int /*<<< orphan*/  num_nodes; int /*<<< orphan*/  nodes_list; } ;
struct TYPE_14__ {int hash; struct TYPE_14__* link; } ;
