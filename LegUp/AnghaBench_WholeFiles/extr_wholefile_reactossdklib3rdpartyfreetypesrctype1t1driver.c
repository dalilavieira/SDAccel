...
struct TYPE_21__ {int /*<<< orphan*/  fs_type; } ;
struct TYPE_20__ {int is_fixed_pitch; scalar_t__ italic_angle; int /*<<< orphan*/ * weight; int /*<<< orphan*/ * family_name; int /*<<< orphan*/ * full_name; int /*<<< orphan*/ * notice; int /*<<< orphan*/ * version; int /*<<< orphan*/  underline_thickness; int /*<<< orphan*/  underline_position; } ;
struct TYPE_19__ {size_t unique_id; int num_blue_values; size_t blue_fuzz; size_t blue_shift; int num_other_blues; int num_family_blues; int num_family_other_blues; int num_snap_widths; int num_snap_heights; int round_stem_up; int force_bold; size_t lenIV; scalar_t__ password; scalar_t__ language_group; int /*<<< orphan*/ * min_feature; int /*<<< orphan*/ * snap_heights; int /*<<< orphan*/ * snap_widths; int /*<<< orphan*/ * family_other_blues; int /*<<< orphan*/ * family_blues; int /*<<< orphan*/ * other_blues; int /*<<< orphan*/  blue_scale; int /*<<< orphan*/ * blue_values; int /*<<< orphan*/ * standard_height; int /*<<< orphan*/ * standard_width; } ;
struct TYPE_16__ {int /*<<< orphan*/ ** char_name; int /*<<< orphan*/  num_chars; } ;
struct TYPE_15__ {int /*<<< orphan*/  yMax; int /*<<< orphan*/  xMax; int /*<<< orphan*/  yMin; int /*<<< orphan*/  xMin; } ;
struct TYPE_14__ {int /*<<< orphan*/  yy; int /*<<< orphan*/  yx; int /*<<< orphan*/  xy; int /*<<< orphan*/  xx; } ;
struct TYPE_17__ {size_t num_glyphs; int font_type; int paint_type; size_t num_subrs; TYPE_7__ font_info; TYPE_8__ font_extra; TYPE_6__ private_dict; scalar_t__* subrs; int /*<<< orphan*/ * subrs_len; int /*<<< orphan*/  subrs_hash; TYPE_3__ encoding; int /*<<< orphan*/  encoding_type; scalar_t__* charstrings; int /*<<< orphan*/ * charstrings_len; int /*<<< orphan*/ ** glyph_names; int /*<<< orphan*/ * font_name; TYPE_2__ font_bbox; TYPE_1__ font_matrix; } ;
struct TYPE_18__ {TYPE_4__ type1; } ;
typedef  TYPE_4__* T1_Font ;
typedef  TYPE_5__* T1_Face ;
typedef  int /*<<< orphan*/  T1_EncodingType ;
typedef  TYPE_6__ PS_PrivateRec ;
typedef  TYPE_7__ PS_FontInfoRec ;
typedef  TYPE_8__ PS_FontExtraRec ;
...
#define  PS_DICT_WEIGHT 128 
 ...
 int /*<<< orphan*/  ft_strlen (int /*<<< orphan*/ *) ; 
