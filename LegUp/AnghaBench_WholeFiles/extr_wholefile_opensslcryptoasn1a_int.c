...
struct TYPE_44__ {int type; unsigned char* data; size_t length; } ;
...
/* Variables and functions */
 ...
 TYPE_1__* ASN1_STRING_dup (TYPE_1__ const*) ; 
 scalar_t__ ASN1_STRING_set (TYPE_1__*,unsigned char*,int) ; 
