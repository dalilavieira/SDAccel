...
struct i2c_msg {int* buf; int addr; int len; } ;
struct i2c_adapter {int dummy; } ;
struct firmware {int size; scalar_t__ data; } ;
struct dvb_usb_device_properties {int dummy; } ;
struct dvb_usb_device_description {int dummy; } ;
struct dvb_usb_device {int /*<<< orphan*/  data_mutex; int /*<<< orphan*/  last_event; struct af9005_device_state* priv; struct usb_device* udev; int /*<<< orphan*/  i2c_mutex; } ;
struct dvb_usb_adapter {int feedcount; struct dvb_usb_device* dev; TYPE_1__* fe_adap; } ;
struct af9005_device_state {int* data; int led_state; int /*<<< orphan*/  sequence; } ;
...
#define  FW_CONFIRM 128 
 ...
 int /*<<< orphan*/  af9005_fe_attach (struct dvb_usb_device*) ; 
