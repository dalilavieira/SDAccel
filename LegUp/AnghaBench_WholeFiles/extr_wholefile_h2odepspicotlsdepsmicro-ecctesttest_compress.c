...
/* Variables and functions */
 ...
 int /*<<< orphan*/  uECC_compress (scalar_t__*,scalar_t__*,struct uECC_Curve_t const*) ; 
 int /*<<< orphan*/  uECC_decompress (scalar_t__*,scalar_t__*,struct uECC_Curve_t const*) ; 
 int /*<<< orphan*/  uECC_make_key (scalar_t__*,scalar_t__*,struct uECC_Curve_t const*) ; 
