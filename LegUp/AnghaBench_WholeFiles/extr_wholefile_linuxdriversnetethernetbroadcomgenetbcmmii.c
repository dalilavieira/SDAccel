...
/* Type definitions */
typedef  int u32 ;
struct unimac_mdio_pdata {int phy_mask; int (* wait_func ) (void*) ;char* bus_name; int /*<<< orphan*/  flags; scalar_t__ start; scalar_t__ end; struct bcmgenet_priv* wait_func_data; } ;
struct resource {int phy_mask; int (* wait_func ) (void*) ;char* bus_name; int /*<<< orphan*/  flags; scalar_t__ start; scalar_t__ end; struct bcmgenet_priv* wait_func_data; } ;
struct device {struct device_node* of_node; struct bcmgenet_platform_data* platform_data; struct device* parent; } ;
struct platform_device {int id; struct device dev; } ;
struct TYPE_5__ {int /*<<< orphan*/  dev; } ;
struct phy_device {scalar_t__ link; scalar_t__ speed; scalar_t__ duplex; scalar_t__ pause; int supported; int dev_flags; int advertising; TYPE_2__ mdio; int /*<<< orphan*/  irq; } ;
struct net_device {struct phy_device* phydev; } ;
struct fixed_phy_status {int link; int /*<<< orphan*/  asym_pause; int /*<<< orphan*/  pause; int /*<<< orphan*/  duplex; int /*<<< orphan*/  speed; } ;
struct device_node {int dummy; } ;
struct bcmgenet_priv {scalar_t__ old_link; scalar_t__ old_speed; scalar_t__ old_duplex; scalar_t__ old_pause; int ext_phy; int internal_phy; int phy_interface; int gphy_rev; struct platform_device* mii_pdev; int /*<<< orphan*/  phy_dn; struct platform_device* pdev; TYPE_3__* dev; int /*<<< orphan*/  wq; struct device_node* mdio_dn; int /*<<< orphan*/  version; TYPE_1__* hw_params; } ;
struct bcmgenet_platform_data {int phy_interface; int phy_address; int /*<<< orphan*/  phy_duplex; int /*<<< orphan*/  phy_speed; scalar_t__ mdio_enabled; } ;
...
#define  PHY_INTERFACE_MODE_RGMII_TXID 128 
 ...
 void bcmgenet_mii_exit (struct net_device*) ; 
 int bcmgenet_sys_readl (struct bcmgenet_priv*,int /*<<< orphan*/ ) ; 
 ...
 int /*<<< orphan*/  fixed_phy_set_link_update (int /*<<< orphan*/ ,int (*) (struct net_device*,struct fixed_phy_status*)) ; 
 ...
 struct phy_device* of_phy_connect (struct net_device*,int /*<<< orphan*/ ,void (*) (struct net_device*),int,int const) ; 
 ...
 struct phy_device* phy_attach (TYPE_3__*,char*,int) ; 
 int phy_connect_direct (struct net_device*,struct phy_device*,void (*) (struct net_device*),int const) ; 
