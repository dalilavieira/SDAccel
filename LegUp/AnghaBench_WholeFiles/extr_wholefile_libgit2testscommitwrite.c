...
struct TYPE_18__ {int time; int offset; } ;
struct TYPE_19__ {char* name; char* email; TYPE_1__ when; } ;
...
struct TYPE_20__ {char const* ptr; } ;
typedef  TYPE_3__ git_buf ;
struct TYPE_21__ {char* email; char* name; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/ * commit ; 
 char const* commit_message ; 
 char const* committer_email ; 
 char const* committer_name ; 
 int /*<<< orphan*/  g_repo ; 
 ...
 int git_commit_create_buffer (TYPE_3__*,int /*<<< orphan*/ ,TYPE_2__*,TYPE_2__*,int /*<<< orphan*/ *,char const*,int /*<<< orphan*/ *,int,int /*<<< orphan*/  const**) ; 
 int git_commit_create_from_ids (int /*<<< orphan*/  const*,int /*<<< orphan*/ ,int /*<<< orphan*/ *,TYPE_2__*,TYPE_2__*,int /*<<< orphan*/ *,char const*,int /*<<< orphan*/  const*,int,int /*<<< orphan*/  const**) ; 
 int git_commit_create_v (int /*<<< orphan*/  const*,int /*<<< orphan*/ ,char*,TYPE_2__*,TYPE_2__*,int /*<<< orphan*/ *,char const*,int /*<<< orphan*/ *,int,...) ; 
 int git_commit_create_with_signature (int /*<<< orphan*/  const*,int /*<<< orphan*/ ,char const*,char const*,char*) ; 
 ...
 int git_odb_read (int /*<<< orphan*/ **,int /*<<< orphan*/ *,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  git_oid_cmp (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  git_oid_fromstr (int /*<<< orphan*/  const*,char*) ; 
 int /*<<< orphan*/  git_reference_free (int /*<<< orphan*/ *) ; 
 int git_reference_lookup (int /*<<< orphan*/ **,int /*<<< orphan*/ ,char const*) ; 
 int git_reference_symbolic_create (int /*<<< orphan*/ **,int /*<<< orphan*/ ,char*,char const*,int,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  git_reference_symbolic_target (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  const* git_reference_target (int /*<<< orphan*/ *) ; 
 scalar_t__ git_reference_type (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/ * git_reflog_entry_byindex (int /*<<< orphan*/ *,int /*<<< orphan*/ ) ; 
 TYPE_6__* git_reflog_entry_committer (int /*<<< orphan*/  const*) ; 
 ...
 int git_reflog_read (int /*<<< orphan*/ **,int /*<<< orphan*/ ,char const*) ; 
 ...
 int /*<<< orphan*/ * head_old ; 
 char* parent_id_str ; 
 char const* root_commit_message ; 
 char const* root_reflog_message ; 
 char* tree_id_str ; 
