...
/* Type definitions */
struct TYPE_62__ {unsigned short xt_mode; scalar_t__* mixxtlk; TYPE_30__* card; TYPE_7__* a3d; int /*<<< orphan*/ * mixplayb; int /*<<< orphan*/  fixed_res; int /*<<< orphan*/  mmio; } ;
typedef  TYPE_6__ vortex_t ;
struct TYPE_61__ {int /*<<< orphan*/  numid; } ;
struct snd_kcontrol {int (* info ) (struct snd_kcontrol*,struct snd_ctl_elem_info*) ;int (* put ) (struct snd_kcontrol*,struct snd_ctl_elem_value*) ;TYPE_5__ id; TYPE_7__* private_data; } ;
struct TYPE_59__ {int* value; } ;
struct TYPE_60__ {TYPE_3__ integer; } ;
struct snd_ctl_elem_value {TYPE_4__ value; } ;
struct TYPE_56__ {int min; int max; } ;
struct TYPE_57__ {TYPE_1__ integer; } ;
struct snd_ctl_elem_info {int count; TYPE_2__ value; void* type; } ;
struct TYPE_63__ {int slice; int source; int** hrtf; short* itd; unsigned long* dline; short* filter; int /*<<< orphan*/  ild; int /*<<< orphan*/ * vortex; } ;
typedef  TYPE_7__ a3dsrc_t ;
typedef  short* a3d_atmos_t ;
typedef  int /*<<< orphan*/  a3d_LRGains_t ;
typedef  int* a3d_Itd_t ;
typedef  unsigned long* a3d_ItdDline_t ;
typedef  int* a3d_Hrtf_t ;
struct TYPE_58__ {int /*<<< orphan*/  dev; } ;
...
/* Variables and functions */
 ...
 int* A3dHrirImpulse ; 
 int* A3dHrirZeros ; 
 unsigned long* A3dItdDlineZeros ; 
 ...
 int /*<<< orphan*/  VOL_MIN ; 
 scalar_t__ VORTEX_IS_QUAD (TYPE_6__*) ; 
 int /*<<< orphan*/  VORTEX_RESOURCE_MIXIN ; 
#define  XT_DIAMOND 131 
#define  XT_HEADPHONE 130 
#define  XT_SPEAKER0 129 
#define  XT_SPEAKER1 128 
 scalar_t__ a3d_addrA (int,int,int /*<<< orphan*/ ) ; 
 scalar_t__ a3d_addrB (int,int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  dev_err (int /*<<< orphan*/ ,char*) ; 
 int /*<<< orphan*/  dev_warn (int /*<<< orphan*/ ,char*) ; 
 int /*<<< orphan*/  hwwrite (int /*<<< orphan*/ ,scalar_t__,unsigned long) ; 
 int snd_ctl_add (TYPE_30__*,struct snd_kcontrol*) ; 
 struct snd_kcontrol* snd_ctl_new1 (int /*<<< orphan*/ *,TYPE_7__*) ; 
 int /*<<< orphan*/  vortex_XtalkHw_Disable (TYPE_6__*) ; 
 int /*<<< orphan*/  vortex_XtalkHw_Enable (TYPE_6__*) ; 
 int /*<<< orphan*/  vortex_XtalkHw_ProgramDiamondXtalk (TYPE_6__*) ; 
 int /*<<< orphan*/  vortex_XtalkHw_ProgramPipe (TYPE_6__*) ; 
 int /*<<< orphan*/  vortex_XtalkHw_ProgramXtalkNarrow (TYPE_6__*) ; 
 int /*<<< orphan*/  vortex_XtalkHw_ProgramXtalkWide (TYPE_6__*) ; 
 int /*<<< orphan*/  vortex_XtalkHw_SetGainsAllChan (TYPE_6__*) ; 
 int /*<<< orphan*/  vortex_XtalkHw_SetSampleRate (TYPE_6__*,int) ; 
 int /*<<< orphan*/  vortex_XtalkHw_init (TYPE_6__*) ; 
 int /*<<< orphan*/  vortex_a3d_kcontrol ; 
static  int vortex_a3d_register_controls (TYPE_6__*) ; 
static  void vortex_a3d_unregister_controls (TYPE_6__*) ; 
 void* vortex_adb_checkinout (TYPE_6__*,int /*<<< orphan*/ ,int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  vortex_connection_mixin_mix (TYPE_6__*,int,scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  vortex_mix_setinputvolumebyte (TYPE_6__*,int /*<<< orphan*/ ,scalar_t__,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  vortex_route (TYPE_6__*,int,int,scalar_t__,int /*<<< orphan*/ ) ; 
