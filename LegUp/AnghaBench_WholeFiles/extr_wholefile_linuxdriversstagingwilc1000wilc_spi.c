...
struct wilc {int /*<<< orphan*/ * dev; struct gpio_desc* gpio_irq; } ;
struct spi_transfer {int* tx_buf; int len; char* rx_buf; int bits_per_word; int /*<<< orphan*/  delay_usecs; } ;
struct spi_message {int crc_off; int has_thrpt_enh; int nint; void* is_dma_mapped; struct spi_device* spi; } ;
...
#define  CMD_TERMINATE 128 
 ...
 int WILC_PIN_MUX_0 ; 
 int WILC_SPI_PROTOCOL_OFFSET ; 
 int WILC_SPI_REG_BASE ; 
