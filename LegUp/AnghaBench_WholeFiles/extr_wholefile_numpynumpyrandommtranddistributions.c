...
/* Type definitions */
struct TYPE_43__ {int has_binomial; long nsave; double psave; double r; double q; double fm; long m; double p1; double xm; double xl; double xr; double c; double laml; double lamr; double p2; double p3; double p4; } ;
...
/* Variables and functions */
 ...
 double rk_gauss (TYPE_1__*) ; 
 long rk_poisson (TYPE_1__*,double) ; 
 double sqrt (double) ; 
