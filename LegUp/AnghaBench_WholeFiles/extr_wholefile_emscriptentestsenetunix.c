...
struct sockaddr_in {int msg_namelen; size_t msg_iovlen; void* sin_port; TYPE_1__ sin_addr; struct iovec* msg_iov; struct sockaddr_in* msg_name; scalar_t__ sin_family; } ;
struct sockaddr {int dummy; } ;
struct msghdr {int msg_namelen; size_t msg_iovlen; void* sin_port; TYPE_1__ sin_addr; struct iovec* msg_iov; struct msghdr* msg_name; scalar_t__ sin_family; } ;
struct iovec {int dummy; } ;
struct in_addr {int s_addr; } ;
struct hostent {scalar_t__ h_addrtype; char* h_name; scalar_t__* h_addr_list; } ;
typedef  int socklen_t ;
typedef  int /*<<< orphan*/  fd_set ;
typedef  int enet_uint32 ;
struct TYPE_12__ {int host; void* port; } ;
...
#define  ENET_SOCKOPT_SNDTIMEO 128 
 ...
 int recvmsg (int,struct sockaddr_in*,int /*<<< orphan*/ ) ; 
 int select (int,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *,struct timeval*) ; 
 int sendmsg (int,struct sockaddr_in*,int /*<<< orphan*/ ) ; 
