...
/* Type definitions */
typedef  int WK_word ;
typedef  int DictionaryElement ;

/* Variables and functions */
 int DICTIONARY_SIZE ; 
 int HASH_TO_DICT_BYTE_OFFSET (int) ; 
 int HEADER_SIZE_IN_WORDS ; 
 int HIGH_BITS (int) ; 
 int /*<<< orphan*/  LOW_BITS (int) ; 
 int /*<<< orphan*/  PRELOAD_DICTIONARY ; 
 int /*<<< orphan*/  RECORD_EXACT (int) ; 
 int /*<<< orphan*/  RECORD_MISS (int) ; 
 int /*<<< orphan*/  RECORD_PARTIAL (int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  RECORD_ZERO ; 
 int /*<<< orphan*/  SET_LOW_BITS_AREA_END (int*,int*) ; 
 int /*<<< orphan*/  SET_LOW_BITS_AREA_START (int*,int*) ; 
 int /*<<< orphan*/  SET_QPOS_AREA_START (int*,int*) ; 
