...
/* Type definitions */
struct stat {int st_mode; int /*<<< orphan*/  st_mtime; } ;
struct dirent {char* d_name; } ;
struct TYPE_62__ {char* array_; int length_; int /*<<< orphan*/  type_; } ;
struct TYPE_63__ {TYPE_1__ org_xmlvm_runtime_XMLVMArray; } ;
struct TYPE_64__ {TYPE_2__ fields; } ;
typedef  TYPE_3__ org_xmlvm_runtime_XMLVMArray ;
struct TYPE_65__ {TYPE_3__* o; } ;
...
/* Variables and functions */
 int /*<<< orphan*/  SEEK_END ; 
 TYPE_3__* XMLVMArray_createSingleDimension (int /*<<< orphan*/ ,int) ; 
 void* XMLVMUtil_convertFromByteArray (TYPE_3__*) ; 
