...
typedef  char UINT ;
struct TYPE_16__ {int char_width; int char_height; int col; int row; int in_focus; int border_width; } ;
struct TYPE_15__ {scalar_t__ vim_code1; scalar_t__ vim_code0; char key_sym; } ;
struct TYPE_14__ {scalar_t__ message; char wParam; int /*<<< orphan*/  lParam; int /*<<< orphan*/  hwnd; } ;
