...
/* Type definitions */
struct TYPE_13__ {int /*<<< orphan*/  dst; int /*<<< orphan*/  src; int /*<<< orphan*/  string; } ;
...
/* Variables and functions */
 ...
 unsigned int GIT_DIRECTION_PUSH ; 
 ...
 int git_refspec__parse (TYPE_1__*,char const*,int) ; 
 int /*<<< orphan*/  git_refspec_free (TYPE_1__*) ; 
 int git_refspec_parse (TYPE_1__**,char*,int) ; 
 int git_refspec_rtransform (TYPE_2__*,TYPE_1__*,char const*) ; 
 int git_refspec_transform (TYPE_2__*,TYPE_1__*,char const*) ; 
