...
/* Type definitions */
struct status_entry {int member_0; char* member_1; char* member_2; scalar_t__ newname; scalar_t__ oldname; int /*<<< orphan*/  status; } ;
struct TYPE_22__ {int flags; } ;
typedef  TYPE_7__ git_status_options ;
typedef  int /*<<< orphan*/  git_status_list ;
struct TYPE_23__ {int status; TYPE_6__* head_to_index; TYPE_4__* index_to_workdir; } ;
typedef  TYPE_8__ git_status_entry ;
typedef  int /*<<< orphan*/  git_repository ;
typedef  int /*<<< orphan*/  git_index ;
struct TYPE_24__ {int /*<<< orphan*/  ptr; } ;
typedef  TYPE_9__ git_buf ;
struct TYPE_20__ {char* path; } ;
struct TYPE_16__ {char* path; } ;
struct TYPE_21__ {TYPE_5__ new_file; TYPE_1__ old_file; } ;
struct TYPE_18__ {char* path; } ;
struct TYPE_17__ {char* path; } ;
struct TYPE_19__ {TYPE_3__ new_file; TYPE_2__ old_file; } ;

/* Variables and functions */
 TYPE_9__ GIT_BUF_INIT ; 
 int GIT_INDEX_CAPABILITY_IGNORE_CASE ; 
 int GIT_STATUS_INDEX_MODIFIED ; 
 int GIT_STATUS_INDEX_RENAMED ; 
 TYPE_7__ GIT_STATUS_OPTIONS_INIT ; 
 ...
 int /*<<< orphan*/  g_repo ; 
 int /*<<< orphan*/  git_buf_dispose (TYPE_9__*) ; 
 int /*<<< orphan*/  git_buf_joinpath (TYPE_9__*,int /*<<< orphan*/ ,char const*) ; 
 ...
 TYPE_8__* git_status_byindex (int /*<<< orphan*/ *,size_t) ; 
 size_t git_status_list_entrycount (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  git_status_list_free (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  git_status_list_new (int /*<<< orphan*/ **,int /*<<< orphan*/ ,TYPE_7__*) ; 
