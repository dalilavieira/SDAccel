...
struct hal_data_8188e {int* RfRegChnlVal; scalar_t__ EEPROMRegulatory; int** MCSTxPowerLevelOriginalOffset; int const CurrentChannelBW; int pwrGroupCnt; int PGMaxGroup; size_t** TxPwrLegacyHtDiff; size_t** TxPwrHt20Diff; size_t** PwrGroupHT40; size_t** PwrGroupHT20; int /*<<< orphan*/  odmpriv; struct dm_priv dmpriv; } ;
struct adapter {struct hal_data_8188e* HalData; struct mlme_ext_priv mlmeextpriv; } ;
typedef  size_t s8 ;
...
#define  HT_CHANNEL_WIDTH_40 128 
 ...
 int /*<<< orphan*/  phy_set_rf_reg (struct adapter*,size_t,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int) ; 
