...
typedef  struct tm {int tm_year; int tm_mon; int tm_mday; int tm_hour; int tm_min; int tm_sec; } const tm ;

/* Variables and functions */
 int SECS_PER_DAY ; 
static  long date_to_julian (int,int,int) ; 
 struct tm const* gmtime (int /*<<< orphan*/  const*) ; 
static  int julian_adj (struct tm const*,int,long,long*,int*) ; 
static  void julian_to_date (long,int*,int*,int*) ; 
 int /*<<< orphan*/  memcpy (struct tm const*,struct tm const*,int) ; 
