...
struct TYPE_3__ {unsigned int cur_freq; int nid; unsigned int items; int cur_index; int cur_valid; int* idx_lookup; struct lola_sample_clock* sample_clock; } ;
struct lola {unsigned int granularity; unsigned int sample_rate_min; TYPE_1__ clock; TYPE_2__* card; } ;
...
/* Variables and functions */
 ...
 unsigned int LOLA_UNSOLICITED_ENABLE ; 
 ...
 int lola_codec_read (struct lola*,int,int /*<<< orphan*/ ,unsigned int,int /*<<< orphan*/ ,unsigned int*,unsigned int*) ; 
