...
struct TYPE_5__ {void (* release ) (struct device*) ;int /*<<< orphan*/  of_node; int /*<<< orphan*/ * parent; } ;
struct TYPE_6__ {int n_links; int (* read ) (struct fsi_master*,int,scalar_t__,int,void*,size_t) ;int (* write ) (struct fsi_master*,int,scalar_t__,int,void const*,size_t) ;int (* term ) (struct fsi_master*,int,scalar_t__) ;int (* send_break ) (struct fsi_master*,int) ;int (* link_enable ) (struct fsi_master*,int) ;int (* link_config ) (struct fsi_master*,int,void*,void*) ;TYPE_1__ dev; int /*<<< orphan*/  flags; } ;
struct fsi_master_gpio {int t_echo_delay; int last_addr; int t_send_delay; int external_mode; TYPE_2__ master; int /*<<< orphan*/  cmd_lock; int /*<<< orphan*/  no_delays; struct gpio_desc* gpio_mux; struct gpio_desc* gpio_enable; struct gpio_desc* gpio_trans; struct gpio_desc* gpio_data; struct gpio_desc* gpio_clk; int /*<<< orphan*/ * dev; } ;
...
/* Variables and functions */
 ...
 scalar_t__ FSI_CMD_ABS_AR ; 
 int FSI_CMD_DPOLL ; 
 int FSI_CMD_EPOLL ; 
 scalar_t__ FSI_CMD_REL_AR ; 
 scalar_t__ FSI_CMD_SAME_AR ; 
 int FSI_CMD_TERM ; 
 int /*<<< orphan*/  FSI_CRC_ERR_RETRIES ; 
 scalar_t__ FSI_CRC_SIZE ; 
...
#define  FSI_RESP_ERRC 128 
 ...
 int /*<<< orphan*/  fsi_master_rescan (TYPE_2__*) ; 
 int /*<<< orphan*/  fsi_master_unregister (TYPE_2__*) ; 
