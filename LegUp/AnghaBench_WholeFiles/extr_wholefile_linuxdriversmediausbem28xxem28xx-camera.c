...
typedef  int u8 ;
typedef  int u16 ;
struct TYPE_5__ {int width; int height; int /*<<< orphan*/  code; } ;
struct v4l2_subdev_format {TYPE_2__ format; int /*<<< orphan*/  which; } ;
struct v4l2_subdev {int dummy; } ;
struct mt9v011_platform_data {int xtal; } ;
struct i2c_client {int addr; } ;
struct i2c_board_info {char* type; int addr; int /*<<< orphan*/  flags; struct mt9v011_platform_data* platform_data; } ;
...
struct TYPE_6__ {int /*<<< orphan*/  xclk; } ;
struct em28xx {size_t def_i2c_bus; int em28xx_sensor; TYPE_3__ board; struct em28xx_v4l2* v4l2; struct i2c_adapter* i2c_adap; struct i2c_client* i2c_client; TYPE_1__* intf; } ;
