...
struct TYPE_17__ {unsigned int s7; unsigned int width; int direction; int* buf; int element; int character; int /*<<< orphan*/  config; } ;
struct TYPE_16__ {unsigned char* buf; int direction; int buflen; TYPE_2__ codabar; scalar_t__ modifiers; } ;
