...
/* Type definitions */
typedef  int ns_sect ;
struct TYPE_6__ {char* name; int type; int rr_class; int rdlength; unsigned char* rdata; scalar_t__ ttl; } ;
typedef  TYPE_1__ ns_rr ;
struct TYPE_7__ {unsigned char const* _msg; unsigned char const* _eom; int _id; int _flags; int* _counts; unsigned char const** _sections; int _sect; int _rrnum; unsigned char* _msg_ptr; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  NS_GET32 (scalar_t__,unsigned char*) ; 
 int NS_INT16SZ ; 
 int NS_INT32SZ ; 
 size_t NS_MAXDNAME ; 
