...
/* Type definitions */
typedef  int uint8_t ;
struct TYPE_16__ {int* mc_best_cb; int mc_pal_size; int* mc_luma_vals; int mc_use_5col; int* mc_charmap; int* mc_colram; int* mc_charset; int* mc_meta_charset; int mc_lifetime; int mc_frame_counter; scalar_t__ next_pts; int /*<<< orphan*/  randctx; } ;
struct TYPE_15__ {int height; int width; scalar_t__ extradata; TYPE_4__* priv_data; } ;
struct TYPE_14__ {int** data; int* linesize; scalar_t__ pts; } ;
