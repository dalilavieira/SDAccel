...
struct TYPE_3__ {float x; float y; float z; double r; float g; float b; } ;
...
#define  GLFW_KEY_UP 128 
 ...
 int /*<<< orphan*/  glColorPointer (int,int /*<<< orphan*/ ,int,double*) ; 
 ...
 int /*<<< orphan*/  glTranslatef (double,double,float) ; 
