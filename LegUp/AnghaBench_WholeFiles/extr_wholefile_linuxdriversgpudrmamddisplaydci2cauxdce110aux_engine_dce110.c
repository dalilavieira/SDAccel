...
struct aux_request_transaction_data {scalar_t__ type; scalar_t__ action; scalar_t__ length; scalar_t__* data; int /*<<< orphan*/  address; int /*<<< orphan*/  delay; } ;
struct aux_reply_transaction_data {scalar_t__ length; int status; scalar_t__* data; } ;
struct aux_engine_dce110_init_data {int timeout_period; int /*<<< orphan*/  regs; int /*<<< orphan*/  ctx; } ;
struct TYPE_2__ {int /*<<< orphan*/ * funcs; } ;
struct aux_engine {int /*<<< orphan*/ * funcs; TYPE_1__ base; } ;
struct aux_engine_dce110 {int timeout_period; struct aux_engine base; int /*<<< orphan*/  regs; } ;
...
/* Variables and functions */
 ...
 scalar_t__ AUX_SW_STATUS__AUX_SW_DONE_MASK ; 
 scalar_t__ AUX_SW_STATUS__AUX_SW_HPD_DISCON_MASK ; 
 scalar_t__ AUX_SW_STATUS__AUX_SW_RX_INVALID_STOP_MASK ; 
 scalar_t__ AUX_SW_STATUS__AUX_SW_RX_RECV_INVALID_H_MASK ; 
 scalar_t__ AUX_SW_STATUS__AUX_SW_RX_RECV_INVALID_L_MASK ; 
 scalar_t__ AUX_SW_STATUS__AUX_SW_RX_RECV_NO_DET_MASK ; 
 scalar_t__ AUX_SW_STATUS__AUX_SW_RX_TIMEOUT_MASK ; 
 scalar_t__ AUX_SW_STATUS__AUX_SW_RX_TIMEOUT_STATE_MASK ; 
 int /*<<< orphan*/  AUX_SW_USE_AUX_REG_REQ ; 
 int /*<<< orphan*/  AUX_SW_WR_BYTES ; 
 int AUX_TRANSACTION_REPLY_AUX_ACK ; 
 int AUX_TRANSACTION_REPLY_AUX_DEFER ; 
 int AUX_TRANSACTION_REPLY_AUX_NACK ; 
 int AUX_TRANSACTION_REPLY_I2C_DEFER ; 
 int AUX_TRANSACTION_REPLY_I2C_NACK ; 
 void* AUX_TRANSACTION_REPLY_INVALID ; 
 scalar_t__ AUX_TRANSACTION_TYPE_DP ; 
 scalar_t__ AUX_TRANSACTION_TYPE_I2C ; 
 scalar_t__ COMPOSE_AUX_SW_DATA_0_7 (int /*<<< orphan*/ ) ; 
 ...
 scalar_t__ REG_SET (int /*<<< orphan*/ ,scalar_t__,int /*<<< orphan*/ ,scalar_t__) ; 
 scalar_t__ REG_SET_2 (int /*<<< orphan*/ ,scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 ...
 int /*<<< orphan*/  REG_UPDATE_2 (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,scalar_t__) ; 
 scalar_t__ REG_UPDATE_4 (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  REG_UPDATE_SEQ (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int,int /*<<< orphan*/ ) ; 
 scalar_t__ REG_WAIT (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int,int,int) ; 
 int /*<<< orphan*/  REG_WRITE (int /*<<< orphan*/ ,scalar_t__) ; 
 scalar_t__ SW_CAN_ACCESS_AUX ; 
 int /*<<< orphan*/  aux_engine_funcs ; 
 int /*<<< orphan*/  dal_aux_engine_construct (struct aux_engine*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  dal_aux_engine_destruct (struct aux_engine*) ; 
static  void destruct (struct aux_engine_dce110*) ; 
