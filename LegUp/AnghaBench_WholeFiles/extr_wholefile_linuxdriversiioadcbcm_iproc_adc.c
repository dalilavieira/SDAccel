...
struct iproc_adc_priv {int chan_id; int chan_val; scalar_t__ irqno; int /*<<< orphan*/  adc_clk; int /*<<< orphan*/  regmap; int /*<<< orphan*/  completion; int /*<<< orphan*/  mutex; } ;
struct iio_dev {int num_channels; char* name; int /*<<< orphan*/  channels; int /*<<< orphan*/  modes; int /*<<< orphan*/ * info; struct device dev; } ;
...
#define  IIO_VOLTAGE 128 
 ...
 scalar_t__ IPROC_ANALOG_CONTROL ; 
 scalar_t__ IPROC_AUX_DATA ; 
 scalar_t__ IPROC_CONTROLLER_STATUS ; 
 scalar_t__ IPROC_INTERRUPT_MASK ; 
 scalar_t__ IPROC_INTERRUPT_STATUS ; 
 scalar_t__ IPROC_INTERRUPT_THRES ; 
 scalar_t__ IPROC_REGCTL1 ; 
 scalar_t__ IPROC_REGCTL2 ; 
 scalar_t__ IPROC_SOFT_BYPASS_CONTROL ; 
 scalar_t__ IPROC_SOFT_BYPASS_DATA ; 
 ...
 int devm_request_threaded_irq (struct device*,scalar_t__,int /*<<< orphan*/  (*) (int,void*),int /*<<< orphan*/  (*) (int,void*),int /*<<< orphan*/ ,char*,struct iio_dev*) ; 
 int iio_device_register (struct iio_dev*) ; 
 int /*<<< orphan*/  iio_device_unregister (struct iio_dev*) ; 
 struct iproc_adc_priv* iio_priv (struct iio_dev*) ; 
 int /*<<< orphan*/  init_completion (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  iproc_adc_dbg_reg (struct device*,struct iproc_adc_priv*,scalar_t__) ; 
