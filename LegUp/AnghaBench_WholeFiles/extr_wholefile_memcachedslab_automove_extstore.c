...
struct window_global {int window_size; double max_age_ratio; unsigned int free_ratio; scalar_t__ item_size; scalar_t__ last_memcheck_run; int pool_filled_once; scalar_t__ age; int dirty; int evicted; int excess_free; int relaxed; int pool_high; int pool_low; int* free_mem; size_t window_cur; TYPE_1__* sam_after; TYPE_1__* sam_before; TYPE_1__* iam_after; TYPE_1__* iam_before; struct window_global* window_data; struct window_global* window_global; struct settings* settings; } ;
struct window_data {int window_size; double max_age_ratio; unsigned int free_ratio; scalar_t__ item_size; scalar_t__ last_memcheck_run; int pool_filled_once; scalar_t__ age; int dirty; int evicted; int excess_free; int relaxed; int pool_high; int pool_low; int* free_mem; size_t window_cur; TYPE_1__* sam_after; TYPE_1__* sam_before; TYPE_1__* iam_after; TYPE_1__* iam_before; struct window_data* window_data; struct window_data* window_global; struct settings* settings; } ;
struct settings {int slab_automove_window; double slab_automove_ratio; unsigned int slab_automove_freeratio; scalar_t__ ext_item_size; unsigned int* ext_free_memchunks; } ;
struct TYPE_6__ {unsigned int total_pages; unsigned int chunks_per_page; scalar_t__ chunk_size; scalar_t__ evicted; scalar_t__ outofmemory; unsigned int free_chunks; scalar_t__ age; } ;
typedef  TYPE_1__ slab_stats_automove ;
typedef  struct window_global slab_automove ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  free (struct window_global*) ; 
