...
struct TYPE_42__ {int index; unsigned int size_in_bits_plus8; unsigned int* buffer; int size_in_bits; unsigned int const* buffer_end; } ;
...
/* Variables and functions */
 ...
 unsigned int av_clip (int,int,unsigned int) ; 
