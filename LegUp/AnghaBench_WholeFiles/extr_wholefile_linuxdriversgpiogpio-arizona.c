...
struct gpio_chip {TYPE_2__* parent; } ;
struct arizona_pdata {int gpio_base; } ;
struct TYPE_10__ {int ngpio; int base; TYPE_2__* parent; } ;
...
#define  WM8998 128 
 ...
 int regmap_update_bits_check (int /*<<< orphan*/ ,unsigned int,unsigned int,unsigned int,int*) ; 
