...
struct ieee80211_vif {int type; int const* addr; } ;
struct ieee80211_sta {int const* addr; } ;
struct ieee80211_key_conf {int cipher; scalar_t__ keylen; int const* key; int flags; int keyidx; scalar_t__ hw_key_idx; } ;
struct ath_ps_ops {int dummy; } ;
struct ath_keyval {int kv_type; scalar_t__ kv_len; int const* kv_val; int const* kv_mic; int const* kv_txmic; } ;
struct ath_common {scalar_t__ keymax; int crypt_caps; int /*<<< orphan*/  tkip_keymap; int /*<<< orphan*/  keymap; int /*<<< orphan*/  ccmp_keymap; void* ah; struct ath_ps_ops const* ps_ops; } ;
...
/* Variables and functions */
 ...
 scalar_t__ AR_KEYTABLE_TYPE_104 ; 
 scalar_t__ AR_KEYTABLE_TYPE_128 ; 
 scalar_t__ AR_KEYTABLE_TYPE_40 ; 
 scalar_t__ AR_KEYTABLE_TYPE_AES ; 
 scalar_t__ AR_KEYTABLE_TYPE_CCM ; 
 scalar_t__ AR_KEYTABLE_TYPE_CLR ; 
 scalar_t__ AR_KEYTABLE_TYPE_TKIP ; 
 scalar_t__ AR_KEYTABLE_VALID ; 
#define  ATH_CIPHER_AES_CCM 138 
#define  ATH_CIPHER_AES_OCB 137 
#define  ATH_CIPHER_CLR 136 
#define  ATH_CIPHER_TKIP 135 
#define  ATH_CIPHER_WEP 134 
...
#define  NL80211_IFTYPE_AP 132 
 ...
 int /*<<< orphan*/  REG_WRITE (void*,int /*<<< orphan*/ ,scalar_t__) ; 
