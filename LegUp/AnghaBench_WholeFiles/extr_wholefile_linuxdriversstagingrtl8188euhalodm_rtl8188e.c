...
struct rtw_dig {int AntDiv_RSSI_max; int RSSI_max; } ;
struct fast_ant_train {scalar_t__ RxIdleAnt; int* MainAnt_Sum; int* MainAnt_Cnt; int* AuxAnt_Sum; int* AuxAnt_Cnt; scalar_t__ bBecomeLinked; scalar_t__* antsel_c; scalar_t__* antsel_b; scalar_t__* antsel_a; int /*<<< orphan*/  FAT_State; scalar_t__ TrainIdx; scalar_t__* antAveRSSI; scalar_t__* antRSSIcnt; scalar_t__* antSumRSSI; scalar_t__* Bssid; } ;
struct odm_dm_struct {int* mp_mode; scalar_t__ AntDivType; int SupportAbility; scalar_t__ bLinked; struct adapter* Adapter; struct fast_ant_train DM_FatTable; struct sta_info** pODM_StaInfo; struct rtw_dig DM_DigTable; int /*<<< orphan*/  bIsMPChip; } ;
struct adapter {int dummy; } ;

/* Variables and functions */
 scalar_t__ AUX_ANT ; 
 void* AUX_ANT_CGCS_RX ; 
 void* AUX_ANT_CG_TRX ; 
 scalar_t__ BIT (int) ; 
 scalar_t__ CGCS_RX_HW_ANTDIV ; 
 void* CGCS_RX_SW_ANTDIV ; 
 ...
 int /*<<< orphan*/  SET_TX_DESC_ANTSEL_A_88E (scalar_t__*,scalar_t__) ; 
 int /*<<< orphan*/  SET_TX_DESC_ANTSEL_B_88E (scalar_t__*,scalar_t__) ; 
 int /*<<< orphan*/  SET_TX_DESC_ANTSEL_C_88E (scalar_t__*,scalar_t__) ; 
 scalar_t__ bMaskByte0 ; 
 scalar_t__ bMaskByte1 ; 
 scalar_t__ bMaskByte2 ; 
 scalar_t__ bMaskByte3 ; 
 scalar_t__ bMaskDWord ; 
 int max (int,int) ; 
 int min (int,int) ; 
 int phy_query_bb_reg (struct adapter*,int,scalar_t__) ; 
 int /*<<< orphan*/  phy_set_bb_reg (struct adapter*,int,scalar_t__,int) ; 
 void rtl88eu_dm_update_rx_idle_ant (struct odm_dm_struct*,scalar_t__) ; 
