...
struct TYPE_61__ {size_t phase_handler; int request_body_in_single_buf; int request_body_in_persistent_file; int request_body_in_clean_file; scalar_t__ header_sent; TYPE_14__* connection; int /*<<< orphan*/  read_event_handler; int /*<<< orphan*/  pool; TYPE_4__* main; int /*<<< orphan*/  uri; } ;
typedef  TYPE_6__ ngx_http_request_t ;
struct TYPE_62__ {int next; } ;
typedef  TYPE_7__ ngx_http_phase_handler_t ;
struct TYPE_63__ {int postponed_to_access_phase_end; } ;
typedef  TYPE_8__ ngx_http_lua_main_conf_t ;
struct TYPE_55__ {int /*<<< orphan*/  len; int /*<<< orphan*/  data; } ;
struct TYPE_58__ {TYPE_1__ value; } ;
struct TYPE_64__ {scalar_t__ (* access_handler ) (TYPE_6__*) ;scalar_t__ check_client_abort; int /*<<< orphan*/  access_src_key; TYPE_43__ access_src; scalar_t__ access_chunkname; scalar_t__ force_read_body; } ;
typedef  TYPE_9__ ngx_http_lua_loc_conf_t ;
struct TYPE_56__ {int co_ref; int /*<<< orphan*/ * co; } ;
struct TYPE_50__ {int entered_access_phase; scalar_t__ (* resume_handler ) (TYPE_6__*) ;int waiting_more_body; int /*<<< orphan*/  eof; int /*<<< orphan*/  context; int /*<<< orphan*/ * cleanup; TYPE_2__* cur_co_ctx; TYPE_2__ entry_co_ctx; int /*<<< orphan*/  read_body_done; } ;
...
static  scalar_t__ ngx_http_lua_access_by_chunk (int /*<<< orphan*/ *,TYPE_6__*) ; 
