...
struct TYPE_8__ {int major; int chip; } ;
struct nvkm_bios {TYPE_4__ version; } ;
struct TYPE_5__ {int min_freq; int max_freq; int min_inputfreq; int max_inputfreq; int min_m; int max_m; int min_n; int max_n; } ;
struct TYPE_7__ {int min_freq; int max_freq; int min_m; int max_m; int min_n; int max_n; int min_inputfreq; int max_inputfreq; } ;
struct nvbios_pll {int min_p; int max_p_usable; int refclk; TYPE_1__ vco2; TYPE_3__ vco1; } ;
