...
/* Type definitions */
struct crush_work_bucket {size_t perm_x; int perm_n; unsigned int* perm; } ;
struct crush_work {struct crush_work_bucket** work; } ;
struct crush_rule_step {int op; int arg1; int arg2; } ;
struct TYPE_7__ {int ruleset; int type; int min_size; int max_size; } ;
struct crush_rule {size_t len; struct crush_rule_step* steps; TYPE_1__ mask; } ;
struct crush_map {size_t max_rules; int max_devices; int max_buckets; unsigned int choose_total_tries; int working_size; int choose_local_tries; int choose_local_fallback_tries; int chooseleaf_vary_r; int chooseleaf_stable; struct crush_bucket** buckets; int /*<<< orphan*/  chooseleaf_descend_once; struct crush_rule** rules; int /*<<< orphan*/ * choose_tries; } ;
struct crush_choose_arg {int weight_set_size; size_t* ids; TYPE_5__* weight_set; } ;
struct crush_bucket {int size; int id; int* items; int alg; int type; int /*<<< orphan*/  hash; } ;
struct crush_bucket_uniform {struct crush_bucket h; } ;
struct TYPE_9__ {int* items; int /*<<< orphan*/  id; int /*<<< orphan*/  hash; } ;
struct crush_bucket_tree {int num_nodes; size_t* node_weights; TYPE_3__ h; } ;
struct TYPE_12__ {size_t* items; unsigned int size; int /*<<< orphan*/  hash; } ;
struct crush_bucket_straw2 {size_t* item_weights; TYPE_6__ h; } ;
struct TYPE_10__ {size_t size; size_t* items; int /*<<< orphan*/  hash; } ;
struct crush_bucket_straw {int* straws; TYPE_4__ h; } ;
struct TYPE_8__ {int size; int* items; int /*<<< orphan*/  id; int /*<<< orphan*/  hash; } ;
struct crush_bucket_list {int* item_weights; int* sum_weights; TYPE_2__ h; } ;
typedef  int __u64 ;
typedef  size_t __u32 ;
typedef  int __s64 ;
typedef  size_t __s32 ;
struct TYPE_11__ {size_t* weights; } ;

/* Variables and functions */
 int /*<<< orphan*/  BUG_ON (int) ; 
#define  CRUSH_BUCKET_LIST 144 
#define  CRUSH_BUCKET_STRAW 143 
#define  CRUSH_BUCKET_STRAW2 142 
#define  CRUSH_BUCKET_TREE 141 
#define  CRUSH_BUCKET_UNIFORM 140 
...
#define  CRUSH_RULE_TAKE 128 
 ...
 unsigned int crush_hash32_3 (int /*<<< orphan*/ ,int,size_t,int) ; 
 int crush_hash32_4 (int /*<<< orphan*/ ,int,int,int,int /*<<< orphan*/ ) ; 
 int div64_s64 (int,size_t) ; 
