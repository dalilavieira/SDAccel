...
/* Type definitions */
typedef  int /*<<< orphan*/  (* yuv2planarX_fn ) (int*,int,int const**,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ;
typedef  int /*<<< orphan*/  (* yuv2planar1_fn ) (int const*,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ;
typedef  int /*<<< orphan*/  (* yuv2packedX_fn ) (TYPE_3__*,int*,int const**,int,int*,int const**,int const**,int,int const**,int /*<<< orphan*/ *,int,int) ;
typedef  int /*<<< orphan*/  (* yuv2packed2_fn ) (TYPE_3__*,int const**,int const**,int const**,int const**,int /*<<< orphan*/ *,int,int,int,int) ;
typedef  int /*<<< orphan*/  (* yuv2packed1_fn ) (TYPE_3__*,int const*,int const**,int const**,int const*,int /*<<< orphan*/ *,int,int,int) ;
typedef  int /*<<< orphan*/  (* yuv2interleavedX_fn ) (TYPE_3__*,int*,int,int const**,int const**,int /*<<< orphan*/ *,int) ;
typedef  int /*<<< orphan*/  (* yuv2anyX_fn ) (TYPE_3__*,int*,int const**,int,int*,int const**,int const**,int,int const**,int /*<<< orphan*/ **,int,int) ;
typedef  int /*<<< orphan*/  uint8_t ;
typedef  int uint16_t ;
typedef  int int16_t ;
struct TYPE_43__ {int filter_size; int** filter; int isMMX; int /*<<< orphan*/  (* pfn ) (TYPE_3__*,int*,int const**,int,int*,int const**,int const**,int,int const**,int /*<<< orphan*/ **,int,int) ;int /*<<< orphan*/  (* yuv2packedX ) (TYPE_3__*,int*,int const**,int,int*,int const**,int const**,int,int const**,int /*<<< orphan*/ *,int,int) ;int /*<<< orphan*/ * filter_pos; } ;
typedef  TYPE_8__ VScalerContext ;
struct TYPE_44__ {int width; int v_chr_sub_sample; TYPE_1__* plane; int /*<<< orphan*/  h_chr_sub_sample; } ;
struct TYPE_42__ {int uv_offx2; int* lumMmxFilter; int* chrMmxFilter; int warned_unuseable_bilinear; int use_mmx_vfilter; int numDesc; int* vChrFilter; int vChrFilterSize; int* vLumFilter; int vLumFilterSize; int /*<<< orphan*/  (* yuv2packed2 ) (TYPE_3__*,int const**,int const**,int const**,int const**,int /*<<< orphan*/ *,int,int,int,int) ;int /*<<< orphan*/  (* yuv2packed1 ) (TYPE_3__*,int const*,int const**,int const**,int const*,int /*<<< orphan*/ *,int,int,int) ;int /*<<< orphan*/ * vChrFilterPos; int /*<<< orphan*/ * vLumFilterPos; TYPE_2__* desc; scalar_t__ alpMmxFilter; int /*<<< orphan*/  dstFormat; scalar_t__ is_internal_gamma; int /*<<< orphan*/  (* yuv2anyX ) (TYPE_3__*,int*,int const**,int,int*,int const**,int const**,int,int const**,int /*<<< orphan*/ **,int,int) ;int /*<<< orphan*/  (* yuv2packedX ) (TYPE_3__*,int*,int const**,int,int*,int const**,int const**,int,int const**,int /*<<< orphan*/ *,int,int) ;int /*<<< orphan*/  (* yuv2nv12cX ) (TYPE_3__*,int*,int,int const**,int const**,int /*<<< orphan*/ *,int) ;int /*<<< orphan*/  (* yuv2planeX ) (int*,int,int const**,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ;int /*<<< orphan*/  (* yuv2plane1 ) (int const*,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ;scalar_t__ needAlpha; int /*<<< orphan*/  chrDither8; int /*<<< orphan*/  lumDither8; } ;
struct TYPE_41__ {TYPE_8__* instance; } ;
struct TYPE_40__ {int sliceY; int /*<<< orphan*/ ** line; } ;
struct TYPE_39__ {int (* process ) (TYPE_3__*,TYPE_10__*,int,int) ;scalar_t__ alpha; TYPE_9__* dst; TYPE_9__* src; TYPE_8__* instance; } ;
typedef  TYPE_9__ SwsSlice ;
typedef  TYPE_10__ SwsFilterDescriptor ;
...
/* Variables and functions */
 ...
 TYPE_8__* av_mallocz_array (int,int) ; 
 void ff_init_vscale_pfn (TYPE_3__*,int /*<<< orphan*/  (*) (int const*,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int),int /*<<< orphan*/  (*) (int*,int,int const**,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int),int /*<<< orphan*/  (*) (TYPE_3__*,int*,int,int const**,int const**,int /*<<< orphan*/ *,int),int /*<<< orphan*/  (*) (TYPE_3__*,int const*,int const**,int const**,int const*,int /*<<< orphan*/ *,int,int,int),int /*<<< orphan*/  (*) (TYPE_3__*,int const**,int const**,int const**,int const**,int /*<<< orphan*/ *,int,int,int,int),int /*<<< orphan*/  (*) (TYPE_3__*,int*,int const**,int,int*,int const**,int const**,int,int const**,int /*<<< orphan*/ *,int,int),int /*<<< orphan*/  (*) (TYPE_3__*,int*,int const**,int,int*,int const**,int const**,int,int const**,int /*<<< orphan*/ **,int,int),int) ; 
 int /*<<< orphan*/  isALPHA (int /*<<< orphan*/ ) ; 
 scalar_t__ isGray (int /*<<< orphan*/ ) ; 
 scalar_t__ isPlanarYUV (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  stub1 (int const*,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  stub10 (TYPE_3__*,int const*,int const**,int const**,int const*,int /*<<< orphan*/ *,int,int,int) ; 
 int /*<<< orphan*/  stub11 (TYPE_3__*,int const*,int const**,int const**,int const*,int /*<<< orphan*/ *,int,int,int) ; 
 int /*<<< orphan*/  stub12 (TYPE_3__*,int const**,int const**,int const**,int const**,int /*<<< orphan*/ *,int,int,int,int) ; 
 int /*<<< orphan*/  stub13 (TYPE_3__*,int*,int const**,int,int*,int const**,int const**,int,int const**,int /*<<< orphan*/ *,int,int) ; 
 int /*<<< orphan*/  stub14 (TYPE_3__*,int*,int const**,int,int*,int const**,int const**,int,int const**,int /*<<< orphan*/ **,int,int) ; 
 int /*<<< orphan*/  stub2 (int*,int,int const**,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  stub3 (int const*,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  stub4 (int*,int,int const**,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  stub5 (TYPE_3__*,int*,int,int const**,int const**,int /*<<< orphan*/ *,int) ; 
 int /*<<< orphan*/  stub6 (int const*,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  stub7 (int const*,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  stub8 (int*,int,int const**,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  stub9 (int*,int,int const**,int /*<<< orphan*/ *,int,int /*<<< orphan*/ ,int) ; 
