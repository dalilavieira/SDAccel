...
struct BitpackedContext {int (* decode ) (TYPE_4__*,TYPE_3__*,TYPE_2__*) ;} ;
typedef  int /*<<< orphan*/  int8_t ;
typedef  int int32_t ;
typedef  int VLC_TYPE ;
struct TYPE_58__ {int width; int height; struct BitpackedContext* priv_data; int /*<<< orphan*/  pix_fmt; } ;
struct TYPE_57__ {int* linesize; int key_frame; int /*<<< orphan*/  pict_type; scalar_t__* data; int /*<<< orphan*/ * buf; } ;
struct TYPE_56__ {unsigned int* data; int size; int /*<<< orphan*/  buf; } ;
struct TYPE_55__ {int index; unsigned int size_in_bits_plus8; unsigned int* buffer; int size_in_bits; unsigned int const* buffer_end; } ;
...
/* Variables and functions */
 ...
 int av_image_fill_arrays (scalar_t__*,int*,unsigned int*,int /*<<< orphan*/ ,int,int,int) ; 
 int /*<<< orphan*/  av_log (void*,int /*<<< orphan*/ ,char*,int,int,char const*) ; 
 int ff_get_buffer (TYPE_4__*,TYPE_3__*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  re ; 
 int sign_extend (int,int) ; 
 int stub1 (TYPE_4__*,TYPE_3__*,TYPE_2__*) ; 
