...
struct pll_value {scalar_t__ clockType; int /*<<< orphan*/  inputFreq; } ;
struct mode_parameter {unsigned long horizontal_display_end; unsigned long vertical_display_end; int horizontal_total; unsigned int horizontal_sync_width; int horizontal_sync_start; int vertical_total; unsigned int vertical_sync_height; int vertical_sync_start; int /*<<< orphan*/  pixel_clock; scalar_t__ clock_phase_polarity; scalar_t__ horizontal_sync_polarity; scalar_t__ vertical_sync_polarity; } ;
typedef  enum clock_type { ____Placeholder_clock_type } clock_type ;

/* Variables and functions */
 unsigned int CRT_AUTO_CENTERING_BR ; 
 ...
 unsigned int CRT_AUTO_CENTERING_TL ; 
 ...
 unsigned int CRT_HORIZONTAL_SYNC ; 
