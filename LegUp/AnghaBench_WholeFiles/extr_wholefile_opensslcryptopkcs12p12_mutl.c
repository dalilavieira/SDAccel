...
struct TYPE_24__ {TYPE_1__* data; } ;
struct TYPE_27__ {TYPE_2__ d; } ;
struct TYPE_26__ {unsigned char* data; int length; } ;
struct TYPE_25__ {TYPE_17__* mac; TYPE_8__* authsafes; } ;
struct TYPE_23__ {int /*<<< orphan*/  length; int /*<<< orphan*/  data; } ;
struct TYPE_22__ {int /*<<< orphan*/  dinfo; TYPE_4__* salt; int /*<<< orphan*/ * iter; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  ASN1_OCTET_STRING_set (TYPE_4__*,unsigned char*,unsigned int) ; 
 int /*<<< orphan*/  ASN1_STRING_get0_data (TYPE_4__ const*) ; 
 scalar_t__ ASN1_STRING_length (TYPE_4__ const*) ; 
 ...
 int /*<<< orphan*/  HMAC_Init_ex (int /*<<< orphan*/ *,unsigned char*,int,int /*<<< orphan*/  const*,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  HMAC_Update (int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int NID_id_GostR3411_2012_256 ; 
 int NID_id_GostR3411_2012_512 ; 
 int NID_id_GostR3411_94 ; 
 int /*<<< orphan*/  OBJ_nid2obj (int) ; 
 int /*<<< orphan*/  OPENSSL_cleanse (unsigned char*,int) ; 
 unsigned char* OPENSSL_malloc (int) ; 
 scalar_t__ PKCS12_ERROR ; 
 int /*<<< orphan*/  PKCS12_F_PKCS12_GEN_MAC ; 
 int /*<<< orphan*/  PKCS12_F_PKCS12_SETUP_MAC ; 
 int /*<<< orphan*/  PKCS12_F_PKCS12_SET_MAC ; 
 int /*<<< orphan*/  PKCS12_F_PKCS12_VERIFY_MAC ; 
 int /*<<< orphan*/  PKCS12_MAC_DATA_free (TYPE_17__*) ; 
 TYPE_17__* PKCS12_MAC_DATA_new () ; 
 int PKCS12_MAC_ID ; 
 int /*<<< orphan*/  PKCS12_R_CONTENT_TYPE_NOT_DATA ; 
 int /*<<< orphan*/  PKCS12_R_KEY_GEN_ERROR ; 
 ...
 int /*<<< orphan*/  PKCS12_R_UNKNOWN_DIGEST_ALGORITHM ; 
 int PKCS12_SALT_LEN ; 
 int PKCS12_key_gen_utf8 (char const*,int,unsigned char*,int,int,int,int,unsigned char*,int /*<<< orphan*/  const*) ; 
 int PKCS12_setup_mac (TYPE_3__*,int,unsigned char*,int,int /*<<< orphan*/  const*) ; 
 ...
 int /*<<< orphan*/  PKCS7_type_is_data (TYPE_8__*) ; 
 scalar_t__ RAND_bytes (unsigned char*,int) ; 
 int TK26_MAC_KEY_LEN ; 
 int /*<<< orphan*/  V_ASN1_NULL ; 
 int /*<<< orphan*/  X509_ALGOR_get0 (int /*<<< orphan*/  const**,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  X509_ALGOR_set0 (int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  X509_SIG_get0 (int /*<<< orphan*/ ,int /*<<< orphan*/  const**,TYPE_4__ const**) ; 
 int /*<<< orphan*/  X509_SIG_getm (int /*<<< orphan*/ ,int /*<<< orphan*/ **,TYPE_4__**) ; 
 int /*<<< orphan*/  memcpy (unsigned char*,unsigned char*,int) ; 
 int /*<<< orphan*/ * ossl_safe_getenv (char*) ; 
 int stub1 (char const*,int,unsigned char*,int,int,int,int,unsigned char*,int /*<<< orphan*/  const*) ; 
...
__attribute__((used)) static int pkcs12_gen_mac(PKCS12 *p12, const char *pass, int passlen,
