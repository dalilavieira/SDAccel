...
/* Variables and functions */
 unsigned long PM_DTB_MISS ; 
 unsigned long PM_ITB_MISS ; 
 unsigned long PM_LOAD_STORE ; 
 unsigned long PM_MISPREDICT ; 
 scalar_t__ PM_NUM_COUNTERS ; 
 unsigned long PM_REPLAY ; 
 unsigned long PM_STALLED ; 
 unsigned long PM_TAKEN ; 
 unsigned long PM_UNALIGNED ; 
