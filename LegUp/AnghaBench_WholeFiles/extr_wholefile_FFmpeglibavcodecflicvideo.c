...
struct TYPE_19__ {scalar_t__ pix_fmt; TYPE_2__* priv_data; } ;
struct TYPE_18__ {int size; int /*<<< orphan*/ * data; } ;
struct TYPE_17__ {unsigned int* palette; int new_palette; TYPE_11__* frame; TYPE_1__* avctx; int /*<<< orphan*/  fli_type; } ;
struct TYPE_16__ {unsigned int height; int width; } ;
struct TYPE_15__ {unsigned char** data; unsigned int* linesize; int palette_has_changed; } ;
...
#define  FLI_MINI 128 
 ...
 int ff_reget_buffer (TYPE_4__*,TYPE_11__*) ; 
