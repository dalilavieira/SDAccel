...
struct TYPE_14__ {scalar_t__ ByteCount; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  NdisAllocateBuffer (scalar_t__*,TYPE_1__**,int /*<<< orphan*/ ,int /*<<< orphan*/ ************************,scalar_t__) ; 
 int /*<<< orphan*/  NdisAllocatePacket (scalar_t__*,int /*<<< orphan*/ *,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  NdisChainBufferAtFront (int /*<<< orphan*/ ,TYPE_1__*) ; 
 int /*<<< orphan*/  NdisFreeBuffer (TYPE_1__*) ; 
 int /*<<< orphan*/  NdisFreePacket (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  NdisGetFirstBufferFromPacket (int /*<<< orphan*/ ,TYPE_1__**,int /*<<< orphan*/ ************************,scalar_t__*,scalar_t__*) ; 
 int /*<<< orphan*/  NdisGetNextBuffer (TYPE_1__*,TYPE_1__**) ; 
 int /*<<< orphan*/  NdisQueryBuffer (TYPE_1__*,int /*<<< orphan*/ *************************,scalar_t__*) ; 
