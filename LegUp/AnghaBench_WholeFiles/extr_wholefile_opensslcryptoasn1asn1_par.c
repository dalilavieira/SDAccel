...
struct TYPE_12__ {int type; int length; unsigned char const* data; } ;
struct TYPE_11__ {int type; int length; unsigned char const* data; } ;
...
static  int asn1_parse2 (int /*<<< orphan*/ *,unsigned char const**,long,int,int,int,int) ; 
