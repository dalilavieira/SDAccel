...
struct TYPE_42__ {void* enc_write_state; } ;
struct TYPE_40__ {int /*<<< orphan*/  const* new_sym_enc; TYPE_3__* new_cipher; int /*<<< orphan*/  const* new_hash; } ;
struct TYPE_41__ {TYPE_4__ tmp; int /*<<< orphan*/  handshake_buffer; } ;
struct TYPE_45__ {unsigned char* early_secret; unsigned char* handshake_secret; unsigned char* server_finished_secret; unsigned char* client_finished_secret; unsigned char* client_app_traffic_secret; unsigned char* read_iv; unsigned char* write_iv; scalar_t__ early_data_state; scalar_t__ max_early_data; unsigned char* early_exporter_master_secret; unsigned char* handshake_traffic_hash; unsigned char* master_secret; unsigned char* server_finished_hash; unsigned char* resumption_master_secret; unsigned char* server_app_traffic_secret; unsigned char* exporter_master_secret; int server; TYPE_26__* session; TYPE_26__* psksession; TYPE_6__ statem; TYPE_5__ s3; int /*<<< orphan*/  rlayer; int /*<<< orphan*/ * enc_read_ctx; int /*<<< orphan*/ * enc_write_ctx; TYPE_2__* method; } ;
struct TYPE_44__ {int /*<<< orphan*/  algorithm2; } ;
struct TYPE_43__ {scalar_t__ max_early_data; } ;
struct TYPE_39__ {int algorithm_enc; } ;
struct TYPE_38__ {TYPE_1__* ssl3_enc; } ;
struct TYPE_37__ {TYPE_7__ ext; TYPE_3__* cipher; } ;
struct TYPE_36__ {char const* server_finished_label; } ;
typedef  TYPE_8__ SSL_CIPHER ;
...
/* Variables and functions */
 ...
 void* ENC_WRITE_STATE_INVALID ; 
 void* ENC_WRITE_STATE_VALID ; 
 void* ENC_WRITE_STATE_WRITE_PLAIN_ALERTS ; 
 ...
 void* EVP_MD_size (int /*<<< orphan*/  const*) ; 
 ...
 int /*<<< orphan*/  const* EVP_get_cipherbynid (int /*<<< orphan*/ ) ; 
 ...
 int SSL_AES128CCM8 ; 
 int SSL_AES256CCM8 ; 
 int /*<<< orphan*/  SSL_CIPHER_get_cipher_nid (TYPE_8__ const*) ; 
 ...
 TYPE_8__* SSL_SESSION_get0_cipher (TYPE_26__*) ; 
 int /*<<< orphan*/  SSLerr (int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  SSLfatal (TYPE_9__*,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 ...
 int /*<<< orphan*/  ossl_statem_export_allowed (TYPE_9__*) ; 
 int /*<<< orphan*/  ossl_statem_export_early_allowed (TYPE_9__*) ; 
 int /*<<< orphan*/  ssl3_digest_cached_records (TYPE_9__*,int) ; 
 int /*<<< orphan*/  ssl_cipher_get_evp (TYPE_26__*,int /*<<< orphan*/  const**,int /*<<< orphan*/  const**,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ssl_handshake_hash (TYPE_9__*,unsigned char*,int,size_t*) ; 
 int /*<<< orphan*/  const* ssl_handshake_md (TYPE_9__*) ; 
 int /*<<< orphan*/  ssl_log_secret (TYPE_9__*,char const*,unsigned char*,size_t) ; 
