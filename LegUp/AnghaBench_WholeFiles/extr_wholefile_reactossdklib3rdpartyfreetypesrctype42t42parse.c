...
struct TYPE_37__ {char** elements; int* lengths; scalar_t__ init; } ;
...
struct TYPE_34__ {int num_glyphs; TYPE_4__ parser; TYPE_8__ swap_table; TYPE_8__ glyph_names; TYPE_8__ charstrings; } ;
...
#define  OTHER_TABLES 131 
 void* T1_Add_Table (TYPE_8__*,int,char*,int) ; 
...
#define  T1_FIELD_LOCATION_FONT_INFO 128 
 ...
 void* T1_Load_Field (TYPE_4__*,TYPE_7__*,void**,int,int /*<<< orphan*/ ) ; 
 void* T1_Load_Field_Table (TYPE_4__*,TYPE_7__*,void**,int,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  T1_Skip_PS_Token (TYPE_4__*) ; 
 int /*<<< orphan*/  T1_Skip_Spaces (TYPE_4__*) ; 
 int /*<<< orphan*/  T1_ToBytes (TYPE_4__*,char*,scalar_t__,scalar_t__*,int) ; 
 void* T1_ToInt (TYPE_4__*) ; 
 scalar_t__ ft_isdigit (char) ; 
 scalar_t__ ft_strcmp (char const*,char const*) ; 
 void* stub1 (TYPE_8__*,int,int /*<<< orphan*/ ) ; 
 void* stub2 (TYPE_8__*,int,int /*<<< orphan*/ ) ; 
