...
typedef  int u8 ;
typedef  int u32 ;
struct TYPE_7__ {int BoardType; int CutVersion; int SupportPlatform; int PackageType; int SupportInterface; int TypeGLNA; int TypeGPA; int TypeALNA; int TypeAPA; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  odm_ConfigMAC_8723B (TYPE_1__*,int,int) ; 
