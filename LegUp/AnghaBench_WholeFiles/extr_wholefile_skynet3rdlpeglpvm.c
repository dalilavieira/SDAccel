...
typedef  int byte ;
struct TYPE_29__ {char const* s; int ptop; TYPE_2__* ocap; int /*<<< orphan*/ * L; } ;
struct TYPE_26__ {int aux; int key; int /*<<< orphan*/  code; } ;
struct TYPE_28__ {TYPE_1__ i; int /*<<< orphan*/  buff; } ;
struct TYPE_27__ {int siz; int idx; char const* s; int caplevel; void* kind; TYPE_3__ const* p; } ;
typedef  TYPE_2__ Stack ;
typedef  int /*<<< orphan*/  Opcode ;
typedef  TYPE_3__ const Instruction ;
typedef  TYPE_2__ Capture ;
...
#define  ITestSet 128 
 ...
 scalar_t__ caplistidx (int) ; 
 int finddyncap (TYPE_2__*,TYPE_2__*) ; 
 void* getkind (TYPE_3__ const*) ; 
 ...
 int /*<<< orphan*/  lua_replace (int /*<<< orphan*/ *,scalar_t__) ; 
 int /*<<< orphan*/  lua_settop (int /*<<< orphan*/ *,int) ; 
 int /*<<< orphan*/  lua_toboolean (int /*<<< orphan*/ *,int) ; 
 int lua_tointeger (int /*<<< orphan*/ *,int) ; 
 int /*<<< orphan*/  memcpy (TYPE_2__*,TYPE_2__*,int) ; 
 int runtimecap (TYPE_5__*,TYPE_2__*,char const*,int*) ; 
