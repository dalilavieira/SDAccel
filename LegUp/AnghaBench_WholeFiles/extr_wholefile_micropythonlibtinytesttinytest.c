...
/* Type definitions */
struct testlist_alias_t {char const* name; char const** tests; } ;
struct testgroup_t {char* prefix; struct testcase_t* cases; } ;
struct testcase_t {int flags; char* name; TYPE_1__* setup; int /*<<< orphan*/  (* fn ) (void*) ;} ;
...
static  int process_test_option (struct testgroup_t*,char const*) ; 
