...
struct TYPE_5__ {scalar_t__ ar_errno; int /*<<< orphan*/  ar_subj_asid; int /*<<< orphan*/  ar_event; int /*<<< orphan*/  ar_subj_auid; } ;
struct kaudit_record {int k_ar_commit; size_t k_ulen; TYPE_1__ k_ar; void* k_udata; } ;
struct kaudit_queue {int dummy; } ;
struct au_record {size_t len; void* data; } ;
typedef  scalar_t__ off_t ;
typedef  int /*<<< orphan*/ * kauth_cred_t ;
typedef  int /*<<< orphan*/  au_id_t ;
typedef  int /*<<< orphan*/  au_event_t ;
typedef  int /*<<< orphan*/  au_class_t ;
struct TYPE_8__ {scalar_t__ af_filesz; scalar_t__ af_currsz; } ;
struct TYPE_7__ {int aq_minfree; int aq_lowater; int aq_hiwater; } ;
...
#define  BSM_SUCCESS 128 
 ...
 struct vfs_context audit_ctx ; 
 int /*<<< orphan*/  audit_drain_cv ; 
 struct kaudit_record audit_drain_kar ; 
 int /*<<< orphan*/  audit_enabled ; 
 scalar_t__ audit_fail_stop ; 
 int audit_file_rotate_wait ; 
 int /*<<< orphan*/  audit_free (struct kaudit_record*) ; 
 TYPE_4__ audit_fstat ; 
 int audit_in_failure ; 
 int /*<<< orphan*/  audit_mtx ; 
 scalar_t__ audit_panic_on_write_fail ; 
 int /*<<< orphan*/  audit_pipe_submit (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int,int,void*,size_t) ; 
 int /*<<< orphan*/  audit_pipe_submit_user (void*,size_t) ; 
 int audit_pre_q_len ; 
 struct kaudit_queue audit_q ; 
 int audit_q_draining ; 
 int audit_q_len ; 
 TYPE_3__ audit_qctrl ; 
 int /*<<< orphan*/  audit_sdev_submit (int /*<<< orphan*/ ,int /*<<< orphan*/ ,void*,size_t) ; 
 ...
 int vfs_update_vfsstat (TYPE_2__*,struct vfs_context*,int /*<<< orphan*/ ) ; 
