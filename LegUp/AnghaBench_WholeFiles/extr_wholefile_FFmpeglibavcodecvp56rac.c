...
typedef  int int32_t ;
struct TYPE_45__ {int high; int bits; unsigned int const* buffer; unsigned int const* end; int /*<<< orphan*/  code_word; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  bytestream_get_be24 (unsigned int const**) ; 
 int /*<<< orphan*/  re ; 
 int sign_extend (int,int) ; 
 int vp56_rac_get (TYPE_1__*) ; 
 int vp8_rac_get (TYPE_1__*) ; 
