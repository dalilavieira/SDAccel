...
/* Type definitions */
struct s390_load_data {char* kernel_buf; int /*<<< orphan*/  memsz; int /*<<< orphan*/  member_0; } ;
struct kimage {scalar_t__ type; } ;
struct kexec_buf {char* buffer; size_t bufsz; size_t mem; scalar_t__ memsz; struct kimage* image; } ;
struct TYPE_7__ {scalar_t__ start; } ;
struct TYPE_6__ {int e_phoff; int e_phnum; scalar_t__ e_type; scalar_t__* e_ident; int e_phentsize; size_t e_ehsize; } ;
struct TYPE_5__ {scalar_t__ p_type; int p_offset; size_t p_filesz; size_t p_paddr; int /*<<< orphan*/  p_align; scalar_t__ p_memsz; } ;
