...
/* Type definitions */
typedef  int u16 ;
struct TYPE_2__ {int (* get_vbus ) (struct platform_device*) ;} ;
struct usbhs_priv {int irqflags; int /*<<< orphan*/  irq; TYPE_1__ pfunc; } ;
struct usbhs_mod_info {int (* irq_vbus ) (struct usbhs_priv*,struct usbhs_irq_state*) ;struct usbhs_mod* curt; struct usbhs_mod** mod; } ;
struct usbhs_mod {int irq_bempsts; int irq_brdysts; scalar_t__ irq_sack; scalar_t__ irq_sign; scalar_t__ irq_dtch; scalar_t__ irq_attch; scalar_t__ irq_ready; scalar_t__ irq_empty; scalar_t__ irq_ctrl_stage; struct usbhs_priv* priv; } ;
...
#define  ADDRESS_STATE 133 
 ...
 int /*<<< orphan*/  BRDYENB ; 
 int /*<<< orphan*/  BRDYSTS ; 
#define  CONFIGURATION_STATE 132 
 int CTRE ; 
 int CTRT ; 
 int CTSQ_MASK ; 
#define  DEFAULT_STATE 131 
 int DTCH ; 
 int DTCHE ; 
 int DVSQ_MASK ; 
 int DVST ; 
...
#define  USBHS_HOST 128 
 ...
 int devm_request_irq (struct device*,int /*<<< orphan*/ ,int /*<<< orphan*/  (*) (int,void*),int,int /*<<< orphan*/ ,struct usbhs_priv*) ; 
...
static  int /*<<< orphan*/  usbhs_interrupt (int,void*) ; 
 void usbhs_irq_callback_update (struct usbhs_priv*,struct usbhs_mod*) ; 
...
__attribute__((used)) static int usbhs_status_get_each_irq(struct usbhs_priv *priv,
