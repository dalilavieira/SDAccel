...
struct TYPE_45__ {int num; int den; } ;
struct TYPE_49__ {TYPE_1__ time_base; } ;
struct TYPE_48__ {void* duration; int /*<<< orphan*/  pts; int /*<<< orphan*/  pict_type; TYPE_3__* priv_data; } ;
struct TYPE_47__ {void* lba; unsigned int* buffer; int copied; } ;
...
typedef  TYPE_3__ DVDNavParseContext ;
...
/* Variables and functions */
 ...
 void* AV_RB32 (unsigned int const*) ; 
