...
/* Variables and functions */
 ...
 int /*<<< orphan*/  AV_WN32A (int /*<<< orphan*/  const*,int /*<<< orphan*/ ) ; 
 int CLIP_SW_0_255 (int) ; 
 int /*<<< orphan*/  ILVL_H2_SW (int,int,int,int,int,int) ; 
 int /*<<< orphan*/  ILVL_H4_SW (int,int,int,int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  ILVR_B4_SH (int,int,int,int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  ILVR_B4_SW (int,int,int,int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  ILVR_H2_SW (int,int,int,int,int,int) ; 
 int /*<<< orphan*/  ILVR_H4_SW (int,int,int,int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  LD_SB4 (int /*<<< orphan*/  const*,int,int,int,int,int) ; 
 int /*<<< orphan*/  LD_SB8 (int /*<<< orphan*/  const*,int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  LD_SH8 (int*,int,int,int,int,int,int,int,int,int) ; 
 int /*<<< orphan*/  LD_SW2 (int*,int,int,int) ; 
 int /*<<< orphan*/  ST2x4_UB (int,int /*<<< orphan*/ ,int /*<<< orphan*/  const*,int) ; 
 int /*<<< orphan*/  ST4x4_UB (int,int,int /*<<< orphan*/ ,int,int,int,int /*<<< orphan*/  const*,int) ; 
 int /*<<< orphan*/  ST8x1_UB (int,int /*<<< orphan*/  const*) ; 
 ...
 scalar_t__ __msa_xor_v (scalar_t__,scalar_t__) ; 
