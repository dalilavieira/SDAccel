...
typedef  int u8 ;
typedef  int u32 ;
struct cxd2880_spi {int (* write_read ) (struct cxd2880_spi*,int*,int,int*,int) ;int (* write ) (struct cxd2880_spi*,int*,int) ;} ;
struct cxd2880_io {int (* read_regs ) (struct cxd2880_io*,int,int,int*,int) ;int (* write_regs ) (struct cxd2880_io*,int,int,int const*,int) ;int slave_select; scalar_t__ i2c_address_demod; scalar_t__ i2c_address_sys; struct cxd2880_spi* if_object; int /*<<< orphan*/  write_reg; } ;
...
/* Variables and functions */
 ...
 int stub3 (struct cxd2880_spi*,int*,int) ; 
