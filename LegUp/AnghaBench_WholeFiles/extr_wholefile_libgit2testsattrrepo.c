...
/* Type definitions */
struct attr_expected {char* path; char* attr; int /*<<< orphan*/  expected_str; int /*<<< orphan*/  expected; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  attr_check_expected (int /*<<< orphan*/ ,int /*<<< orphan*/ ,char*,char const*) ; 
 ...
 int git_attr_cache__is_cached (int /*<<< orphan*/ *,int /*<<< orphan*/ ,char*) ; 
 int /*<<< orphan*/  git_attr_foreach (int /*<<< orphan*/ *,int /*<<< orphan*/ ,char*,int (*) (char const*,char const*,void*),int*) ; 
