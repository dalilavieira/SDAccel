...
struct v4l2_window {struct v4l2_rect w; int /*<<< orphan*/  chromakey; int /*<<< orphan*/  field; } ;
...
#define  OMAPDSS_VER_OMAP3630 128 
 ...
 int omap_vout_dss_omap24xx () ; 
 int omap_vout_dss_omap34xx () ; 
