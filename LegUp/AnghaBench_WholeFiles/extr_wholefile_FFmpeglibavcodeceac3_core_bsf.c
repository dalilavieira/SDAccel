...
struct TYPE_48__ {scalar_t__ frame_type; int frame_size; } ;
struct TYPE_47__ {unsigned int* data; int size; } ;
...
typedef  TYPE_3__ AC3HeaderInfo ;
...
/* Variables and functions */
 ...
 int ff_ac3_parse_header (TYPE_1__*,TYPE_3__*) ; 
 int ff_bsf_get_packet_ref (int /*<<< orphan*/ *,TYPE_2__*) ; 
 int /*<<< orphan*/  re ; 
