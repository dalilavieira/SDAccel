...
struct TYPE_34__ {scalar_t__ Signature; } ;
struct TYPE_33__ {TYPE_1__* ops; } ;
struct TYPE_32__ {char const* name; int (* read ) (TYPE_2__*,void*,unsigned int) ;int (* write ) (TYPE_2__*,void const*,unsigned int) ;int (* close ) (TYPE_2__*) ;int (* is_authorized ) (TYPE_2__*) ;int /*<<< orphan*/  (* inquire_auth_client ) (TYPE_2__*,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ ) ;int /*<<< orphan*/  (* revert_to_self ) (TYPE_2__*) ;int /*<<< orphan*/  (* impersonate_client ) (TYPE_2__*) ;int /*<<< orphan*/  (* secure_packet ) (TYPE_2__*,int,int /*<<< orphan*/ *,unsigned int,unsigned char*,unsigned int,int /*<<< orphan*/ *,unsigned char*,unsigned int) ;int /*<<< orphan*/  (* authorize ) (TYPE_2__*,int,unsigned char*,unsigned int,unsigned char*,unsigned int*) ;int /*<<< orphan*/  (* handoff ) (TYPE_2__*,TYPE_2__*) ;int /*<<< orphan*/  (* cancel_call ) (TYPE_2__*) ;int /*<<< orphan*/  (* close_read ) (TYPE_2__*) ;} ;
...
typedef  TYPE_3__* PRPC_ASYNC_STATE ;
typedef  int BOOL ;
...
/* Variables and functions */
 ...
 int stub7 (TYPE_2__*) ; 
 int /*<<< orphan*/  stub8 (TYPE_2__*,int,unsigned char*,unsigned int,unsigned char*,unsigned int*) ; 
