...
/* Type definitions */
struct TYPE_6__ {int cont; int start; scalar_t__ encode; int buf_len; int buf_off; size_t tmp_len; char const* buf; unsigned char* tmp; int tmp_nl; int /*<<< orphan*/ * base64; } ;
