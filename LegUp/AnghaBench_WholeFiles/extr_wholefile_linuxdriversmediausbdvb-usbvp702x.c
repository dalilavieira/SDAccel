...
struct vp702x_adapter_state {int pid_filter_state; int pid_filter_count; int pid_filter_can_bypass; } ;
struct usb_interface {int dummy; } ;
struct usb_device_id {int dummy; } ;
struct rc_map_table {int scancode; } ;
struct dvb_usb_device {struct vp702x_device_state* priv; int /*<<< orphan*/  usb_mutex; int /*<<< orphan*/  udev; } ;
struct dvb_usb_adapter {struct dvb_usb_device* dev; TYPE_1__* fe_adap; struct vp702x_adapter_state* priv; } ;
typedef  int pid ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  deb_xfer (char*,int,int,int) ; 
 int /*<<< orphan*/  debug_dump (int*,int,int /*<<< orphan*/  (*) (char*,int,int,int)) ; 
 ...
 int /*<<< orphan*/  vp702x_fe_attach (struct dvb_usb_device*) ; 
