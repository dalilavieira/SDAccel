...
struct TYPE_15__ {int s10; int direction; int element; int character; char* buf; int width; } ;
struct TYPE_14__ {char* buf; int direction; int buf_alloc; int buflen; TYPE_2__ i25; scalar_t__ modifiers; } ;
