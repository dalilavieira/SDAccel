...
struct TYPE_4__ {int /*<<< orphan*/  alarm_program_lock; } ;
struct nvbios_therm_threshold {int hysteresis; int temp; } ;
struct nvbios_therm_sensor {struct nvbios_therm_threshold thrs_critical; struct nvbios_therm_threshold thrs_fan_boost; struct nvbios_therm_threshold thrs_shutdown; struct nvbios_therm_threshold thrs_down_clock; } ;
struct nvkm_therm {struct nvkm_subdev subdev; TYPE_2__ sensor; struct nvbios_therm_sensor bios_sensor; TYPE_1__* func; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  nvkm_debug (struct nvkm_subdev*,char*,int,int,int,int,int,int,int,int) ; 
