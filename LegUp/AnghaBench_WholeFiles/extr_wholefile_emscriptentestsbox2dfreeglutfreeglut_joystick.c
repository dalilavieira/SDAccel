...
/* Type definitions */
struct TYPE_10__ {void* JoysticksInitialised; } ;
struct TYPE_9__ {int num_axes; int error; float* center; float* min; float* saturate; float* dead_band; float* max; int num_buttons; char* name; } ;
