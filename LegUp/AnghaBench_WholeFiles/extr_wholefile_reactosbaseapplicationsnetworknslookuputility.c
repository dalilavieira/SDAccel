...
/* Variables and functions */
 void* AF_INET ; 
#define  CLASS_ANY 169 
#define  CLASS_IN 168 
 char* ClassAny ; 
 char* ClassIDtoClassName (scalar_t__) ; 
 char* ClassIN ; 
 scalar_t__ FALSE ; 
 int /*<<< orphan*/  INADDR_ANY ; 
 scalar_t__ INVALID_SOCKET ; 
 int /*<<< orphan*/  IPPROTO_UDP ; 
#define  OPCODE_IQUERY 167 
#define  OPCODE_QUERY 166 
#define  OPCODE_STATUS 165 
 char* OpcodeIDtoOpcodeName (int) ; 
 char* OpcodeIQuery ; 
 char* OpcodeQuery ; 
 char* OpcodeReserved ; 
 char* OpcodeStatus ; 
 void PrintD2 (char*,int) ; 
 void PrintDebug (char*,int) ; 
#define  RCODE_FAILURE 164 
#define  RCODE_FORMERR 163 
#define  RCODE_NOERROR 162 
#define  RCODE_NOTIMP 161 
#define  RCODE_NXDOMAIN 160 
#define  RCODE_REFUSED 159 
 char* RCodeFAILURE ; 
 char* RCodeFORMERR ; 
 char* RCodeIDtoRCodeName (int) ; 
 char* RCodeNOERROR ; 
 char* RCodeNOTIMP ; 
 char* RCodeNXDOMAIN ; 
 char* RCodeREFUSED ; 
...
#define  TYPE_WKS 151 
 ...
 char* TypeAny ; 
 char* TypeCNAME ; 
 char* TypeIDtoTypeName (scalar_t__) ; 
 char* TypeMX ; 
 char* TypeNS ; 
 char* TypePTR ; 
 char* TypeSOA ; 
...
#define  WSANOTINITIALISED 128 
 ...
 int recvfrom (scalar_t__,char*,int,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int*) ; 
 int sendto (scalar_t__,char*,int,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int) ; 
