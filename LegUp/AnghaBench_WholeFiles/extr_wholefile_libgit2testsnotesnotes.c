...
/* Type definitions */
struct note_create_payload {char* note_oid; char* object_oid; int seen; char* member_0; char* member_1; int /*<<< orphan*/  member_2; } ;
...
struct TYPE_2__ {char* note_sha; char* annotated_object_sha; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  cl_assert_equal_oid (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 ...
 int /*<<< orphan*/  git_commit_lookup (int /*<<< orphan*/ **,int /*<<< orphan*/ ,int /*<<< orphan*/  const*) ; 
 int git_note_commit_create (int /*<<< orphan*/  const*,int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/  const*,char const*,int) ; 
 ...
 int git_note_commit_remove (int /*<<< orphan*/  const*,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/  const*) ; 
 int git_note_create (int /*<<< orphan*/  const*,int /*<<< orphan*/ ,char const*,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/  const*,char const*,int) ; 
 int git_note_default_ref (int /*<<< orphan*/ *,int /*<<< orphan*/ ) ; 
 int git_note_foreach (int /*<<< orphan*/ ,char*,int (*) (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,void*),...) ; 
 int /*<<< orphan*/  git_note_free (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  const* git_note_id (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  git_note_iterator_free (int /*<<< orphan*/ *) ; 
 int git_note_iterator_new (int /*<<< orphan*/ **,int /*<<< orphan*/ ,char*) ; 
 int /*<<< orphan*/  git_note_message (int /*<<< orphan*/ *) ; 
 int git_note_next (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*,int /*<<< orphan*/ *) ; 
 int git_note_read (int /*<<< orphan*/ **,int /*<<< orphan*/ ,char*,int /*<<< orphan*/  const*) ; 
 int git_note_remove (int /*<<< orphan*/ ,char*,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/  const*) ; 
 scalar_t__ git_oid_cmp (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int /*<<< orphan*/  git_oid_cpy (int /*<<< orphan*/  const*,int /*<<< orphan*/  const*) ; 
 int git_oid_fromstr (int /*<<< orphan*/  const*,char const*) ; 
 int git_reference_create (int /*<<< orphan*/ **,int /*<<< orphan*/ ,char*,int /*<<< orphan*/  const*,int /*<<< orphan*/ ,int /*<<< orphan*/ *) ; 
