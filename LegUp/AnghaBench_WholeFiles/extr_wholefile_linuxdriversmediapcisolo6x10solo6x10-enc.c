...
struct solo_dev {int irq_mask; scalar_t__ type; unsigned long video_hsize; unsigned long video_vsize; int nr_chans; int* jpeg_qp; int /*<<< orphan*/  jpeg_qp_lock; int /*<<< orphan*/  pdev; scalar_t__ reg_base; } ;
...
/* Variables and functions */
 ...
 void* SOLO_VE_JPEG_QP_CH_H ; 
 void* SOLO_VE_JPEG_QP_CH_L ; 
 ...
 int /*<<< orphan*/  solo_p2m_dma (struct solo_dev*,int,int*,int,int,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
