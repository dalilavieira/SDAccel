...
struct TYPE_10__ {int ready; int error; int eof; size_t available; int active; scalar_t__ complete; TYPE_1__ ovlp; } ;
...
/* Variables and functions */
 ...
 int WSARecv (int /*<<< orphan*/ ,TYPE_4__*,int,size_t*,size_t*,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
