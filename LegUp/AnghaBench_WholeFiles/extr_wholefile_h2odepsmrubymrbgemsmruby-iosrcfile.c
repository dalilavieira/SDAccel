...
#define  EINTR 128 
 ...
 int /*<<< orphan*/  mrb_define_class_method (int /*<<< orphan*/ *,struct RClass*,char*,char* (*) (int /*<<< orphan*/ *,char*),int) ; 
 int /*<<< orphan*/  mrb_define_const (int /*<<< orphan*/ *,struct RClass*,char*,char*) ; 
 int /*<<< orphan*/  mrb_define_method (int /*<<< orphan*/ *,struct RClass*,char*,char* (*) (int /*<<< orphan*/ *,char*),int) ; 
 struct RClass* mrb_define_module_under (int /*<<< orphan*/ *,struct RClass*,char*) ; 
 char* mrb_ensure_string_type (int /*<<< orphan*/ *,char*) ; 
 char* mrb_false_value () ; 
 scalar_t__ mrb_fixnum (int /*<<< orphan*/ ) ; 
 char* mrb_fixnum_value (size_t) ; 
 char* mrb_format (int /*<<< orphan*/ *,char*,char*,char*) ; 
 int /*<<< orphan*/  mrb_free (int /*<<< orphan*/ *,char*) ; 
 char* mrb_funcall (int /*<<< orphan*/ *,char*,char*,int,char*) ; 
 int /*<<< orphan*/  mrb_gc_arena_restore (int /*<<< orphan*/ *,int) ; 
 int mrb_gc_arena_save (int /*<<< orphan*/ *) ; 
 scalar_t__ mrb_get_args (int /*<<< orphan*/ *,char*,...) ; 
 int /*<<< orphan*/  mrb_io_fileno (int /*<<< orphan*/ *,char*) ; 
 int /*<<< orphan*/  mrb_locale_free (char const*) ; 
 void* mrb_locale_from_utf8 (char const*,int) ; 
 scalar_t__ mrb_malloc (int /*<<< orphan*/ *,size_t) ; 
 char* mrb_nil_value () ; 
 char* mrb_obj_value (struct RClass*) ; 
 int /*<<< orphan*/  mrb_raise (int /*<<< orphan*/ *,int /*<<< orphan*/ ,char*) ; 
 int /*<<< orphan*/  mrb_raisef (int /*<<< orphan*/ *,int /*<<< orphan*/ ,char*,char*) ; 
 scalar_t__ mrb_realloc (int /*<<< orphan*/ *,char*,size_t) ; 
 char* mrb_str_append (int /*<<< orphan*/ *,char*,char*) ; 
 char* mrb_str_buf_new (int /*<<< orphan*/ *,int /*<<< orphan*/ ) ; 
 char* mrb_str_dup (int /*<<< orphan*/ *,char*) ; 
 char* mrb_str_new (int /*<<< orphan*/ *,char*,int) ; 
 char* mrb_str_new_cstr (int /*<<< orphan*/ *,char*) ; 
 int /*<<< orphan*/  mrb_str_resize (int /*<<< orphan*/ *,char*,int /*<<< orphan*/ ) ; 
 char* mrb_str_to_cstr (int /*<<< orphan*/ *,char*) ; 
 char* mrb_string_value_cstr (int /*<<< orphan*/ *,char**) ; 
