...
struct sk_buff {int len; unsigned short* data; } ;
struct nr_sock {unsigned short vs; unsigned short vr; int condition; unsigned short va; unsigned short vl; scalar_t__ state; int window; scalar_t__ n2count; int /*<<< orphan*/  reseq_queue; int /*<<< orphan*/  dest_addr; int /*<<< orphan*/  source_addr; int /*<<< orphan*/  ack_queue; } ;
