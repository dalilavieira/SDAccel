...
struct credential {char* protocol; char* host; char* path; char* username; char* password; scalar_t__ port; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  g_error_free (TYPE_4__*) ; 
 int /*<<< orphan*/  g_free (char*) ; 
 int /*<<< orphan*/  g_hash_table_insert (int /*<<< orphan*/ *,char*,char*) ; 
 char* g_hash_table_lookup (int /*<<< orphan*/ *,char*) ; 
 int /*<<< orphan*/ * g_hash_table_new_full (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/  (*) (char*)) ; 
 ...
 int /*<<< orphan*/  secret_password_clearv_sync (int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *,TYPE_4__**) ; 
 int /*<<< orphan*/  secret_password_storev_sync (int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *,char*,char*,int /*<<< orphan*/ *,TYPE_4__**) ; 
 int /*<<< orphan*/ * secret_service_get_sync (int /*<<< orphan*/ ,int /*<<< orphan*/ *,TYPE_4__**) ; 
 TYPE_3__* secret_service_search_sync (int /*<<< orphan*/ *,int /*<<< orphan*/ ,int /*<<< orphan*/ *,int,int /*<<< orphan*/ *,TYPE_4__**) ; 
