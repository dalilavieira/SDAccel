...
/* Type definitions */
struct TYPE_7__ {scalar_t__ original_sync_level; scalar_t__ thread_id; scalar_t__ acquisition_depth; scalar_t__ sync_level; struct acpi_thread_state* owner_thread; union acpi_operand_object* next; union acpi_operand_object* prev; int /*<<< orphan*/  os_mutex; TYPE_4__* node; } ;
struct TYPE_5__ {scalar_t__ value; } ;
union acpi_operand_object {TYPE_3__ mutex; TYPE_1__ integer; } ;
typedef  scalar_t__ u8 ;
typedef  int /*<<< orphan*/  u32 ;
typedef  int /*<<< orphan*/  u16 ;
struct acpi_walk_state {struct acpi_thread_state* thread; } ;
struct acpi_thread_state {scalar_t__ current_sync_level; scalar_t__ thread_id; union acpi_operand_object* acquired_mutex_list; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  acpi_ut_get_node_name (TYPE_4__*) ; 
