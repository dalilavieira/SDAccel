...
typedef  struct TYPE_57__   TYPE_44__ ;
...
struct TYPE_58__ {scalar_t__ (* init ) (TYPE_11__*,TYPE_5__*) ;TYPE_6__* data; } ;
struct TYPE_59__ {TYPE_4__ peer; } ;
typedef  TYPE_5__ ngx_stream_upstream_srv_conf_t ;
struct TYPE_60__ {int total_weight; TYPE_7__* peer; } ;
typedef  TYPE_6__ ngx_stream_upstream_rr_peers_t ;
struct TYPE_48__ {int len; char* data; } ;
struct TYPE_61__ {scalar_t__ weight; scalar_t__ max_fails; scalar_t__ fails; scalar_t__ checked; scalar_t__ fail_timeout; scalar_t__ max_conns; scalar_t__ conns; TYPE_12__ server; struct TYPE_61__* next; int /*<<< orphan*/  name; int /*<<< orphan*/  socklen; int /*<<< orphan*/  sockaddr; scalar_t__ down; } ;
typedef  TYPE_7__ ngx_stream_upstream_rr_peer_t ;
struct TYPE_62__ {TYPE_10__* points; int /*<<< orphan*/  key; } ;
typedef  TYPE_8__ ngx_stream_upstream_hash_srv_conf_t ;
struct TYPE_51__ {uintptr_t* tried; TYPE_19__* peers; TYPE_7__* current; } ;
struct TYPE_56__ {char* data; int len; } ;
struct TYPE_63__ {int tries; scalar_t__ rehash; int hash; scalar_t__ (* get_rr_peer ) (TYPE_13__*,TYPE_16__*) ;TYPE_16__ rrp; TYPE_43__ key; TYPE_8__* conf; } ;
typedef  TYPE_9__ ngx_stream_upstream_hash_peer_data_t ;
struct TYPE_46__ {size_t number; TYPE_44__* point; } ;
typedef  TYPE_10__ ngx_stream_upstream_chash_points_t ;
typedef  int /*<<< orphan*/  ngx_stream_upstream_chash_point_t ;
struct TYPE_47__ {TYPE_3__* connection; TYPE_2__* upstream; } ;
typedef  TYPE_11__ ngx_stream_session_t ;
typedef  TYPE_12__ ngx_str_t ;
struct TYPE_49__ {int /*<<< orphan*/ * name; int /*<<< orphan*/  socklen; int /*<<< orphan*/  sockaddr; int /*<<< orphan*/  log; int /*<<< orphan*/ * connection; TYPE_43__* tries; } ;
typedef  TYPE_13__ ngx_peer_connection_t ;
typedef  scalar_t__ ngx_int_t ;
struct TYPE_50__ {int /*<<< orphan*/  pool; } ;
typedef  TYPE_14__ ngx_conf_t ;
struct TYPE_57__ {int hash; TYPE_12__* server; } ;
struct TYPE_55__ {int /*<<< orphan*/  log; int /*<<< orphan*/  pool; } ;
struct TYPE_53__ {scalar_t__ (* get ) (TYPE_13__*,void*) ;TYPE_16__* data; } ;
struct TYPE_54__ {TYPE_1__ peer; } ;
struct TYPE_52__ {scalar_t__ total_weight; TYPE_7__* peer; scalar_t__ single; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  ngx_log_debug1 (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,char*,TYPE_43__*) ; 
 int /*<<< orphan*/  ngx_log_debug2 (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ,char*,scalar_t__,int) ; 
 void* ngx_palloc (int /*<<< orphan*/ ,size_t) ; 
 int /*<<< orphan*/  ngx_qsort (TYPE_44__*,size_t,int,int /*<<< orphan*/ ) ; 
 char* ngx_sprintf (char*,char*,scalar_t__) ; 
 scalar_t__ ngx_stream_complex_value (TYPE_11__*,int /*<<< orphan*/ *,TYPE_43__*) ; 
 TYPE_8__* ngx_stream_conf_upstream_srv_conf (TYPE_5__*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  ngx_stream_upstream_chash_cmp_points ; 
static  scalar_t__ ngx_stream_upstream_get_hash_peer (TYPE_13__*,void*) ; 
 scalar_t__ ngx_stream_upstream_get_round_robin_peer (TYPE_13__*,TYPE_16__*) ; 
 int /*<<< orphan*/  ngx_stream_upstream_hash_module ; 
 scalar_t__ ngx_stream_upstream_init_chash_peer (TYPE_11__*,TYPE_5__*) ; 
static  scalar_t__ ngx_stream_upstream_init_hash_peer (TYPE_11__*,TYPE_5__*) ; 
 scalar_t__ ngx_stream_upstream_init_round_robin (TYPE_14__*,TYPE_5__*) ; 
 scalar_t__ ngx_stream_upstream_init_round_robin_peer (TYPE_11__*,TYPE_5__*) ; 
 int /*<<< orphan*/  ngx_stream_upstream_rr_peer_lock (TYPE_19__*,TYPE_7__*) ; 
 int /*<<< orphan*/  ngx_stream_upstream_rr_peer_unlock (TYPE_19__*,TYPE_7__*) ; 
 int /*<<< orphan*/  ngx_stream_upstream_rr_peers_rlock (TYPE_19__*) ; 
 int /*<<< orphan*/  ngx_stream_upstream_rr_peers_unlock (TYPE_19__*) ; 
 scalar_t__ ngx_strncasecmp (char*,char*,int) ; 
 scalar_t__ ngx_time () ; 
 scalar_t__ stub1 (TYPE_13__*,TYPE_16__*) ; 
 scalar_t__ stub2 (TYPE_13__*,TYPE_16__*) ; 
