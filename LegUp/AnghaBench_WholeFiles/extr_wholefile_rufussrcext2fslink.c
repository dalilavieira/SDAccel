...
/* Type definitions */
struct link_struct {int namelen; scalar_t__ err; scalar_t__ inode; char const* name; int flags; unsigned int blocksize; scalar_t__ done; int /*<<< orphan*/  sb; TYPE_1__* fs; } ;
...
struct TYPE_12__ {unsigned int blocksize; int flags; int /*<<< orphan*/  super; } ;
...
/* Variables and functions */
 ...
 scalar_t__ ext2fs_dir_iterate (TYPE_1__*,scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int (*) (struct ext2_dir_entry*,int,int,char*,void*),struct link_struct*) ; 
