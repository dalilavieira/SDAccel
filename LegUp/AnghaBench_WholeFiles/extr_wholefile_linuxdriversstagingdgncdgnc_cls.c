...
struct un_t {scalar_t__ un_type; int un_flags; int /*<<< orphan*/  un_flags_wait; struct channel_t* un_ch; } ;
struct tty_struct {scalar_t__ driver_data; } ;
struct dgnc_board {scalar_t__ nasync; scalar_t__ bd_dividend; int state; int /*<<< orphan*/  helper_tasklet; int /*<<< orphan*/  bd_intr_lock; int /*<<< orphan*/ * re_map_membase; struct channel_t** channels; int /*<<< orphan*/  bd_lock; } ;
struct TYPE_7__ {int digi_flags; } ;
struct TYPE_6__ {int un_flags; int /*<<< orphan*/  un_tty; } ;
struct TYPE_5__ {int /*<<< orphan*/  un_tty; } ;
struct channel_t {int ch_t_tlevel; unsigned char ch_startc; unsigned char ch_stopc; int ch_r_watermark; int ch_r_tlevel; int ch_flags; int ch_r_head; int ch_r_tail; int ch_c_iflag; unsigned char* ch_equeue; int ch_e_head; unsigned char ch_mostat; int ch_w_tail; int ch_w_head; unsigned char* ch_wqueue; unsigned char ch_mistat; int ch_c_cflag; scalar_t__ ch_old_baud; scalar_t__ ch_custom_speed; TYPE_4__* ch_cls_uart; scalar_t__ ch_stop_sending_break; struct dgnc_board* ch_bd; int /*<<< orphan*/  ch_xoff_sends; int /*<<< orphan*/  ch_xon_sends; int /*<<< orphan*/  ch_lock; TYPE_3__ ch_digi; TYPE_2__ ch_tun; TYPE_1__ ch_pun; scalar_t__ ch_e_tail; int /*<<< orphan*/  ch_txcount; int /*<<< orphan*/  ch_rxcount; int /*<<< orphan*/  ch_err_frame; int /*<<< orphan*/  ch_err_break; int /*<<< orphan*/  ch_err_parity; void** ch_rqueue; int /*<<< orphan*/  ch_err_overrun; } ;
typedef  int /*<<< orphan*/  irqreturn_t ;
struct TYPE_8__ {int /*<<< orphan*/  txrx; int /*<<< orphan*/  lcr; int /*<<< orphan*/  lsr; int /*<<< orphan*/  ier; int /*<<< orphan*/  msr; int /*<<< orphan*/  isr_fcr; int /*<<< orphan*/  mcr; int /*<<< orphan*/  spr; } ;
...
#define  CS8 128 
 ...
 int UART_CLASSIC_POLL_ADDR_OFFSET ; 
