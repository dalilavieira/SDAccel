...
struct TYPE_3__ {int (* onetimeauth ) (unsigned char*,unsigned char const*,unsigned long long,unsigned char const*) ;int (* onetimeauth_verify ) (unsigned char const*,unsigned char const*,unsigned long long,unsigned char const*) ;int (* onetimeauth_init ) (int /*<<< orphan*/ *,unsigned char const*) ;int (* onetimeauth_update ) (int /*<<< orphan*/ *,unsigned char const*,unsigned long long) ;int (* onetimeauth_final ) (int /*<<< orphan*/ *,unsigned char*) ;} ;

/* Variables and functions */
 size_t crypto_onetimeauth_poly1305_BYTES ; 
 size_t crypto_onetimeauth_poly1305_KEYBYTES ; 
 TYPE_1__ crypto_onetimeauth_poly1305_donna_implementation ; 
 ...
 int stub2 (unsigned char const*,unsigned char const*,unsigned long long,unsigned char const*) ; 
 int stub3 (int /*<<< orphan*/ *,unsigned char const*) ; 
 int stub4 (int /*<<< orphan*/ *,unsigned char const*,unsigned long long) ; 
 int stub5 (int /*<<< orphan*/ *,unsigned char*) ; 
