...
struct TYPE_2__ {int format; int levels; int is_render_target; int gen_mipmaps; int /*<<< orphan*/  texture; scalar_t__ gl_target; scalar_t__ gl_internal_format; scalar_t__ gl_format; scalar_t__ type; int /*<<< orphan*/ * device; } ;
struct gs_texture_cube {int size; TYPE_1__ base; } ;
struct fbo_info {scalar_t__ type; int format; struct fbo_info* fbo; int /*<<< orphan*/  texture; int /*<<< orphan*/  ref; } ;
typedef  struct fbo_info gs_texture_t ;
...
/* Variables and functions */
 ...
 scalar_t__ GL_TEXTURE_MAX_LEVEL ; 
...
#define  GS_ZS_NONE 128 
 ...
 struct gs_texture_cube* bzalloc (int) ; 
 ...
 int /*<<< orphan*/  glDeleteFramebuffers (int,struct fbo_info**) ; 
 ...
 int /*<<< orphan*/  gl_init_face (scalar_t__,scalar_t__,int,scalar_t__,scalar_t__,int,int,int,int,int /*<<< orphan*/  const***) ; 
 void gs_cubetexture_destroy (struct fbo_info*) ; 
