...
struct TYPE_8__ {int /*<<< orphan*/ * g; int /*<<< orphan*/ * q; int /*<<< orphan*/ * p; TYPE_1__* meth; } ;
struct TYPE_7__ {int (* dsa_paramgen ) (TYPE_2__*,int,unsigned char const*,int,int*,unsigned long*,int /*<<< orphan*/ *) ;} ;
...
/* Variables and functions */
 ...
 int dsa_builtin_paramgen (TYPE_2__*,size_t,size_t,int /*<<< orphan*/  const*,unsigned char const*,size_t,unsigned char*,int*,unsigned long*,int /*<<< orphan*/ *) ; 
