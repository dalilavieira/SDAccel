...
struct TYPE_33__ {int h_sync; int h_buffer_credits; TYPE_3__* h_transaction; } ;
...
struct TYPE_32__ {int /*<<< orphan*/  t_tid; TYPE_2__* t_journal; int /*<<< orphan*/  t_private_list; } ;
struct TYPE_31__ {struct super_block* j_private; } ;
struct TYPE_30__ {scalar_t__ s_feature_compat; scalar_t__ s_feature_ro_compat; scalar_t__ s_feature_incompat; } ;
