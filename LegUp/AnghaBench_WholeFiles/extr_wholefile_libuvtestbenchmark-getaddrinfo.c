...
static  void getaddrinfo_initiate (int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  loop ; 
 int /*<<< orphan*/  name ; 
 int /*<<< orphan*/  uv_close (int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  uv_freeaddrinfo (struct addrinfo*) ; 
 int uv_getaddrinfo (int /*<<< orphan*/ ,int /*<<< orphan*/ *,void (*) (int /*<<< orphan*/ *,int,struct addrinfo*),int /*<<< orphan*/ ,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
