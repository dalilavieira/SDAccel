...
typedef  int int32_t ;
typedef  int int16_t ;
struct TYPE_6__ {int* raster_end; } ;
struct TYPE_7__ {size_t* block_last_index; int y_dc_scale; int c_dc_scale; int* inter_matrix; TYPE_1__ inter_scantable; scalar_t__ ac_pred; scalar_t__ h263_aic; } ;
typedef  TYPE_2__ MpegEncContext ;

/* Variables and functions */
 scalar_t__ HADD_SW_S32 (int) ; 
 int LD_SH (int*) ; 
 int /*<<< orphan*/  LD_SH4 (int const*,int,int,int,int,int) ; 
