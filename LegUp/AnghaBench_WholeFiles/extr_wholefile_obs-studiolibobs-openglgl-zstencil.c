...
struct gs_zstencil_buffer {scalar_t__ buffer; int /*<<< orphan*/ * device; scalar_t__ attachment; scalar_t__ format; int /*<<< orphan*/  fbo; int /*<<< orphan*/  ref; } ;
struct fbo_info {scalar_t__ buffer; int /*<<< orphan*/ * device; scalar_t__ attachment; scalar_t__ format; int /*<<< orphan*/  fbo; int /*<<< orphan*/  ref; } ;
typedef  struct gs_zstencil_buffer gs_zstencil_t ;
typedef  struct gs_zstencil_buffer gs_samplerstate_t ;
...
/* Variables and functions */
 ...
 scalar_t__ GL_DEPTH_STENCIL_ATTACHMENT ; 
...
#define  GS_ZS_NONE 128 
 ...
 int /*<<< orphan*/  bfree (struct gs_zstencil_buffer*) ; 
 int /*<<< orphan*/  blog (int /*<<< orphan*/ ,char*,...) ; 
 struct gs_zstencil_buffer* bzalloc (int) ; 
 int /*<<< orphan*/  glActiveTexture (scalar_t__) ; 
 int /*<<< orphan*/  glBindBuffer (scalar_t__,scalar_t__) ; 
 int /*<<< orphan*/  glBindFramebuffer (scalar_t__,scalar_t__) ; 
 int /*<<< orphan*/  glBindRenderbuffer (scalar_t__,scalar_t__) ; 
 int /*<<< orphan*/  glBindTexture (scalar_t__,scalar_t__) ; 
 int /*<<< orphan*/  glBindVertexArray (scalar_t__) ; 
 int /*<<< orphan*/  glCullFace (scalar_t__) ; 
 int /*<<< orphan*/  glDeleteBuffers (int /*<<< orphan*/ ,scalar_t__*) ; 
 int /*<<< orphan*/  glDeleteFramebuffers (int,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  glDeleteRenderbuffers (int,scalar_t__*) ; 
 int /*<<< orphan*/  glDeleteTextures (int /*<<< orphan*/ ,scalar_t__*) ; 
 int /*<<< orphan*/  glDeleteVertexArrays (int /*<<< orphan*/ ,scalar_t__*) ; 
 int /*<<< orphan*/  glDisable (scalar_t__) ; 
 int /*<<< orphan*/  glEnable (scalar_t__) ; 
 int /*<<< orphan*/  glGenBuffers (int /*<<< orphan*/ ,scalar_t__*) ; 
 int /*<<< orphan*/  glGenRenderbuffers (int,scalar_t__*) ; 
 int /*<<< orphan*/  glGenTextures (int /*<<< orphan*/ ,scalar_t__*) ; 
 int /*<<< orphan*/  glGenVertexArrays (int /*<<< orphan*/ ,scalar_t__*) ; 
 scalar_t__ glGetError () ; 
 int /*<<< orphan*/  glGetIntegerv (scalar_t__,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  glRenderbufferStorage (scalar_t__,scalar_t__,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  glTexParameterf (scalar_t__,scalar_t__,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  glTexParameteri (scalar_t__,scalar_t__,int /*<<< orphan*/ ) ; 
 void gs_zstencil_destroy (struct gs_zstencil_buffer*) ; 
