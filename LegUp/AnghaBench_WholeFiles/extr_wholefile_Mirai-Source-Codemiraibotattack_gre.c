...
struct iphdr {int version; int ihl; int tos; int id; int ttl; int saddr; int daddr; void* check; void* protocol; void* frag_off; void* tot_len; } ;
struct grehdr {void* protocol; } ;
struct ethhdr {scalar_t__ h_source; scalar_t__ h_dest; void* h_proto; } ;
struct TYPE_3__ {int s_addr; } ;
struct TYPE_4__ {scalar_t__ sin_port; TYPE_1__ sin_addr; void* sin_family; } ;
