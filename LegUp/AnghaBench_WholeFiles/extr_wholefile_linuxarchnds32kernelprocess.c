...
/* Type definitions */
struct pt_regs {unsigned long sp; char** uregs; unsigned long r6; unsigned long r7; unsigned long pc; scalar_t__ osp; int /*<<< orphan*/  gp; int /*<<< orphan*/  fp; scalar_t__ lp; } ;
