...
struct TYPE_17__ {char* shader; double* color; TYPE_1__* shaderImage; } ;
typedef  TYPE_2__ shaderInfo_t ;
typedef  int /*<<< orphan*/  entity_t ;
struct TYPE_18__ {char* shader; } ;
typedef  TYPE_3__ bspShader_t ;
struct TYPE_19__ {int numBSPSurfaces; int firstBSPSurface; } ;
typedef  TYPE_4__ bspModel_t ;
struct TYPE_20__ {double* xyz; double* normal; double* st; } ;
typedef  TYPE_5__ bspDrawVert_t ;
struct TYPE_21__ {int surfaceType; int shaderNum; int numVerts; int numIndexes; int firstVert; int firstIndex; } ;
