...
typedef  int byte ;
struct TYPE_57__ {int* cs; } ;
struct TYPE_55__ {int ps; int n; } ;
struct TYPE_56__ {int key; int tag; int cap; int /*<<< orphan*/ * code; scalar_t__ codesize; struct TYPE_56__* tree; TYPE_1__ u; } ;
typedef  TYPE_2__ TTree ;
typedef  TYPE_2__ Pattern ;
typedef  int /*<<< orphan*/  Instruction ;
typedef  TYPE_4__ Charset ;
...
#define  LUA_TBOOLEAN 149 
#define  LUA_TFUNCTION 148 
#define  LUA_TNUMBER 147 
#define  LUA_TSTRING 146 
#define  LUA_TTABLE 145 
 int /*<<< orphan*/  MAXBACK ; 
 int MAXBEHIND ; 
 scalar_t__ MAXLIM ; 
 int MAXRULES ; 
...
#define  TTrue 128 
 ...
 int bytes2slots (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/ * compile (int /*<<< orphan*/ *,TYPE_2__*) ; 
 ...
 int /*<<< orphan*/  luaL_checktype (int /*<<< orphan*/ *,int,int const) ; 
 ...
 int /*<<< orphan*/  metareg ; 
static  TYPE_2__* newgrammar (int /*<<< orphan*/ *,int) ; 
 scalar_t__ nofail (TYPE_2__*) ; 
 int nullable (TYPE_2__*) ; 
 int* numsiblings ; 
 int /*<<< orphan*/  pattreg ; 
 int /*<<< orphan*/  printktable (int /*<<< orphan*/ *,int) ; 
 int /*<<< orphan*/  printpatt (int /*<<< orphan*/ *,scalar_t__) ; 
 int /*<<< orphan*/  printtree (TYPE_2__*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  realloccode (int /*<<< orphan*/ *,TYPE_2__*,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  setchar (int*,int) ; 
 TYPE_2__* sib1 (TYPE_2__*) ; 
 TYPE_2__* sib2 (TYPE_2__*) ; 
 scalar_t__ tocharset (TYPE_2__*,TYPE_4__*) ; 
...
__attribute__((used)) static int lp_locale (lua_State *L) {
