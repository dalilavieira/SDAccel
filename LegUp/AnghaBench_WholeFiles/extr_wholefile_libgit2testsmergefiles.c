...
/* Type definitions */
struct TYPE_17__ {size_t automergeable; size_t mode; size_t len; char const* ptr; int /*<<< orphan*/  member_0; int /*<<< orphan*/  path; } ;
typedef  TYPE_1__ git_merge_file_result ;
struct TYPE_18__ {int /*<<< orphan*/  flags; int /*<<< orphan*/  favor; } ;
typedef  TYPE_2__ git_merge_file_options ;
struct TYPE_19__ {char* ptr; size_t size; char* path; int mode; } ;
typedef  TYPE_3__ git_merge_file_input ;
struct TYPE_20__ {char* path; int mode; int /*<<< orphan*/  id; } ;
typedef  TYPE_4__ git_index_entry ;
typedef  int /*<<< orphan*/  git_config ;

/* Variables and functions */
 char const* AUTOMERGEABLE_MERGED_FILE ; 
 ...
 int /*<<< orphan*/  git_merge_file_from_index (TYPE_1__*,int /*<<< orphan*/ ,TYPE_4__*,TYPE_4__*,TYPE_4__*,int /*<<< orphan*/ ) ; 
