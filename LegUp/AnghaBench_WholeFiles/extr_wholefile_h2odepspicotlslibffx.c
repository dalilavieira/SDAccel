...
struct TYPE_9__ {void (* do_dispose ) (int*) ;void (* do_init ) (struct st_ptls_cipher_context_t*,void const*) ;void (* do_transform ) (int*,void*,void const*,size_t) ;TYPE_1__* algo; } ;
struct TYPE_10__ {int* enc_ctx; int nb_rounds; int is_enc; size_t byte_length; int nb_left; int nb_right; int mask_last_byte; int* tweaks; TYPE_2__ super; } ;
typedef  TYPE_3__ ptls_ffx_context_t ;
typedef  int ptls_cipher_context_t ;
struct TYPE_11__ {scalar_t__ key_size; scalar_t__ iv_size; } ;
typedef  TYPE_4__ ptls_cipher_algorithm_t ;
typedef  int /*<<< orphan*/  left ;
typedef  int /*<<< orphan*/  confusion ;
struct TYPE_8__ {scalar_t__ key_size; scalar_t__ iv_size; size_t block_size; } ;

/* Variables and functions */
 int PTLS_ERROR_LIBRARY ; 
 int /*<<< orphan*/  assert (int) ; 
static  void ffx_dispose (int*) ; 
static  void ffx_encrypt (int*,void*,void const*,size_t) ; 
static  void ffx_init (struct st_ptls_cipher_context_t*,void const*) ; 
 int /*<<< orphan*/  free (int*) ; 
 scalar_t__ malloc (int) ; 
 int /*<<< orphan*/  memcpy (int*,void const*,int) ; 
 int /*<<< orphan*/  memset (int*,int /*<<< orphan*/ ,int) ; 
 int /*<<< orphan*/  ptls_cipher_encrypt (int*,int*,int const*,int) ; 
 int /*<<< orphan*/  ptls_cipher_free (int*) ; 
 int /*<<< orphan*/  ptls_cipher_init (int*,int*) ; 
...
__attribute__((used)) static void ffx_encrypt(ptls_cipher_context_t *_ctx, void *output, const void *input, size_t len)
{
    ptls_ffx_context_t *ctx = (ptls_ffx_context_t *)_ctx;
