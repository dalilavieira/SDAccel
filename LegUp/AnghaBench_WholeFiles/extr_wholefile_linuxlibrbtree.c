...
struct rb_root_cached {struct rb_node const* rb_leftmost; struct rb_root rb_root; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  __rb_change_child_rcu (struct rb_node const*,struct rb_node const*,struct rb_node const*,struct rb_root*) ; 
 struct rb_node const* __rb_erase_augmented (struct rb_node const*,struct rb_root*,struct rb_node const**,int /*<<< orphan*/ *) ; 
 int /*<<< orphan*/  __rb_insert (struct rb_node const*,struct rb_root*,int,struct rb_node const**,void (*) (struct rb_node const*,struct rb_node const*)) ; 
