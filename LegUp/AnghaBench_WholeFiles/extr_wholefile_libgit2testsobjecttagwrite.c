...
struct TYPE_8__ {int time; int offset; } ;
struct TYPE_9__ {char* name; char* email; TYPE_1__ when; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  git_tag_annotation_create (int /*<<< orphan*/ *,int /*<<< orphan*/ ,char const*,int /*<<< orphan*/ *,TYPE_2__*,char*) ; 
 int /*<<< orphan*/  git_tag_create (int /*<<< orphan*/ *,int /*<<< orphan*/ ,char*,int /*<<< orphan*/ *,TYPE_2__*,int /*<<< orphan*/ ,int) ; 
