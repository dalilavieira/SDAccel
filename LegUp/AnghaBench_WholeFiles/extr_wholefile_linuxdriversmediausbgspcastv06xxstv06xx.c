...
struct usb_host_interface {TYPE_6__* endpoint; } ;
struct usb_device_id {scalar_t__ driver_info; } ;
struct usb_device {int dummy; } ;
struct TYPE_15__ {int* usb_buf; int /*<<< orphan*/  alt; int /*<<< orphan*/  iface; struct usb_device* dev; } ;
struct sd {scalar_t__ bridge; int to_skip; TYPE_9__* sensor; void* sensor_priv; TYPE_2__ gspca_dev; } ;
struct TYPE_20__ {int width; } ;
struct TYPE_14__ {int /*<<< orphan*/ * ctrl_handler; } ;
struct gspca_dev {size_t curr_mode; int /*<<< orphan*/ * sd_desc; TYPE_7__ pixfmt; int /*<<< orphan*/  last_packet_type; int /*<<< orphan*/  iface; TYPE_8__* dev; int /*<<< orphan*/  ctrl_handler; TYPE_1__ vdev; } ;
typedef  int __u8 ;
struct TYPE_22__ {int i2c_len; int i2c_addr; int i2c_flush; int (* init ) (struct sd*) ;int (* init_controls ) (struct sd*) ;int (* start ) (struct sd*) ;int* max_packet_size; int* min_packet_size; int (* stop ) (struct sd*) ;int /*<<< orphan*/  (* probe ) (struct sd*) ;int /*<<< orphan*/  (* dump ) (struct sd*) ;} ;
struct TYPE_21__ {TYPE_4__* actconfig; } ;
struct TYPE_18__ {void* wMaxPacketSize; } ;
struct TYPE_19__ {TYPE_5__ desc; } ;
struct TYPE_17__ {TYPE_3__** intf_cache; } ;
struct TYPE_16__ {struct usb_host_interface* altsetting; } ;
...
/* Variables and functions */
 ...
 int /*<<< orphan*/  sd_desc ; 
 int stub1 (struct sd*) ; 
 int /*<<< orphan*/  stub10 (struct sd*) ; 
 int /*<<< orphan*/  stub2 (struct sd*) ; 
 int stub3 (struct sd*) ; 
 int stub4 (struct sd*) ; 
 int stub5 (struct sd*) ; 
 int /*<<< orphan*/  stub6 (struct sd*) ; 
 int /*<<< orphan*/  stub7 (struct sd*) ; 
 int /*<<< orphan*/  stub8 (struct sd*) ; 
 int /*<<< orphan*/  stub9 (struct sd*) ; 
 TYPE_9__ stv06xx_sensor_hdcs1020 ; 
 TYPE_9__ stv06xx_sensor_hdcs1x00 ; 
 TYPE_9__ stv06xx_sensor_pb0100 ; 
 TYPE_9__ stv06xx_sensor_st6422 ; 
 TYPE_9__ stv06xx_sensor_vv6410 ; 
 int stv06xx_write_sensor_bytes (struct sd*,int const*,int) ; 
 int stv06xx_write_sensor_words (struct sd*,int const*,int) ; 
 ...
 int usb_set_interface (TYPE_8__*,int /*<<< orphan*/ ,int) ; 
