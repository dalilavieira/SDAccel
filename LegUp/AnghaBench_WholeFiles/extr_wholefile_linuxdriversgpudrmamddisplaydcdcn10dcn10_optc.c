...
struct TYPE_7__ {scalar_t__ vstartup_start; int vupdate_offset; int vupdate_width; int vready_offset; scalar_t__ signal; } ;
struct timing_generator {int inst; TYPE_4__* funcs; TYPE_3__* ctx; TYPE_1__ dlg_otg_param; } ;
struct tg_color {int color_b_cb; int color_g_y; int color_r_cr; } ;
struct TYPE_11__ {int /*<<< orphan*/ * funcs; } ;
struct optc {scalar_t__ max_h_total; scalar_t__ max_v_total; int min_h_blank; scalar_t__ min_h_sync_width; scalar_t__ min_v_sync_width; int min_v_blank_interlace; int min_v_blank; TYPE_6__* tg_mask; TYPE_5__ base; } ;
struct drr_params {int vertical_total_max; int vertical_total_min; } ;
struct dcn_otg_state {int otg_enabled; int v_blank_start; int v_blank_end; int v_sync_a_pol; int v_total; int v_total_max; int v_total_min; int v_total_max_sel; int v_total_min_sel; int v_sync_a_start; int v_sync_a_end; int h_blank_start; int h_blank_end; int h_sync_a_start; int h_sync_a_end; int h_sync_a_pol; int h_total; int underflow_occurred_status; } ;
struct TYPE_8__ {int INTERLACE; scalar_t__ VSYNC_POSITIVE_POLARITY; scalar_t__ HSYNC_POSITIVE_POLARITY; } ;
struct dc_crtc_timing {int v_front_porch; int h_addressable; int h_border_right; int h_front_porch; int h_total; int h_border_left; int v_addressable; int v_border_bottom; int v_total; int v_border_top; int pix_clk_khz; int h_sync_width; int v_sync_width; scalar_t__ pixel_encoding; scalar_t__ timing_3d_format; TYPE_2__ flags; } ;
...
struct TYPE_12__ {scalar_t__ OTG_H_TOTAL; scalar_t__ OTG_V_TOTAL; } ;
struct TYPE_10__ {int /*<<< orphan*/  (* get_position ) (struct timing_generator*,struct crtc_position*) ;} ;
struct TYPE_9__ {scalar_t__ dce_environment; } ;

/* Variables and functions */
 int /*<<< orphan*/  ASSERT (int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  BREAK_TO_DEBUGGER () ; 
#define  COLOR_DEPTH_101010 146 
#define  COLOR_DEPTH_121212 145 
#define  COLOR_DEPTH_666 144 
#define  COLOR_DEPTH_888 143 
 int /*<<< orphan*/  CONTROL ; 
#define  CONTROLLER_DP_TEST_PATTERN_COLORRAMP 142 
#define  CONTROLLER_DP_TEST_PATTERN_COLORSQUARES 141 
#define  CONTROLLER_DP_TEST_PATTERN_COLORSQUARES_CEA 140 
#define  CONTROLLER_DP_TEST_PATTERN_HORIZONTALBARS 139 
#define  CONTROLLER_DP_TEST_PATTERN_VERTICALBARS 138 
#define  CONTROLLER_DP_TEST_PATTERN_VIDEOMODE 137 
...
#define  CRTC_STATE_VBLANK 133 
 ...
 int /*<<< orphan*/  REG_UPDATE_5 (int /*<<< orphan*/ ,int /*<<< orphan*/ ,int,int /*<<< orphan*/ ,int,int /*<<< orphan*/ ,int,int /*<<< orphan*/ ,int,int /*<<< orphan*/ ,int) ; 
