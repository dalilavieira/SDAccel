...
/* Variables and functions */
 ...
 int /*<<< orphan*/  DSA_free (unsigned char*) ; 
 int /*<<< orphan*/  DSA_generate_key (unsigned char*) ; 
 int /*<<< orphan*/  DSA_get0_q (unsigned char*) ; 
 unsigned char* DSA_new () ; 
 int /*<<< orphan*/  DSA_set0_pqg (unsigned char*,int /*<<< orphan*/ *,int /*<<< orphan*/ *,int /*<<< orphan*/ *) ; 
 int DSA_verify (int /*<<< orphan*/ ,unsigned char*,int,unsigned char*,size_t,unsigned char*) ; 
 ...
 int /*<<< orphan*/  EVP_PKEY_set1_DSA (unsigned char*,unsigned char*) ; 
