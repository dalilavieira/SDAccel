...
struct TYPE_4__ {int (* read16_sync ) (struct rtl_priv*,int) ;int (* read32_sync ) (struct rtl_priv*,int) ;int /*<<< orphan*/  (* write32_async ) (struct rtl_priv*,int,int) ;int /*<<< orphan*/  (* write16_async ) (struct rtl_priv*,int,int) ;int /*<<< orphan*/  const (* read8_sync ) (struct rtl_priv*,int) ;int /*<<< orphan*/  (* write8_async ) (struct rtl_priv*,int,int /*<<< orphan*/  const) ;} ;
