...
typedef  int u32 ;
typedef  int u16 ;
struct smiapp_sensor {int /*<<< orphan*/  active; TYPE_1__* src; } ;
...
#define  SMIAPP_REG_8BIT 128 
 ...
 int SMIAPP_REG_FLAGS (int) ; 
 int SMIAPP_REG_FLAG_FLOAT ; 
 int SMIAPP_REG_WIDTH (int) ; 
 int /*<<< orphan*/  dev_err (int /*<<< orphan*/ *,char*,...) ; 
 int i2c_transfer (int /*<<< orphan*/ ,struct i2c_msg*,int) ; 
 int /*<<< orphan*/  reg_access ; 
 int smiapp_call_quirk (struct smiapp_sensor*,int /*<<< orphan*/ ,int,int*,int*) ; 
 int smiapp_needs_quirk (struct smiapp_sensor*,int /*<<< orphan*/ ) ; 
