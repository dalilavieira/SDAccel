...
struct TYPE_8__ {void* i_data; int /*<<< orphan*/  xattr_sem; } ;
struct TYPE_7__ {TYPE_2__* s_es; } ;
struct TYPE_6__ {scalar_t__ s_feature_compat; scalar_t__ s_feature_ro_compat; scalar_t__ s_feature_incompat; } ;
