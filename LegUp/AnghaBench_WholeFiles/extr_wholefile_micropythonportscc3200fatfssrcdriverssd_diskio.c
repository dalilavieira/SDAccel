...
/* Type definitions */
typedef  int UINT ;
struct TYPE_5__ {int usRCA; unsigned long ulBlockSize; unsigned long ulNofBlock; int bStatus; scalar_t__ ucCardType; scalar_t__ ulCapClass; int /*<<< orphan*/  ulVersion; } ;
...
/* Variables and functions */
 scalar_t__ CARD_CAP_CLASS_SDHC ; 
 scalar_t__ CARD_CAP_CLASS_SDSC ; 
 scalar_t__ CARD_TYPE_MMC ; 
 scalar_t__ CARD_TYPE_SDCARD ; 
 scalar_t__ CARD_TYPE_UNKNOWN ; 
 int /*<<< orphan*/  CARD_VERSION_1 ; 
 int /*<<< orphan*/  CARD_VERSION_2 ; 
 unsigned int CMD_ALL_SEND_CID ; 
 unsigned int CMD_APP_CMD ; 
 unsigned int CMD_GO_IDLE_STATE ; 
 unsigned int CMD_READ_MULTI_BLK ; 
 unsigned int CMD_READ_SINGLE_BLK ; 
 unsigned int CMD_SD_SEND_OP_COND ; 
 unsigned int CMD_SELECT_CARD ; 
 unsigned int CMD_SEND_CSD ; 
 unsigned int CMD_SEND_IF_COND ; 
 unsigned int CMD_SEND_OP_COND ; 
 unsigned int CMD_SEND_REL_ADDR ; 
 unsigned int CMD_SET_BLK_CNT ; 
 unsigned int CMD_STOP_TRANS ; 
 unsigned int CMD_WRITE_MULTI_BLK ; 
 unsigned int CMD_WRITE_SINGLE_BLK ; 
