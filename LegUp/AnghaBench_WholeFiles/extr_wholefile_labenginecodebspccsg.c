...
struct TYPE_61__ {scalar_t__* mins; scalar_t__* maxs; TYPE_4__* headnode; } ;
typedef  TYPE_1__ tree_t ;
struct TYPE_62__ {size_t planenum; scalar_t__ texinfo; int flags; int surf; struct TYPE_62__* original; int /*<<< orphan*/ * winding; } ;
typedef  TYPE_2__ side_t ;
typedef  int qboolean ;
struct TYPE_63__ {int /*<<< orphan*/  dist; int /*<<< orphan*/  normal; } ;
typedef  TYPE_3__ plane_t ;
struct TYPE_64__ {int contents; int /*<<< orphan*/  planenum; } ;
typedef  TYPE_4__ node_t ;
struct TYPE_65__ {scalar_t__ contents; scalar_t__ expansionbbox; int numsides; scalar_t__* mins; scalar_t__* maxs; TYPE_8__* original_sides; } ;
typedef  TYPE_5__ mapbrush_t ;
struct TYPE_66__ {int numsides; scalar_t__* mins; scalar_t__* maxs; struct TYPE_66__* next; TYPE_2__* sides; TYPE_5__* original; } ;
typedef  TYPE_6__ bspbrush_t ;
struct TYPE_67__ {int flags; scalar_t__ winding; } ;

/* Variables and functions */
 TYPE_6__* AllocBrush (int) ; 
 TYPE_4__* AllocNode () ; 
 int /*<<< orphan*/ * BaseWindingForPlane (int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 int /*<<< orphan*/  BoundBrush (TYPE_6__*) ; 
 TYPE_1__* BrushBSP (TYPE_6__*,scalar_t__*,scalar_t__*) ; 
 int CONTENTS_DETAIL ; 
 int CONTENTS_SOLID ; 
 int /*<<< orphan*/  ChopWindingInPlace (int /*<<< orphan*/ **,int /*<<< orphan*/ ,int /*<<< orphan*/ ,int /*<<< orphan*/ ) ; 
 TYPE_6__* CopyBrush (TYPE_6__*) ; 
 int /*<<< orphan*/ * CopyWinding (int /*<<< orphan*/ *) ; 
 int CountBrushList (TYPE_6__*) ; 
 ...
 int SFL_VISIBLE ; 
 int SURF_HINT ; 
 int /*<<< orphan*/  SplitBrush (TYPE_6__*,int,TYPE_6__**,TYPE_6__**) ; 
