...
/cygdrive/c/LegUp-7.5/legup/examples/mark_labels.pl route_cheb.c > route_cheb_labeled.c;
...
# produces pre-link time optimization binary bitcode: ./.legup/RoutCheb.prelto.bc
...
# to produce RoutCheb.prelto.1.bc
# If not using OpenMP, use Clang
clang-3.5.2 route_cheb_labeled.c -emit-llvm -c -D__LEGUP__  -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/include -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0 -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0/x86_64-unknown-linux-gnu/ -m32 -I /usr/include/i386-linux-gnu -D LEGUP_DEFAULT_FIFO_DEPTH=2 -O3 -fno-builtin -I C:/LegUp-7.5/legup/examples/lib/include/ -I C:/LegUp-7.5/legup/legup-library -I/cygdrive/c/LegUp-7.5/legup/legup-library  -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/include -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0 -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0/x86_64-unknown-linux-gnu/ -fno-vectorize -fno-slp-vectorize -Werror=implicit-function-declaration -Wno-ignored-attributes -fno-exceptions -D __LEGUP__ -I C:/LegUp-7.5/legup/include -I C:/LegUp-7.5/cygwin64/usr/include -I C:/LegUp-7.5/cygwin64/lib/gcc/x86_64-pc-cygwin/5.4.0/include/c++ -I C:/LegUp-7.5/cygwin64/lib/gcc/x86_64-pc-cygwin/5.4.0/include/c++/x86_64-pc-cygwin -g -mllvm -inline-threshold=-9999 -o ./.legup/route_cheb_labeled.bc || { rm -f route_cheb_labeled.c && false; };
#mv route_cheb_labeled.c ./.legup  # this breaks eclipse
rm -f route_cheb_labeled.c
# Then uses llvm-link to link all the .bc file (without optimizations)
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/llvm-link  ./.legup/route_cheb_labeled.bc -o ./.legup/RoutCheb.prelto.1.bc; 
# Remove debug info if the TCL parameter REMOVE_DEBUG_INFO is set.
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -remove-debug-info ./.legup/RoutCheb.prelto.1.bc -o ./.legup/RoutCheb.prelto.1.bc
# Set the variable to zero if not set.
#---------------------------------------------------------------------------#
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-preprocessing -always-inline -axi-interface -std-link-opts -break-constgeps -loweratomic ./.legup/RoutCheb.prelto.1.bc -o ./.legup/RoutCheb.preprocessing.bc
# annotated top-level pointer and global variables and remove sw testbench
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-sc-parser  -annotate-toplevel-ptrargs -ANALYZE_WHOLE_PROGRAM=1 -before-removing-tb=1 -removeswtestbench ./.legup/RoutCheb.preprocessing.bc -o ./.legup/RoutCheb.swremoved.bc
# lower special types
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -arbitrary-bitwidth -legup-lower-sc ./.legup/RoutCheb.swremoved.bc -o ./.legup/RoutCheb.lower.int.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -break-constgeps -legup-lower-ap ./.legup/RoutCheb.lower.int.bc -o ./.legup/RoutCheb.lower.ap.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -data-pack -split-legup-force-reg ./.legup/RoutCheb.lower.ap.bc -o ./.legup/RoutCheb.lower.datapack.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-lower-fifos ./.legup/RoutCheb.lower.datapack.bc -o ./.legup/RoutCheb.lower.fifo.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -basiccg -inline-cost -inline -globalopt -globaldce ./.legup/RoutCheb.lower.fifo.bc -o ./.legup/RoutCheb.lower.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -std-link-opts ./.legup/RoutCheb.lower.bc -o ./.legup/RoutCheb.stdlinkopts.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -std-compile-opts ./.legup/RoutCheb.stdlinkopts.bc -o ./.legup/RoutCheb.stdcompileopts.bc	
# performs intrinsic lowering 
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-prelto ./.legup/RoutCheb.stdcompileopts.bc -o ./.legup/RoutCheb.legupprelto.bc
# perform link-time optimizations
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -std-link-opts ./.legup/RoutCheb.legupprelto.bc -o ./.legup/RoutCheb.stdlinkopts2.bc
# link libraries
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/llvm-link  ./.legup/RoutCheb.stdlinkopts2.bc /cygdrive/c/LegUp-7.5/legup/examples/lib/llvm/liblegup.bc /cygdrive/c/LegUp-7.5/legup/examples/lib/llvm/liblegupParallel.bc /cygdrive/c/LegUp-7.5/legup/examples/lib/llvm/libm.bc -o ./.legup/RoutCheb.postlto.6.bc	
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -internalize-public-api-list=main -globaldce -std-link-opts -internalize ./.legup/RoutCheb.postlto.6.bc -o ./.legup/RoutCheb.postlto.8.bc
# check for unsupported C features 
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-code-support-checking -HYBRID_FLOW=0 ./.legup/RoutCheb.postlto.8.bc -o /dev/null
# arbitrary bitwidth
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-process-bw -legup-prop-bw ./.legup/RoutCheb.postlto.8.bc -o ./.legup/RoutCheb.ab.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -indvars2 -mem2reg -simplifycfg -loops -lcssa -loop-simplify -loop-rotate ./.legup/RoutCheb.ab.bc -o ./.legup/RoutCheb.looprotate.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -break-constgeps ./.legup/RoutCheb.loop_nest_merged.bc -o ./.legup/RoutCheb.breakgeps.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-parallel-api -HYBRID_FLOW=0 ./.legup/RoutCheb.breakgeps.bc -o ./.legup/RoutCheb.parallel.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -voidptr-argpromotion -dce -globaldce ./.legup/RoutCheb.parallel.bc -o ./.legup/RoutCheb.voidptr.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -instcombine -std-link-opts -break-constgeps ./.legup/RoutCheb.voidptr.bc -o ./.legup/RoutCheb.voidptropt.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -mem-partition -axi-interface -axi-rm-unused-mem-only -dce -deadargelim -dce -globaldce ./.legup/RoutCheb.voidptropt.bc -o ./.legup/RoutCheb.mp.bc
# annotate fifo function arguments with their widths and as input/output FIFOs
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-sc-fsm-generator -annotate-toplevel-ptrargs ./.legup/RoutCheb.mp.bc -o ./.legup/RoutCheb.fifo.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-handle-static-objects -dce ./.legup/RoutCheb.fifo.bc -o ./.legup/RoutCheb.static.bc
# 
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -mergereturn -legup-ga2l -dce -mem2reg ./.legup/RoutCheb.static.bc -o ./.legup/RoutCheb.ga2l.1.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -break-crit-edges -legup-ga2l -break-exit-stores -simplifycfg ./.legup/RoutCheb.ga2l.1.bc -o ./.legup/RoutCheb.ga2l.bc
# perform link-time optimizations
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -instcombine -std-link-opts ./.legup/RoutCheb.ga2l.bc -o ./.legup/RoutCheb.postlto.bc
...
# /cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -break-constgeps -legup-lower-ap ./.legup/RoutCheb.postlto.bc -o ./.legup/RoutCheb.lower.ap.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -break-constgeps -legup-struct-support-checking ./.legup/RoutCheb.postlto.bc -o ./.legup/RoutCheb.check.struct.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-promote-ap ./.legup/RoutCheb.check.struct.bc -o ./.legup/RoutCheb.promoted.ap.bc
cp ./.legup/RoutCheb.promoted.ap.bc ./.legup/RoutCheb.ap.1.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -basicaa -loop-simplify -indvars2 -instcombine -gvn -legup-strength-reduction -legup-expr-tree-balance -legup-store-merge ./.legup/RoutCheb.ap.1.bc -o ./.legup/RoutCheb.preifconv.1.bc
# These passes are run before COMBINE_BB_PASS as a preprocessing
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -lowerswitch -simplifycfg ./.legup/RoutCheb.preifconv.1.bc -o ./.legup/RoutCheb.preifconv.2.bc
#/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-combine-bb -combine-bb-aggressive=1 -combine-bb=1 -loops-only=0 -generate-merge-rpt ./.legup/RoutCheb.preifconv.2.bc -o ./.legup/RoutCheb.ifconv.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-if-conversion ./.legup/RoutCheb.preifconv.2.bc -o ./.legup/RoutCheb.ifconv.bc
...
#---------------------------------------------------------------------------#
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -simplifycfg ./.legup/RoutCheb.ifconv.bc -o ./.legup/RoutCheb.ifconv.1.bc
#/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -instcombine -gvn -legup-strength-reduction ./.legup/RoutCheb.ifconv.bc -o ./.legup/RoutCheb.ifconv.1.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -loop-simplify -indvars2 -instcombine -gvn -legup-strength-reduction -argpromotion -annotate-fifoarguments ./.legup/RoutCheb.ifconv.1.bc -o ./.legup/RoutCheb.ifconv.2.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-reduce-latency -legup-reduce-latency-annotate-depth -fuse-ops -bit-manipulation -globaldce -adce -annotate-legup-force-reg ./.legup/RoutCheb.ifconv.2.bc -o ./.legup/RoutCheb.finaloptimizedir.bc
# Restore predicate metadata with restore-metadata
rm -f reports/pipelining.legup.rpt
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -restore-metadata -basicaa -loop-pipeline -function-pipeline -HYBRID_FLOW=0 ./.legup/RoutCheb.finaloptimizedir.bc -o ./.legup/RoutCheb.bc
...
#---------------------------------------------------------------------------#
# Set the variable to zero if not set.
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/llc -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -march=v -HYBRID_FLOW=0 -LEGUP_ACCELERATOR_FILENAME=RoutCheb ./.legup/RoutCheb.bc -o RoutCheb.v
